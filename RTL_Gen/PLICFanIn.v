module PLICFanIn(
  ...
  wire [3:0] effectivePriority_66 = {io_ip[65],io_prio_65}; // @[Cat.scala 31:58]
  ...
  wire  _T_256 = _T_254 >= effectivePriority_66; // @[Plic.scala 344:20]
  wire [3:0] _T_258 = _T_256 ? _T_254 : effectivePriority_66; // @[Misc.scala 34:9]
  wire [1:0] _T_259 = _T_256 ? {{1'd0}, _T_255} : 2'h2; // @[Misc.scala 34:36]
  wire  _T_260 = _T_250 >= _T_258; // @[Plic.scala 344:20]
  wire [6:0] _GEN_31 = {{5'd0}, _T_259}; // @[Plic.scala 344:61]
  wire [6:0] _T_261 = 7'h40 | _GEN_31; // @[Plic.scala 344:61]
  wire [3:0] maxPri = _T_260 ? _T_250 : _T_258; // @[Misc.scala 34:9]
  assign io_dev = _T_260 ? {{1'd0}, _T_251} : _T_261; // @[Misc.scala 34:36]
