module AXI4IdIndexer_1(
  ...
  input  [1:0]  auto_out_bid,
  input         auto_out_arready,
  output        auto_out_arvalid,
  output [1:0]  auto_out_arid,
  ...
  assign auto_in_bid = auto_out_bid[0]; // @[Nodes.scala 1210:84 BundleMap.scala 247:19]
  ...
  assign auto_in_rid = auto_out_rid[0]; // @[Nodes.scala 1210:84 BundleMap.scala 247:19]
