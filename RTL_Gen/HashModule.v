...
`endif // RANDOMIZE_REG_INIT
  ...
  wire  shaSource_signBit = sha256sum0[31]; // @[BitUtils.scala 43:20]
  ...
  wire  shaSource_signBit_1 = sha256sum1[31]; // @[BitUtils.scala 43:20]
  ...
  wire  shaSource_signBit_2 = sha256sig0[31]; // @[BitUtils.scala 43:20]
  ...
  wire  shaSource_signBit_3 = sha256sig1[31]; // @[BitUtils.scala 43:20]
  ...
  wire  sm3_signBit = sm3p1[31]; // @[BitUtils.scala 43:20]
  ...
  wire  sm3_signBit_1 = sm3p0[31]; // @[BitUtils.scala 43:20]
