module FoldedSRAMTemplate_46(
  ...
  wire [2:0] array_io_rreq_bits_setIdx; // @[SRAMTemplate.scala 169:21]
  wire  array_io_rresp_data_0_valid; // @[SRAMTemplate.scala 169:21]
  wire [9:0] array_io_rresp_data_0_tag; // @[SRAMTemplate.scala 169:21]
  wire [2:0] array_io_rresp_data_0_ctr; // @[SRAMTemplate.scala 169:21]
  wire  array_io_rresp_data_1_valid; // @[SRAMTemplate.scala 169:21]
  wire [9:0] array_io_rresp_data_1_tag; // @[SRAMTemplate.scala 169:21]
  wire [2:0] array_io_rresp_data_1_ctr; // @[SRAMTemplate.scala 169:21]
  wire  array_io_wreq_valid; // @[SRAMTemplate.scala 169:21]
  wire [2:0] array_io_wreq_bits_setIdx; // @[SRAMTemplate.scala 169:21]
  wire [9:0] array_io_wreq_bits_data_0_tag; // @[SRAMTemplate.scala 169:21]
  wire [2:0] array_io_wreq_bits_data_0_ctr; // @[SRAMTemplate.scala 169:21]
  wire [9:0] array_io_wreq_bits_data_1_tag; // @[SRAMTemplate.scala 169:21]
  ...
  SRAMTemplate_55 array ( // @[SRAMTemplate.scala 169:21]
    .clock(array_clock),
    .reset(array_reset),
