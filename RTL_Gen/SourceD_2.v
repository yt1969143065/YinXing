module SourceD_2(
  ...
  output [1:0]   io_sourceD_rhazard_bits_way,
  output [11:0]  io_sourceD_rhazard_bits_set,
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [11:0] pipe_io_in_bits_req_set; // @[SourceD.scala 183:20]
  ...
  wire [1:0] pipe_io_in_bits_req_way; // @[SourceD.scala 183:20]
  ...
  wire [11:0] pipe_io_out_bits_req_set; // @[SourceD.scala 183:20]
  ...
  wire [1:0] pipe_io_out_bits_req_way; // @[SourceD.scala 183:20]
  ...
  reg [11:0] s1_req_reg_set; // @[Reg.scala 16:16]
  ...
  reg [1:0] s1_req_reg_way; // @[Reg.scala 16:16]
  ...
  reg [11:0] s2_req_set; // @[Reg.scala 16:16]
  ...
  reg [1:0] s2_req_way; // @[Reg.scala 16:16]
  ...
  reg  s3_queue_io_enq_valid_REG_3; // @[Pipeline.scala 41:37]
  ...
  reg [11:0] s4_req_set; // @[Reg.scala 16:16]
  reg [1:0] s4_req_way; // @[Reg.scala 16:16]
  ...
  Pipeline_17 pipe ( // @[SourceD.scala 183:20]
    .clock(pipe_clock),
    .reset(pipe_reset),
  ...
  Queue_268 s3_queue ( // @[SourceD.scala 204:24]
  ...
  assign s3_queue_io_enq_valid = s3_queue_io_enq_valid_REG_3; // @[SourceD.scala 220:25]
  ...
  always @(posedge clock) begin
    ...
    if (reset) begin // @[Pipeline.scala 41:37]
      s3_queue_io_enq_valid_REG_3 <= 1'h0; // @[Pipeline.scala 41:37]
    end else begin
      s3_queue_io_enq_valid_REG_3 <= s3_queue_io_enq_valid_REG_2; // @[Pipeline.scala 41:37]
    end
    if (reset) begin // @[Arbiter.scala 116:26]
...
`ifdef RANDOMIZE_REG_INIT
  ...
  _RAND_42 = {1{`RANDOM}};
  s3_queue_io_enq_valid_REG_3 = _RAND_42[0:0];
  _RAND_43 = {1{`RANDOM}};
  state_0 = _RAND_43[0:0];
  _RAND_44 = {1{`RANDOM}};
  s4_full = _RAND_44[0:0];
  _RAND_45 = {1{`RANDOM}};
  s4_need_pb = _RAND_45[0:0];
  _RAND_46 = {1{`RANDOM}};
  s4_req_set = _RAND_46[11:0];
  _RAND_47 = {1{`RANDOM}};
  s4_req_way = _RAND_47[1:0];
  _RAND_48 = {8{`RANDOM}};
