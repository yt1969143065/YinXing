module FastArbiter_14(
  ...
  input  [5:0]  io_in_10_bits_source,
  ...
  input  [5:0]  io_in_11_bits_source,
  ...
  input  [5:0]  io_in_12_bits_source,
  ...
  input  [5:0]  io_in_13_bits_source,
  input         io_out_ready,
  output        io_out_valid,
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [5:0] _io_out_bits_T_14 = chosenOH[0] ? io_in_0_bits_source : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_15 = chosenOH[1] ? io_in_1_bits_source : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_16 = chosenOH[2] ? io_in_2_bits_source : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_17 = chosenOH[3] ? io_in_3_bits_source : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_18 = chosenOH[4] ? io_in_4_bits_source : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_19 = chosenOH[5] ? io_in_5_bits_source : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_20 = chosenOH[6] ? io_in_6_bits_source : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_21 = chosenOH[7] ? io_in_7_bits_source : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_22 = chosenOH[8] ? io_in_8_bits_source : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_23 = chosenOH[9] ? io_in_9_bits_source : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_24 = chosenOH[10] ? io_in_10_bits_source : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_25 = chosenOH[11] ? io_in_11_bits_source : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_26 = chosenOH[12] ? io_in_12_bits_source : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_27 = chosenOH[13] ? io_in_13_bits_source : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_28 = _io_out_bits_T_14 | _io_out_bits_T_15; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_29 = _io_out_bits_T_28 | _io_out_bits_T_16; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_30 = _io_out_bits_T_29 | _io_out_bits_T_17; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_31 = _io_out_bits_T_30 | _io_out_bits_T_18; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_32 = _io_out_bits_T_31 | _io_out_bits_T_19; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_33 = _io_out_bits_T_32 | _io_out_bits_T_20; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_34 = _io_out_bits_T_33 | _io_out_bits_T_21; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_35 = _io_out_bits_T_34 | _io_out_bits_T_22; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_36 = _io_out_bits_T_35 | _io_out_bits_T_23; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_37 = _io_out_bits_T_36 | _io_out_bits_T_24; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_38 = _io_out_bits_T_37 | _io_out_bits_T_25; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_39 = _io_out_bits_T_38 | _io_out_bits_T_26; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_68 = chosenOH[0] ? io_in_0_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_69 = chosenOH[1] ? io_in_1_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_70 = chosenOH[2] ? io_in_2_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_71 = chosenOH[3] ? io_in_3_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_72 = chosenOH[4] ? io_in_4_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_73 = chosenOH[5] ? io_in_5_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_74 = chosenOH[6] ? io_in_6_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_75 = chosenOH[7] ? io_in_7_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_76 = chosenOH[8] ? io_in_8_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_77 = chosenOH[9] ? io_in_9_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_78 = chosenOH[10] ? io_in_10_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_79 = chosenOH[11] ? io_in_11_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_80 = chosenOH[12] ? io_in_12_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_81 = chosenOH[13] ? io_in_13_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_82 = _io_out_bits_T_68 | _io_out_bits_T_69; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_83 = _io_out_bits_T_82 | _io_out_bits_T_70; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_84 = _io_out_bits_T_83 | _io_out_bits_T_71; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_85 = _io_out_bits_T_84 | _io_out_bits_T_72; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_86 = _io_out_bits_T_85 | _io_out_bits_T_73; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_87 = _io_out_bits_T_86 | _io_out_bits_T_74; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_88 = _io_out_bits_T_87 | _io_out_bits_T_75; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_89 = _io_out_bits_T_88 | _io_out_bits_T_76; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_90 = _io_out_bits_T_89 | _io_out_bits_T_77; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_91 = _io_out_bits_T_90 | _io_out_bits_T_78; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_92 = _io_out_bits_T_91 | _io_out_bits_T_79; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_93 = _io_out_bits_T_92 | _io_out_bits_T_80; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_95 = chosenOH[0] ? io_in_0_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_96 = chosenOH[1] ? io_in_1_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_97 = chosenOH[2] ? io_in_2_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_98 = chosenOH[3] ? io_in_3_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_99 = chosenOH[4] ? io_in_4_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_100 = chosenOH[5] ? io_in_5_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_101 = chosenOH[6] ? io_in_6_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_102 = chosenOH[7] ? io_in_7_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_103 = chosenOH[8] ? io_in_8_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_104 = chosenOH[9] ? io_in_9_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_105 = chosenOH[10] ? io_in_10_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_106 = chosenOH[11] ? io_in_11_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_107 = chosenOH[12] ? io_in_12_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_108 = chosenOH[13] ? io_in_13_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_109 = _io_out_bits_T_95 | _io_out_bits_T_96; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_110 = _io_out_bits_T_109 | _io_out_bits_T_97; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_111 = _io_out_bits_T_110 | _io_out_bits_T_98; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_112 = _io_out_bits_T_111 | _io_out_bits_T_99; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_113 = _io_out_bits_T_112 | _io_out_bits_T_100; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_114 = _io_out_bits_T_113 | _io_out_bits_T_101; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_115 = _io_out_bits_T_114 | _io_out_bits_T_102; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_116 = _io_out_bits_T_115 | _io_out_bits_T_103; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_117 = _io_out_bits_T_116 | _io_out_bits_T_104; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_118 = _io_out_bits_T_117 | _io_out_bits_T_105; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_119 = _io_out_bits_T_118 | _io_out_bits_T_106; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_120 = _io_out_bits_T_119 | _io_out_bits_T_107; // @[Mux.scala 27:73]
  ...
  assign io_out_bits_tag = _io_out_bits_T_120 | _io_out_bits_T_108; // @[Mux.scala 27:73]
  assign io_out_bits_set = _io_out_bits_T_93 | _io_out_bits_T_81; // @[Mux.scala 27:73]
  assign io_out_bits_needT = chosenOH[0] & io_in_0_bits_needT | chosenOH[1] & io_in_1_bits_needT | chosenOH[2] &
    io_in_2_bits_needT | chosenOH[3] & io_in_3_bits_needT | chosenOH[4] & io_in_4_bits_needT | chosenOH[5] &
    io_in_5_bits_needT | chosenOH[6] & io_in_6_bits_needT | chosenOH[7] & io_in_7_bits_needT | chosenOH[8] &
    io_in_8_bits_needT | chosenOH[9] & io_in_9_bits_needT | chosenOH[10] & io_in_10_bits_needT | chosenOH[11] &
    io_in_11_bits_needT | chosenOH[12] & io_in_12_bits_needT | chosenOH[13] & io_in_13_bits_needT; // @[Mux.scala 27:73]
  assign io_out_bits_source = _io_out_bits_T_39 | _io_out_bits_T_27; // @[Mux.scala 27:73]
