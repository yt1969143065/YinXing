module SinkC(
  ...
  input  [7:0]   io_sourceD_rhazard_bits_set,
  ...
  output         io_release_bits_echo_blockisdirty,
...
`endif // RANDOMIZE_REG_INIT
  ...
  reg [7:0] bufferSet_0; // @[SinkC.scala 13:22]
  reg [7:0] bufferSet_1; // @[SinkC.scala 13:22]
  reg [7:0] bufferSet_2; // @[SinkC.scala 13:22]
  reg [7:0] bufferSet_3; // @[SinkC.scala 13:22]
  reg [7:0] bufferSet_4; // @[SinkC.scala 13:22]
  reg [7:0] bufferSet_5; // @[SinkC.scala 13:22]
  reg [7:0] bufferSet_6; // @[SinkC.scala 13:22]
  ...
  wire [28:0] set = io_c_bits_address[35:7]; // @[HuanCun.scala 139:22]
  wire [7:0] set_1 = set[7:0]; // @[HuanCun.scala 141:30]
  ...
  reg [7:0] task_rset; // @[Reg.scala 16:16]
  reg [20:0] task_rtag; // @[Reg.scala 16:16]
  ...
  reg [2:0] task_rparam; // @[Reg.scala 16:16]
  ...
  reg  task_rdirty; // @[Reg.scala 16:16]
  ...
  wire [34:0] _io_release_bits_address_T = {task_rtag,task_rset,task_roff}; // @[Cat.scala 31:58]
  ...
  assign io_resp_bits_set = set[7:0]; // @[HuanCun.scala 141:30]
  ...
  assign io_release_bits_param = task_rparam; // @[SinkC.scala 157:25]
  assign io_release_bits_size = task_rsize; // @[SinkC.scala 159:24]
  assign io_release_bits_source = task_rsource; // @[SinkC.scala 158:26]
  assign io_release_bits_address = {{1'd0}, _io_release_bits_address_T}; // @[SinkC.scala 154:27]
  assign io_release_bits_echo_blockisdirty = task_rdirty; // @[SinkC.scala 162:49]
  ...
  always @(posedge clock) begin
    ...
    if (_task_rT) begin // @[Reg.scala 17:18]
      task_rparam <= io_task_bits_param; // @[Reg.scala 17:22]
    end
    if (_task_rT) begin // @[Reg.scala 17:18]
    ...
    if (_task_rT) begin // @[Reg.scala 17:18]
      task_rdirty <= io_task_bits_dirty; // @[Reg.scala 17:22]
    end
...
`ifdef RANDOMIZE_REG_INIT
  ...
  _RAND_14 = {1{`RANDOM}};
  bufferSet_0 = _RAND_14[7:0];
  _RAND_15 = {1{`RANDOM}};
  bufferSet_1 = _RAND_15[7:0];
  _RAND_16 = {1{`RANDOM}};
  bufferSet_2 = _RAND_16[7:0];
  _RAND_17 = {1{`RANDOM}};
  bufferSet_3 = _RAND_17[7:0];
  _RAND_18 = {1{`RANDOM}};
  bufferSet_4 = _RAND_18[7:0];
  _RAND_19 = {1{`RANDOM}};
  bufferSet_5 = _RAND_19[7:0];
  _RAND_20 = {1{`RANDOM}};
  bufferSet_6 = _RAND_20[7:0];
  _RAND_21 = {1{`RANDOM}};
  ...
  _RAND_59 = {1{`RANDOM}};
  task_rset = _RAND_59[7:0];
  _RAND_60 = {1{`RANDOM}};
  task_rtag = _RAND_60[20:0];
  _RAND_61 = {1{`RANDOM}};
  task_rsize = _RAND_61[2:0];
  _RAND_62 = {1{`RANDOM}};
  task_rway = _RAND_62[2:0];
  _RAND_63 = {1{`RANDOM}};
  ...
  _RAND_66 = {1{`RANDOM}};
  task_rparam = _RAND_66[2:0];
  _RAND_67 = {1{`RANDOM}};
  task_rsource = _RAND_67[3:0];
  _RAND_68 = {1{`RANDOM}};
  task_rsave = _RAND_68[0:0];
  _RAND_69 = {1{`RANDOM}};
  task_rdrop = _RAND_69[0:0];
  _RAND_70 = {1{`RANDOM}};
  task_rrelease = _RAND_70[0:0];
  _RAND_71 = {1{`RANDOM}};
  task_rdirty = _RAND_71[0:0];
  _RAND_72 = {1{`RANDOM}};
  busy = _RAND_72[0:0];
  _RAND_73 = {1{`RANDOM}};
  w_counter_save = _RAND_73[0:0];
  _RAND_74 = {1{`RANDOM}};
  w_counter_through = _RAND_74[0:0];
  _RAND_75 = {1{`RANDOM}};
  w_save_done_r = _RAND_75[0:0];
  _RAND_76 = {1{`RANDOM}};
  w_through_done_r = _RAND_76[0:0];
`endif // RANDOMIZE_REG_INIT
  `endif // RANDOMIZE
end // initial
