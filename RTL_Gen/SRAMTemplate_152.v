module SRAMTemplate_152(
  ...
  output [7:0] io_rresp_data_1,
  output [7:0] io_rresp_data_2,
  output [7:0] io_rresp_data_3,
  input        io_wreq_valid,
  input  [7:0] io_wreq_bits_setIdx,
  input  [7:0] io_wreq_bits_data_0,
  input  [7:0] io_wreq_bits_data_1,
  input  [7:0] io_wreq_bits_data_2,
  input  [7:0] io_wreq_bits_data_3,
  ...
  wire [7:0] array_RW0_wdata_0; // @[SRAMTemplate.scala 102:26]
  wire [7:0] array_RW0_wdata_1; // @[SRAMTemplate.scala 102:26]
  wire [7:0] array_RW0_wdata_2; // @[SRAMTemplate.scala 102:26]
  wire [7:0] array_RW0_wdata_3; // @[SRAMTemplate.scala 102:26]
  wire [7:0] array_RW0_rdata_0; // @[SRAMTemplate.scala 102:26]
  wire [7:0] array_RW0_rdata_1; // @[SRAMTemplate.scala 102:26]
  wire [7:0] array_RW0_rdata_2; // @[SRAMTemplate.scala 102:26]
  wire [7:0] array_RW0_rdata_3; // @[SRAMTemplate.scala 102:26]
  ...
  array_23 array ( // @[SRAMTemplate.scala 102:26]
