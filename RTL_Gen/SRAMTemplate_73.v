...
`endif // RANDOMIZE_REG_INIT
  wire [2:0] array_RW0_addr; // @[SRAMTemplate.scala 102:26]
  ...
  wire [14:0] array_RW0_wdata_0; // @[SRAMTemplate.scala 102:26]
  wire [14:0] array_RW0_wdata_1; // @[SRAMTemplate.scala 102:26]
  wire [14:0] array_RW0_rdata_0; // @[SRAMTemplate.scala 102:26]
  wire [14:0] array_RW0_rdata_1; // @[SRAMTemplate.scala 102:26]
  ...
  wire [2:0] setIdx = resetState ? resetSet : io_wreq_bits_setIdx; // @[SRAMTemplate.scala 117:19]
  wire  _wdata_T__0_valid = resetState ? 1'h0 : 1'h1; // @[SRAMTemplate.scala 118:26]
  wire [10:0] _wdata_T__0_tag = resetState ? 11'h0 : io_wreq_bits_data_0_tag; // @[SRAMTemplate.scala 118:26]
  wire [2:0] _wdata_T__0_ctr = resetState ? 3'h0 : io_wreq_bits_data_0_ctr; // @[SRAMTemplate.scala 118:26]
  wire [10:0] _wdata_T__1_tag = resetState ? 11'h0 : io_wreq_bits_data_1_tag; // @[SRAMTemplate.scala 118:26]
  wire [2:0] _wdata_T__1_ctr = resetState ? 3'h0 : io_wreq_bits_data_1_ctr; // @[SRAMTemplate.scala 118:26]
  wire [11:0] wdata_hi = {_wdata_T__0_valid,_wdata_T__0_tag}; // @[SRAMTemplate.scala 118:102]
  wire [11:0] wdata_hi_1 = {_wdata_T__0_valid,_wdata_T__1_tag}; // @[SRAMTemplate.scala 118:102]
  wire [1:0] waymask = resetState ? 2'h3 : io_wreq_bits_waymask; // @[SRAMTemplate.scala 119:20]
  reg  rdata_REG; // @[SRAMTemplate.scala 145:59]
  reg [14:0] rdata_r0; // @[Reg.scala 28:20]
  reg [14:0] rdata_r1; // @[Reg.scala 28:20]
  wire [14:0] _GEN_20 = rdata_REG ? array_RW0_rdata_0 : rdata_r0; // @[Reg.scala 29:18 28:20 29:22]
  wire [14:0] _GEN_21 = rdata_REG ? array_RW0_rdata_1 : rdata_r1; // @[Reg.scala 29:18 28:20 29:22]
  array_12 array ( // @[SRAMTemplate.scala 102:26]
  ...
  assign io_rresp_data_0_valid = _GEN_20[14]; // @[SRAMTemplate.scala 146:45]
  assign io_rresp_data_0_tag = _GEN_20[13:3]; // @[SRAMTemplate.scala 146:45]
  assign io_rresp_data_0_ctr = _GEN_20[2:0]; // @[SRAMTemplate.scala 146:45]
  assign io_rresp_data_1_valid = _GEN_21[14]; // @[SRAMTemplate.scala 146:45]
  assign io_rresp_data_1_tag = _GEN_21[13:3]; // @[SRAMTemplate.scala 146:45]
  ...
  always @(posedge clock) begin
    ...
    if (reset) begin // @[Counter.scala 62:40]
      resetSet <= 3'h0; // @[Counter.scala 62:40]
...
`ifdef RANDOMIZE_REG_INIT
  ...
  _RAND_3 = {1{`RANDOM}};
  rdata_r0 = _RAND_3[14:0];
  _RAND_4 = {1{`RANDOM}};
  rdata_r1 = _RAND_4[14:0];
`endif // RANDOMIZE_REG_INIT
  `endif // RANDOMIZE
end // initial
