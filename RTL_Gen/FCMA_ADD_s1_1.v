module FCMA_ADD_s1_1(
  ...
  wire [105:0] far_path_mods_0_io_in_bsig; // @[FADD.scala 208:26]
  ...
  wire [105:0] near_path_mods_0_io_in_bsig; // @[FADD.scala 232:27]
  ...
  wire [105:0] near_path_mods_1_io_in_bsig; // @[FADD.scala 232:27]
  ...
  wire [11:0] exp_diff_a_b = _exp_diff_a_bT - _exp_diff_a_bT_1; // @[FADD.scala 187:47]
  wire [11:0] exp_diff_ba = _exp_diff_a_bT_1 - _exp_diff_a_bT; // @[FADD.scala 188:47]
  wire  need_swap = exp_diff_a_b[11] | io_binter_flags_overflow; // @[FADD.scala 190:47]
  wire [10:0] ea_minus_eb = need_swap ? exp_diff_ba[10:0] : exp_diff_a_b[10:0]; // @[FADD.scala 192:24]
  wire  _sel_far_path_T = ~eff_sub; // @[FADD.scala 193:22]
  wire  _T = ~need_swap; // @[FADD.scala 201:11]
  wire [11:0] _T_5 = _T ? exp_diff_a_b : exp_diff_ba; // @[FADD.scala 203:10]
  ...
  FarPath_1 far_path_mods_0 ( // @[FADD.scala 208:26]
  ...
  NearPath_2 near_path_mods_0 ( // @[FADD.scala 232:27]
  ...
  NearPath_2 near_path_mods_1 ( // @[FADD.scala 232:27]
  ...
  assign io_out_sel_far_path = ~eff_sub | ea_minus_eb > 11'h1 | io_binter_flags_overflow; // @[FADD.scala 193:52]
