module SRAMTemplate_271(
  input         clock,
  input         io_rreq_valid,
  input  [11:0] io_rreq_bits_setIdx,
  output [2:0]  io_rresp_data_0,
  input         io_wreq_valid,
  input  [11:0] io_wreq_bits_setIdx,
  input  [2:0]  io_wreq_bits_data_0
);
  ...
  wire [2:0] array_RW0_wdata_0; // @[SRAMTemplate.scala 113:26]
  wire [2:0] array_RW0_rdata_0; // @[SRAMTemplate.scala 113:26]
  wire  realRen = io_rreq_valid & ~io_wreq_valid; // @[SRAMTemplate.scala 126:38]
  array_45 array ( // @[SRAMTemplate.scala 113:26]
