module Pipeline_2(
  ...
  wire [1:0] stages_0_io_enq_bits_data_clientStates_1; // @[Pipeline.scala 11:47]
  wire  stages_0_io_enq_bits_data_prefetch; // @[Pipeline.scala 11:47]
  ...
  wire [1:0] stages_0_io_deq_bits_data_clientStates_1; // @[Pipeline.scala 11:47]
  wire  stages_0_io_deq_bits_data_prefetch; // @[Pipeline.scala 11:47]
  Queue_233 stages_0 ( // @[Pipeline.scala 11:47]
    ...
    .io_enq_bits_data_prefetch(stages_0_io_enq_bits_data_prefetch),
    ...
    .io_deq_bits_data_prefetch(stages_0_io_deq_bits_data_prefetch)
  );
  ...
  assign io_out_bits_data_clientStates_1 = stages_0_io_deq_bits_data_clientStates_1; // @[Pipeline.scala 18:10]
  assign io_out_bits_data_prefetch = stages_0_io_deq_bits_data_prefetch; // @[Pipeline.scala 18:10]
  ...
  assign stages_0_io_enq_bits_data_clientStates_1 = io_in_bits_data_clientStates_1; // @[Pipeline.scala 14:14]
  assign stages_0_io_enq_bits_data_prefetch = io_in_bits_data_prefetch; // @[Pipeline.scala 14:14]
endmodule
