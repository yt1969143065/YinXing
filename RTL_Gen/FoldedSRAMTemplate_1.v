module FoldedSRAMTemplate_1(
  ...
  wire [6:0] array_io_rresp_data_0_tag; // @[SRAMTemplate.scala 169:21]
  wire [2:0] array_io_rresp_data_0_ctr; // @[SRAMTemplate.scala 169:21]
  wire  array_io_rresp_data_1_valid; // @[SRAMTemplate.scala 169:21]
  wire [6:0] array_io_rresp_data_1_tag; // @[SRAMTemplate.scala 169:21]
  ...
  wire [6:0] array_io_wreq_bits_data_0_tag; // @[SRAMTemplate.scala 169:21]
  wire [2:0] array_io_wreq_bits_data_0_ctr; // @[SRAMTemplate.scala 169:21]
  wire [6:0] array_io_wreq_bits_data_1_tag; // @[SRAMTemplate.scala 169:21]
  ...
  SRAMTemplate_10 array ( // @[SRAMTemplate.scala 169:21]
    .clock(array_clock),
    .reset(array_reset),
