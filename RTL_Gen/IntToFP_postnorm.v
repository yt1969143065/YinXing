module IntToFP_postnorm(
  ...
  wire [7:0] _GEN_1 = {{7'd0}, rounder_io_cout}; // @[IntToFP.scala 88:39]
  wire [7:0] _exp_T_1 = exp_raw + _GEN_1; // @[IntToFP.scala 88:39]
  wire [7:0] exp = io_in_is_zero ? 8'h0 : _exp_T_1; // @[IntToFP.scala 88:16]
  wire [8:0] io_result_hi = {io_in_sign,exp}; // @[Cat.scala 31:58]
