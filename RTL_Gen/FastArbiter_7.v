...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [2:0] _io_out_bits_T_203 = chosenOH[0] ? io_in_0_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_204 = chosenOH[1] ? io_in_1_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_205 = chosenOH[2] ? io_in_2_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_206 = chosenOH[3] ? io_in_3_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_207 = chosenOH[4] ? io_in_4_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_208 = chosenOH[5] ? io_in_5_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_209 = chosenOH[6] ? io_in_6_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_210 = chosenOH[7] ? io_in_7_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_211 = chosenOH[8] ? io_in_8_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_212 = chosenOH[9] ? io_in_9_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_213 = chosenOH[10] ? io_in_10_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_214 = chosenOH[11] ? io_in_11_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_215 = chosenOH[12] ? io_in_12_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_216 = chosenOH[13] ? io_in_13_bits_way : 3'h0; // @[Mux.scala 27:73]
  ...
  wire [7:0] _io_out_bits_T_365 = chosenOH[0] ? io_in_0_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_366 = chosenOH[1] ? io_in_1_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_367 = chosenOH[2] ? io_in_2_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_368 = chosenOH[3] ? io_in_3_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_369 = chosenOH[4] ? io_in_4_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_370 = chosenOH[5] ? io_in_5_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_371 = chosenOH[6] ? io_in_6_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_372 = chosenOH[7] ? io_in_7_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_373 = chosenOH[8] ? io_in_8_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_374 = chosenOH[9] ? io_in_9_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_375 = chosenOH[10] ? io_in_10_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_376 = chosenOH[11] ? io_in_11_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_377 = chosenOH[12] ? io_in_12_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_378 = chosenOH[13] ? io_in_13_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_379 = _io_out_bits_T_365 | _io_out_bits_T_366; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_380 = _io_out_bits_T_379 | _io_out_bits_T_367; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_381 = _io_out_bits_T_380 | _io_out_bits_T_368; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_382 = _io_out_bits_T_381 | _io_out_bits_T_369; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_383 = _io_out_bits_T_382 | _io_out_bits_T_370; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_384 = _io_out_bits_T_383 | _io_out_bits_T_371; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_385 = _io_out_bits_T_384 | _io_out_bits_T_372; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_386 = _io_out_bits_T_385 | _io_out_bits_T_373; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_387 = _io_out_bits_T_386 | _io_out_bits_T_374; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_388 = _io_out_bits_T_387 | _io_out_bits_T_375; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_389 = _io_out_bits_T_388 | _io_out_bits_T_376; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_390 = _io_out_bits_T_389 | _io_out_bits_T_377; // @[Mux.scala 27:73]
