module Pipeline(
  ...
  wire  stages_0_io_enq_bits_needT; // @[Pipeline.scala 11:47]
  ...
  wire  stages_0_io_deq_bits_needT; // @[Pipeline.scala 11:47]
  wire [5:0] stages_0_io_deq_bits_source; // @[Pipeline.scala 11:47]
  Queue_219 stages_0 ( // @[Pipeline.scala 11:47]
    ...
    .io_enq_bits_needT(stages_0_io_enq_bits_needT),
    ...
    .io_deq_bits_needT(stages_0_io_deq_bits_needT),
  ...
  assign io_out_bits_needT = stages_0_io_deq_bits_needT; // @[Pipeline.scala 18:10]
  ...
  assign stages_0_io_enq_bits_needT = io_in_bits_needT; // @[Pipeline.scala 14:14]
  assign stages_0_io_enq_bits_source = io_in_bits_source; // @[Pipeline.scala 14:14]
