module SRAMTemplate_265(
  ...
  wire [8:0] array_RW0_addr; // @[SRAMTemplate.scala 113:26]
  ...
  wire [1:0] array_RW0_wdata_0; // @[SRAMTemplate.scala 113:26]
  wire [1:0] array_RW0_wdata_1; // @[SRAMTemplate.scala 113:26]
  wire [1:0] array_RW0_wdata_2; // @[SRAMTemplate.scala 113:26]
  wire [1:0] array_RW0_wdata_3; // @[SRAMTemplate.scala 113:26]
  wire [1:0] array_RW0_wdata_4; // @[SRAMTemplate.scala 113:26]
  wire [1:0] array_RW0_wdata_5; // @[SRAMTemplate.scala 113:26]
  wire [1:0] array_RW0_wdata_6; // @[SRAMTemplate.scala 113:26]
  wire [1:0] array_RW0_wdata_7; // @[SRAMTemplate.scala 113:26]
  wire [1:0] array_RW0_rdata_0; // @[SRAMTemplate.scala 113:26]
  wire [1:0] array_RW0_rdata_1; // @[SRAMTemplate.scala 113:26]
  wire [1:0] array_RW0_rdata_2; // @[SRAMTemplate.scala 113:26]
  wire [1:0] array_RW0_rdata_3; // @[SRAMTemplate.scala 113:26]
  wire [1:0] array_RW0_rdata_4; // @[SRAMTemplate.scala 113:26]
  wire [1:0] array_RW0_rdata_5; // @[SRAMTemplate.scala 113:26]
  wire [1:0] array_RW0_rdata_6; // @[SRAMTemplate.scala 113:26]
  wire [1:0] array_RW0_rdata_7; // @[SRAMTemplate.scala 113:26]
  ...
  array_39 array ( // @[SRAMTemplate.scala 113:26]
  ...
  assign io_rresp_data_0_0_state = array_RW0_rdata_0; // @[SRAMTemplate.scala 163:22]
  assign io_rresp_data_1_0_state = array_RW0_rdata_1; // @[SRAMTemplate.scala 163:22]
  assign io_rresp_data_2_0_state = array_RW0_rdata_2; // @[SRAMTemplate.scala 163:22]
  assign io_rresp_data_3_0_state = array_RW0_rdata_3; // @[SRAMTemplate.scala 163:22]
  assign io_rresp_data_4_0_state = array_RW0_rdata_4; // @[SRAMTemplate.scala 163:22]
  assign io_rresp_data_5_0_state = array_RW0_rdata_5; // @[SRAMTemplate.scala 163:22]
  assign io_rresp_data_6_0_state = array_RW0_rdata_6; // @[SRAMTemplate.scala 163:22]
  assign io_rresp_data_7_0_state = array_RW0_rdata_7; // @[SRAMTemplate.scala 163:22]
  assign array_RW0_clk = clock; // @[SRAMTemplate.scala 131:14]
  assign array_RW0_wdata_0 = io_wreq_bits_data_0_0_state; // @[SRAMTemplate.scala 129:26]
  assign array_RW0_wdata_1 = io_wreq_bits_data_1_0_state; // @[SRAMTemplate.scala 129:26]
  assign array_RW0_wdata_2 = io_wreq_bits_data_2_0_state; // @[SRAMTemplate.scala 129:26]
  assign array_RW0_wdata_3 = io_wreq_bits_data_3_0_state; // @[SRAMTemplate.scala 129:26]
  assign array_RW0_wdata_4 = io_wreq_bits_data_4_0_state; // @[SRAMTemplate.scala 129:26]
  assign array_RW0_wdata_5 = io_wreq_bits_data_5_0_state; // @[SRAMTemplate.scala 129:26]
  assign array_RW0_wdata_6 = io_wreq_bits_data_6_0_state; // @[SRAMTemplate.scala 129:26]
  assign array_RW0_wdata_7 = io_wreq_bits_data_7_0_state; // @[SRAMTemplate.scala 129:26]
