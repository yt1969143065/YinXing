...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [2:0] _io_out_bits_T_257 = chosenOH[0] ? io_in_0_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_258 = chosenOH[1] ? io_in_1_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_259 = chosenOH[2] ? io_in_2_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_260 = chosenOH[3] ? io_in_3_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_261 = chosenOH[4] ? io_in_4_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_262 = chosenOH[5] ? io_in_5_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_263 = chosenOH[6] ? io_in_6_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_264 = chosenOH[7] ? io_in_7_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_265 = chosenOH[8] ? io_in_8_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_266 = chosenOH[9] ? io_in_9_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_267 = chosenOH[10] ? io_in_10_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_268 = chosenOH[11] ? io_in_11_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_269 = chosenOH[12] ? io_in_12_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_270 = chosenOH[13] ? io_in_13_bits_way : 3'h0; // @[Mux.scala 27:73]
  ...
  wire [20:0] _io_out_bits_T_311 = chosenOH[0] ? io_in_0_bits_tag : 21'h0; // @[Mux.scala 27:73]
  wire [20:0] _io_out_bits_T_312 = chosenOH[1] ? io_in_1_bits_tag : 21'h0; // @[Mux.scala 27:73]
  wire [20:0] _io_out_bits_T_313 = chosenOH[2] ? io_in_2_bits_tag : 21'h0; // @[Mux.scala 27:73]
  wire [20:0] _io_out_bits_T_314 = chosenOH[3] ? io_in_3_bits_tag : 21'h0; // @[Mux.scala 27:73]
  wire [20:0] _io_out_bits_T_315 = chosenOH[4] ? io_in_4_bits_tag : 21'h0; // @[Mux.scala 27:73]
  wire [20:0] _io_out_bits_T_316 = chosenOH[5] ? io_in_5_bits_tag : 21'h0; // @[Mux.scala 27:73]
  wire [20:0] _io_out_bits_T_317 = chosenOH[6] ? io_in_6_bits_tag : 21'h0; // @[Mux.scala 27:73]
  wire [20:0] _io_out_bits_T_318 = chosenOH[7] ? io_in_7_bits_tag : 21'h0; // @[Mux.scala 27:73]
  wire [20:0] _io_out_bits_T_319 = chosenOH[8] ? io_in_8_bits_tag : 21'h0; // @[Mux.scala 27:73]
  wire [20:0] _io_out_bits_T_320 = chosenOH[9] ? io_in_9_bits_tag : 21'h0; // @[Mux.scala 27:73]
  wire [20:0] _io_out_bits_T_321 = chosenOH[10] ? io_in_10_bits_tag : 21'h0; // @[Mux.scala 27:73]
  wire [20:0] _io_out_bits_T_322 = chosenOH[11] ? io_in_11_bits_tag : 21'h0; // @[Mux.scala 27:73]
  wire [20:0] _io_out_bits_T_323 = chosenOH[12] ? io_in_12_bits_tag : 21'h0; // @[Mux.scala 27:73]
  wire [20:0] _io_out_bits_T_324 = chosenOH[13] ? io_in_13_bits_tag : 21'h0; // @[Mux.scala 27:73]
  wire [20:0] _io_out_bits_T_325 = _io_out_bits_T_311 | _io_out_bits_T_312; // @[Mux.scala 27:73]
  wire [20:0] _io_out_bits_T_326 = _io_out_bits_T_325 | _io_out_bits_T_313; // @[Mux.scala 27:73]
  wire [20:0] _io_out_bits_T_327 = _io_out_bits_T_326 | _io_out_bits_T_314; // @[Mux.scala 27:73]
  wire [20:0] _io_out_bits_T_328 = _io_out_bits_T_327 | _io_out_bits_T_315; // @[Mux.scala 27:73]
  wire [20:0] _io_out_bits_T_329 = _io_out_bits_T_328 | _io_out_bits_T_316; // @[Mux.scala 27:73]
  wire [20:0] _io_out_bits_T_330 = _io_out_bits_T_329 | _io_out_bits_T_317; // @[Mux.scala 27:73]
  wire [20:0] _io_out_bits_T_331 = _io_out_bits_T_330 | _io_out_bits_T_318; // @[Mux.scala 27:73]
  wire [20:0] _io_out_bits_T_332 = _io_out_bits_T_331 | _io_out_bits_T_319; // @[Mux.scala 27:73]
  wire [20:0] _io_out_bits_T_333 = _io_out_bits_T_332 | _io_out_bits_T_320; // @[Mux.scala 27:73]
  wire [20:0] _io_out_bits_T_334 = _io_out_bits_T_333 | _io_out_bits_T_321; // @[Mux.scala 27:73]
  wire [20:0] _io_out_bits_T_335 = _io_out_bits_T_334 | _io_out_bits_T_322; // @[Mux.scala 27:73]
  wire [20:0] _io_out_bits_T_336 = _io_out_bits_T_335 | _io_out_bits_T_323; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_338 = chosenOH[0] ? io_in_0_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_339 = chosenOH[1] ? io_in_1_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_340 = chosenOH[2] ? io_in_2_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_341 = chosenOH[3] ? io_in_3_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_342 = chosenOH[4] ? io_in_4_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_343 = chosenOH[5] ? io_in_5_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_344 = chosenOH[6] ? io_in_6_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_345 = chosenOH[7] ? io_in_7_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_346 = chosenOH[8] ? io_in_8_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_347 = chosenOH[9] ? io_in_9_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_348 = chosenOH[10] ? io_in_10_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_349 = chosenOH[11] ? io_in_11_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_350 = chosenOH[12] ? io_in_12_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_351 = chosenOH[13] ? io_in_13_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_352 = _io_out_bits_T_338 | _io_out_bits_T_339; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_353 = _io_out_bits_T_352 | _io_out_bits_T_340; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_354 = _io_out_bits_T_353 | _io_out_bits_T_341; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_355 = _io_out_bits_T_354 | _io_out_bits_T_342; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_356 = _io_out_bits_T_355 | _io_out_bits_T_343; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_357 = _io_out_bits_T_356 | _io_out_bits_T_344; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_358 = _io_out_bits_T_357 | _io_out_bits_T_345; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_359 = _io_out_bits_T_358 | _io_out_bits_T_346; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_360 = _io_out_bits_T_359 | _io_out_bits_T_347; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_361 = _io_out_bits_T_360 | _io_out_bits_T_348; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_362 = _io_out_bits_T_361 | _io_out_bits_T_349; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_363 = _io_out_bits_T_362 | _io_out_bits_T_350; // @[Mux.scala 27:73]
