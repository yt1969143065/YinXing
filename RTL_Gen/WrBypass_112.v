module WrBypass_112(
  ...
  input         reset,
  input         io_wen,
  input  [2:0]  io_write_idx,
  input  [10:0] io_write_tag,
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [2:0] idx_tag_cam_io_rreq_0_idx; // @[WrBypass.scala 57:27]
  wire [10:0] idx_tag_cam_io_rreq_0_tag; // @[WrBypass.scala 57:27]
  ...
  wire [2:0] idx_tag_cam_io_wdata_idx; // @[WrBypass.scala 57:27]
  wire [10:0] idx_tag_cam_io_wdata_tag; // @[WrBypass.scala 57:27]
  ...
  wire [3:0] _GEN_79 = {{3'd0}, enq_en}; // @[CircularQueuePtr.scala 40:46]
  wire [3:0] _enq_ptr_new_ptr_T_2 = _enq_ptr_new_ptr_T + _GEN_79; // @[CircularQueuePtr.scala 40:46]
  ...
  CAMTemplate_112 idx_tag_cam ( // @[WrBypass.scala 57:27]
