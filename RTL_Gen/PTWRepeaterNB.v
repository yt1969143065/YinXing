...
`endif // RANDOMIZE_REG_INIT
  ...
  wire  _sent_T_2 = _sent_T_1 | delay_io_out; // @[Repeater.scala 106:61]
  reg  sent; // @[StopWatch.scala 24:20]
  wire  _GEN_1 = _req_T | sent; // @[StopWatch.scala 24:20 30:{20,24}]
  ...
  wire  _recv_T_2 = io_tlb_resp_valid | delay_io_out; // @[Repeater.scala 113:61]
  reg  recv; // @[StopWatch.scala 24:20]
  wire  _GEN_18 = _resp_T | recv; // @[StopWatch.scala 24:20 30:{20,24}]
  DelayN_31 delay ( // @[Hold.scala 94:23]
    .clock(delay_clock),
    .io_in(delay_io_in),
    .io_out(delay_io_out)
  );
  assign io_tlb_req_0_ready = ~sent; // @[Repeater.scala 107:19]
  assign io_tlb_resp_valid = recv; // @[Repeater.scala 115:18]
  assign io_tlb_resp_bits_entry_tag = resp_entry_tag; // @[Repeater.scala 116:17]
  assign io_tlb_resp_bits_entry_ppn = resp_entry_ppn; // @[Repeater.scala 116:17]
  assign io_tlb_resp_bits_entry_perm_d = resp_entry_perm_d; // @[Repeater.scala 116:17]
  assign io_tlb_resp_bits_entry_perm_a = resp_entry_perm_a; // @[Repeater.scala 116:17]
  assign io_tlb_resp_bits_entry_perm_g = resp_entry_perm_g; // @[Repeater.scala 116:17]
  assign io_tlb_resp_bits_entry_perm_u = resp_entry_perm_u; // @[Repeater.scala 116:17]
  assign io_tlb_resp_bits_entry_perm_x = resp_entry_perm_x; // @[Repeater.scala 116:17]
  assign io_tlb_resp_bits_entry_perm_w = resp_entry_perm_w; // @[Repeater.scala 116:17]
  assign io_tlb_resp_bits_entry_perm_r = resp_entry_perm_r; // @[Repeater.scala 116:17]
  assign io_tlb_resp_bits_entry_level = resp_entry_level; // @[Repeater.scala 116:17]
  assign io_tlb_resp_bits_pf = resp_pf; // @[Repeater.scala 116:17]
  assign io_tlb_resp_bits_af = resp_af; // @[Repeater.scala 116:17]
  assign io_ptw_req_0_valid = sent; // @[Repeater.scala 108:20]
  assign io_ptw_req_0_bits_vpn = req_vpn; // @[Repeater.scala 109:19]
  assign io_ptw_resp_ready = ~recv; // @[Repeater.scala 114:21]
  assign delay_clock = clock;
  assign delay_io_in = io_sfence_valid | io_csr_satp_changed; // @[Repeater.scala 98:67]
  always @(posedge clock) begin
    ...
    end else if (_recv_T_2) begin // @[StopWatch.scala 31:19]
...
`ifdef RANDOMIZE_REG_INIT
  ...
  _RAND_12 = {1{`RANDOM}};
  resp_pf = _RAND_12[0:0];
  _RAND_13 = {1{`RANDOM}};
  resp_af = _RAND_13[0:0];
  _RAND_14 = {1{`RANDOM}};
  recv = _RAND_14[0:0];
`endif // RANDOMIZE_REG_INIT
  `endif // RANDOMIZE
