module ITTageTable_3(
  ...
  input  [6:0]  io_req_bits_folded_hist_hist_33_folded_hist,
  input  [8:0]  io_req_bits_folded_hist_hist_9_folded_hist,
  ...
  input  [6:0]  io_update_folded_hist_hist_33_folded_hist,
  input  [8:0]  io_update_folded_hist_hist_9_folded_hist,
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [37:0] _GEN_261 = {{31'd0}, io_req_bits_folded_hist_hist_33_folded_hist}; // @[ITTAGE.scala 186:31]
  wire [37:0] _idx_T = s0_unhashed_idx ^ _GEN_261; // @[ITTAGE.scala 186:31]
  wire [6:0] s0_idx = _idx_T[6:0]; // @[ITTAGE.scala 186:40]
  wire [30:0] _GEN_262 = {{22'd0}, io_req_bits_folded_hist_hist_9_folded_hist}; // @[ITTAGE.scala 187:52]
  ...
  wire [37:0] _GEN_264 = {{31'd0}, io_update_folded_hist_hist_33_folded_hist}; // @[ITTAGE.scala 186:31]
  wire [37:0] _idx_T_1 = io_update_pc[38:1] ^ _GEN_264; // @[ITTAGE.scala 186:31]
  wire [6:0] update_idx = _idx_T_1[6:0]; // @[ITTAGE.scala 186:40]
  wire [30:0] _GEN_265 = {{22'd0}, io_update_folded_hist_hist_9_folded_hist}; // @[ITTAGE.scala 187:52]
