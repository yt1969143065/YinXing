...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [2:0] _io_out_bits_T_95 = chosenOH[0] ? io_in_0_bits_param : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_96 = chosenOH[1] ? io_in_1_bits_param : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_97 = chosenOH[2] ? io_in_2_bits_param : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_98 = chosenOH[3] ? io_in_3_bits_param : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_99 = chosenOH[4] ? io_in_4_bits_param : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_100 = chosenOH[5] ? io_in_5_bits_param : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_101 = chosenOH[6] ? io_in_6_bits_param : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_102 = chosenOH[7] ? io_in_7_bits_param : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_103 = chosenOH[8] ? io_in_8_bits_param : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_104 = chosenOH[9] ? io_in_9_bits_param : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_105 = chosenOH[10] ? io_in_10_bits_param : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_106 = chosenOH[11] ? io_in_11_bits_param : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_107 = chosenOH[12] ? io_in_12_bits_param : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_108 = chosenOH[13] ? io_in_13_bits_param : 3'h0; // @[Mux.scala 27:73]
  ...
  wire [7:0] _io_out_bits_T_122 = chosenOH[0] ? io_in_0_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_123 = chosenOH[1] ? io_in_1_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_124 = chosenOH[2] ? io_in_2_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_125 = chosenOH[3] ? io_in_3_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_126 = chosenOH[4] ? io_in_4_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_127 = chosenOH[5] ? io_in_5_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_128 = chosenOH[6] ? io_in_6_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_129 = chosenOH[7] ? io_in_7_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_130 = chosenOH[8] ? io_in_8_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_131 = chosenOH[9] ? io_in_9_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_132 = chosenOH[10] ? io_in_10_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_133 = chosenOH[11] ? io_in_11_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_134 = chosenOH[12] ? io_in_12_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_135 = chosenOH[13] ? io_in_13_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_136 = _io_out_bits_T_122 | _io_out_bits_T_123; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_137 = _io_out_bits_T_136 | _io_out_bits_T_124; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_138 = _io_out_bits_T_137 | _io_out_bits_T_125; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_139 = _io_out_bits_T_138 | _io_out_bits_T_126; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_140 = _io_out_bits_T_139 | _io_out_bits_T_127; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_141 = _io_out_bits_T_140 | _io_out_bits_T_128; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_142 = _io_out_bits_T_141 | _io_out_bits_T_129; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_143 = _io_out_bits_T_142 | _io_out_bits_T_130; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_144 = _io_out_bits_T_143 | _io_out_bits_T_131; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_145 = _io_out_bits_T_144 | _io_out_bits_T_132; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_146 = _io_out_bits_T_145 | _io_out_bits_T_133; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_147 = _io_out_bits_T_146 | _io_out_bits_T_134; // @[Mux.scala 27:73]
  ...
  assign io_out_bits_param = _io_out_bits_T_120 | _io_out_bits_T_108; // @[Mux.scala 27:73]
