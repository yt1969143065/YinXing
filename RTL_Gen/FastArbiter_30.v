...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [5:0] _io_out_bits_T_46 = chosenOH[0] ? io_in_0_bits_off : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_47 = chosenOH[1] ? io_in_1_bits_off : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_48 = chosenOH[2] ? io_in_2_bits_off : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_49 = chosenOH[3] ? io_in_3_bits_off : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_50 = _io_out_bits_T_46 | _io_out_bits_T_47; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_51 = _io_out_bits_T_50 | _io_out_bits_T_48; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_53 = chosenOH[0] ? io_in_0_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_54 = chosenOH[1] ? io_in_1_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_55 = chosenOH[2] ? io_in_2_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_56 = chosenOH[3] ? io_in_3_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_57 = _io_out_bits_T_53 | _io_out_bits_T_54; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_58 = _io_out_bits_T_57 | _io_out_bits_T_55; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_60 = chosenOH[0] ? io_in_0_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_61 = chosenOH[1] ? io_in_1_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_62 = chosenOH[2] ? io_in_2_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_63 = chosenOH[3] ? io_in_3_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_64 = _io_out_bits_T_60 | _io_out_bits_T_61; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_65 = _io_out_bits_T_64 | _io_out_bits_T_62; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_67 = chosenOH[0] ? io_in_0_bits_source : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_68 = chosenOH[1] ? io_in_1_bits_source : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_69 = chosenOH[2] ? io_in_2_bits_source : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_70 = chosenOH[3] ? io_in_3_bits_source : 6'h0; // @[Mux.scala 27:73]
  ...
  wire [2:0] _io_out_bits_T_74 = chosenOH[0] ? io_in_0_bits_size : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_75 = chosenOH[1] ? io_in_1_bits_size : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_76 = chosenOH[2] ? io_in_2_bits_size : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_77 = chosenOH[3] ? io_in_3_bits_size : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_78 = _io_out_bits_T_74 | _io_out_bits_T_75; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_79 = _io_out_bits_T_78 | _io_out_bits_T_76; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_81 = chosenOH[0] ? io_in_0_bits_param : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_82 = chosenOH[1] ? io_in_1_bits_param : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_83 = chosenOH[2] ? io_in_2_bits_param : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_84 = chosenOH[3] ? io_in_3_bits_param : 3'h0; // @[Mux.scala 27:73]
  ...
  wire [2:0] _io_out_bits_T_88 = chosenOH[0] ? io_in_0_bits_opcode : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_89 = chosenOH[1] ? io_in_1_bits_opcode : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_90 = chosenOH[2] ? io_in_2_bits_opcode : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_91 = chosenOH[3] ? io_in_3_bits_opcode : 3'h0; // @[Mux.scala 27:73]
  ...
  wire [2:0] _io_out_bits_T_95 = chosenOH[0] ? io_in_0_bits_channel : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_96 = chosenOH[1] ? io_in_1_bits_channel : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_97 = chosenOH[2] ? io_in_2_bits_channel : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_98 = chosenOH[3] ? io_in_3_bits_channel : 3'h0; // @[Mux.scala 27:73]
  ...
  assign io_out_bits_channel = _io_out_bits_T_100 | _io_out_bits_T_98; // @[Mux.scala 27:73]
  assign io_out_bits_opcode = _io_out_bits_T_93 | _io_out_bits_T_91; // @[Mux.scala 27:73]
  assign io_out_bits_param = _io_out_bits_T_86 | _io_out_bits_T_84; // @[Mux.scala 27:73]
  assign io_out_bits_size = _io_out_bits_T_79 | _io_out_bits_T_77; // @[Mux.scala 27:73]
  assign io_out_bits_source = _io_out_bits_T_72 | _io_out_bits_T_70; // @[Mux.scala 27:73]
  assign io_out_bits_set = _io_out_bits_T_65 | _io_out_bits_T_63; // @[Mux.scala 27:73]
  assign io_out_bits_tag = _io_out_bits_T_58 | _io_out_bits_T_56; // @[Mux.scala 27:73]
  assign io_out_bits_off = _io_out_bits_T_51 | _io_out_bits_T_49; // @[Mux.scala 27:73]
