...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [7:0] _io_out_bits_T_14 = chosenOH[0] ? io_in_0_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_15 = chosenOH[1] ? io_in_1_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_16 = chosenOH[2] ? io_in_2_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_17 = chosenOH[3] ? io_in_3_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_18 = chosenOH[4] ? io_in_4_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_19 = chosenOH[5] ? io_in_5_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_20 = chosenOH[6] ? io_in_6_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_21 = chosenOH[7] ? io_in_7_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_22 = chosenOH[8] ? io_in_8_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_23 = chosenOH[9] ? io_in_9_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_24 = chosenOH[10] ? io_in_10_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_25 = chosenOH[11] ? io_in_11_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_26 = chosenOH[12] ? io_in_12_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_27 = chosenOH[13] ? io_in_13_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_28 = _io_out_bits_T_14 | _io_out_bits_T_15; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_29 = _io_out_bits_T_28 | _io_out_bits_T_16; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_30 = _io_out_bits_T_29 | _io_out_bits_T_17; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_31 = _io_out_bits_T_30 | _io_out_bits_T_18; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_32 = _io_out_bits_T_31 | _io_out_bits_T_19; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_33 = _io_out_bits_T_32 | _io_out_bits_T_20; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_34 = _io_out_bits_T_33 | _io_out_bits_T_21; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_35 = _io_out_bits_T_34 | _io_out_bits_T_22; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_36 = _io_out_bits_T_35 | _io_out_bits_T_23; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_37 = _io_out_bits_T_36 | _io_out_bits_T_24; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_38 = _io_out_bits_T_37 | _io_out_bits_T_25; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_39 = _io_out_bits_T_38 | _io_out_bits_T_26; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_41 = chosenOH[0] ? io_in_0_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_42 = chosenOH[1] ? io_in_1_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_43 = chosenOH[2] ? io_in_2_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_44 = chosenOH[3] ? io_in_3_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_45 = chosenOH[4] ? io_in_4_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_46 = chosenOH[5] ? io_in_5_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_47 = chosenOH[6] ? io_in_6_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_48 = chosenOH[7] ? io_in_7_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_49 = chosenOH[8] ? io_in_8_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_50 = chosenOH[9] ? io_in_9_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_51 = chosenOH[10] ? io_in_10_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_52 = chosenOH[11] ? io_in_11_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_53 = chosenOH[12] ? io_in_12_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_54 = chosenOH[13] ? io_in_13_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_55 = _io_out_bits_T_41 | _io_out_bits_T_42; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_56 = _io_out_bits_T_55 | _io_out_bits_T_43; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_57 = _io_out_bits_T_56 | _io_out_bits_T_44; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_58 = _io_out_bits_T_57 | _io_out_bits_T_45; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_59 = _io_out_bits_T_58 | _io_out_bits_T_46; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_60 = _io_out_bits_T_59 | _io_out_bits_T_47; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_61 = _io_out_bits_T_60 | _io_out_bits_T_48; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_62 = _io_out_bits_T_61 | _io_out_bits_T_49; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_63 = _io_out_bits_T_62 | _io_out_bits_T_50; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_64 = _io_out_bits_T_63 | _io_out_bits_T_51; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_65 = _io_out_bits_T_64 | _io_out_bits_T_52; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_66 = _io_out_bits_T_65 | _io_out_bits_T_53; // @[Mux.scala 27:73]
  ...
  assign io_out_bits_tag = _io_out_bits_T_66 | _io_out_bits_T_54; // @[Mux.scala 27:73]
  assign io_out_bits_set = _io_out_bits_T_39 | _io_out_bits_T_27; // @[Mux.scala 27:73]
