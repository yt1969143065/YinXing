module SelectPolicy_8(
  ...
  wire  matrix_1_1_0 = ~(|emptyVec_7); // @[BitUtils.scala 222:50]
  wire [1:0] _matrix_2_0_T_3 = {emptyVec_7,emptyVec_6}; // @[Cat.scala 31:58]
  wire  matrix_1_2_0 = ~(|_matrix_2_0_T_3); // @[BitUtils.scala 222:50]
  wire [2:0] _matrix_3_0_T_3 = {emptyVec_7,emptyVec_6,emptyVec_5}; // @[Cat.scala 31:58]
  wire  matrix_1_3_0 = ~(|_matrix_3_0_T_3); // @[BitUtils.scala 222:50]
  wire [3:0] _matrix_4_0_T_3 = {emptyVec_7,emptyVec_6,emptyVec_5,emptyVec_4}; // @[Cat.scala 31:58]
  wire  matrix_1_4_0 = ~(|_matrix_4_0_T_3); // @[BitUtils.scala 222:50]
  wire [4:0] _matrix_5_0_T_3 = {emptyVec_7,emptyVec_6,emptyVec_5,emptyVec_4,emptyVec_3}; // @[Cat.scala 31:58]
  wire  matrix_1_5_0 = ~(|_matrix_5_0_T_3); // @[BitUtils.scala 222:50]
  wire [5:0] _matrix_6_0_T_3 = {emptyVec_7,emptyVec_6,emptyVec_5,emptyVec_4,emptyVec_3,emptyVec_2}; // @[Cat.scala 31:58]
  wire  matrix_1_6_0 = ~(|_matrix_6_0_T_3); // @[BitUtils.scala 222:50]
  wire [6:0] _matrix_7_0_T_3 = {emptyVec_7,emptyVec_6,emptyVec_5,emptyVec_4,emptyVec_3,emptyVec_2,emptyVec_1}; // @[Cat.scala 31:58]
  wire  matrix_1_7_0 = ~(|_matrix_7_0_T_3); // @[BitUtils.scala 222:50]
  wire  _moreThan_T_83 = emptyVec_1 & (emptyVec_2 | (emptyVec_3 | (emptyVec_4 | (emptyVec_5 | (emptyVec_6 | emptyVec_7))
    ))) | (emptyVec_2 & (emptyVec_3 | (emptyVec_4 | (emptyVec_5 | (emptyVec_6 | emptyVec_7)))) | (emptyVec_3 & (
    emptyVec_4 | (emptyVec_5 | (emptyVec_6 | emptyVec_7))) | (emptyVec_4 & (emptyVec_5 | (emptyVec_6 | emptyVec_7)) | (
    emptyVec_5 & (emptyVec_6 | emptyVec_7) | emptyVec_6 & emptyVec_7)))); // @[BitUtils.scala 199:49]
  ...
  wire [3:0] io_allocate_0_bits_lo = {sel__3,sel__2,sel__1,emptyVec_0}; // @[SelectPolicy.scala 43:35]
  wire [3:0] io_allocate_0_bits_hi = {sel__7,sel__6,sel__5,sel__4}; // @[SelectPolicy.scala 43:35]
  wire  sel_1_1 = emptyVec_6 & matrix_1_1_0; // @[BitUtils.scala 239:62]
  wire  sel_1_2 = emptyVec_5 & matrix_1_2_0; // @[BitUtils.scala 239:62]
  wire  sel_1_3 = emptyVec_4 & matrix_1_3_0; // @[BitUtils.scala 239:62]
  wire  sel_1_4 = emptyVec_3 & matrix_1_4_0; // @[BitUtils.scala 239:62]
  wire  sel_1_5 = emptyVec_2 & matrix_1_5_0; // @[BitUtils.scala 239:62]
  wire  sel_1_6 = emptyVec_1 & matrix_1_6_0; // @[BitUtils.scala 239:62]
  wire  sel_1_7 = emptyVec_0 & matrix_1_7_0; // @[BitUtils.scala 239:62]
  wire [3:0] io_allocate_1_bits_lo = {sel_1_4,sel_1_5,sel_1_6,sel_1_7}; // @[SelectPolicy.scala 43:35]
  wire [3:0] io_allocate_1_bits_hi = {emptyVec_7,sel_1_1,sel_1_2,sel_1_3}; // @[SelectPolicy.scala 43:35]
  ...
  wire [3:0] io_grant_0_bits_lo = {sel_2_3,sel_2_2,sel_2_1,request_0}; // @[SelectPolicy.scala 56:32]
  wire [3:0] io_grant_0_bits_hi = {sel_2_7,sel_2_6,sel_2_5,sel_2_4}; // @[SelectPolicy.scala 56:32]
  assign io_allocate_0_valid = emptyVec_0 | (emptyVec_1 | (emptyVec_2 | (emptyVec_3 | (emptyVec_4 | (emptyVec_5 | (
    emptyVec_6 | emptyVec_7)))))); // @[BitUtils.scala 199:49]
  ...
  assign io_allocate_1_valid = emptyVec_0 & (emptyVec_1 | (emptyVec_2 | (emptyVec_3 | (emptyVec_4 | (emptyVec_5 | (
    emptyVec_6 | emptyVec_7)))))) | _moreThan_T_83; // @[BitUtils.scala 199:49]
  ...
  assign io_grant_0_valid = request_0 | (request_1 | (request_2 | (request_3 | (request_4 | (request_5 | (request_6 |
    request_7)))))); // @[BitUtils.scala 199:49]
