...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [37:0] _GEN_876 = {{34'd0}, io_req_bits_folded_hist_hist_7_folded_hist}; // @[Tage.scala 285:29]
  wire [37:0] _idx_T = req_unhashed_idx ^ _GEN_876; // @[Tage.scala 285:29]
  wire [6:0] s0_idx = _idx_T[6:0]; // @[Tage.scala 285:38]
  wire [4:0] _tag_T_1 = {io_req_bits_folded_hist_hist_7_folded_hist, 1'h0}; // @[Tage.scala 286:52]
  wire [37:0] _GEN_878 = {{33'd0}, _tag_T_1}; // @[Tage.scala 286:38]
  wire [37:0] _tag_T_2 = _idx_T ^ _GEN_878; // @[Tage.scala 286:38]
  ...
  wire [37:0] _GEN_879 = {{34'd0}, io_update_folded_hist_hist_7_folded_hist}; // @[Tage.scala 285:29]
  wire [37:0] _idx_T_1 = update_unhashed_idx ^ _GEN_879; // @[Tage.scala 285:29]
  wire [6:0] update_idx = _idx_T_1[6:0]; // @[Tage.scala 285:38]
  wire [4:0] _tag_T_4 = {io_update_folded_hist_hist_7_folded_hist, 1'h0}; // @[Tage.scala 286:52]
  wire [37:0] _GEN_881 = {{33'd0}, _tag_T_4}; // @[Tage.scala 286:38]
  wire [37:0] _tag_T_5 = _idx_T_1 ^ _GEN_881; // @[Tage.scala 286:38]
