...
`endif // RANDOMIZE_REG_INIT
  reg [1:0] sel_rREG; // @[Pipeline.scala 42:31]
  ...
  reg  en_REG; // @[Pipeline.scala 42:31]
  ...
  reg [1:0] sel_rREG_1; // @[Pipeline.scala 42:31]
  ...
  reg  en_REG_1; // @[Pipeline.scala 42:31]
  ...
  always @(posedge clock) begin
    sel_rREG <= io_sel_0; // @[Pipeline.scala 42:31]
    sel_r <= sel_rREG; // @[Pipeline.scala 42:31]
    en_REG <= io_en_0; // @[Pipeline.scala 42:31]
    en <= en_REG; // @[Pipeline.scala 42:31]
    ...
    sel_rREG_1 <= io_sel_1; // @[Pipeline.scala 42:31]
    sel_r1 <= sel_rREG_1; // @[Pipeline.scala 42:31]
    en_REG_1 <= io_en_1; // @[Pipeline.scala 42:31]
    en_1 <= en_REG_1; // @[Pipeline.scala 42:31]
...
`ifdef RANDOMIZE_REG_INIT
  ...
  en = _RAND_3[0:0];
  _RAND_4 = {2{`RANDOM}};
  io_out_0_r = _RAND_4[63:0];
  _RAND_5 = {2{`RANDOM}};
  io_out_0_REG = _RAND_5[63:0];
  _RAND_6 = {1{`RANDOM}};
  io_err_out_0_r = _RAND_6[0:0];
  _RAND_7 = {1{`RANDOM}};
  io_err_out_0_REG = _RAND_7[0:0];
  _RAND_8 = {1{`RANDOM}};
  sel_rREG_1 = _RAND_8[1:0];
  _RAND_9 = {1{`RANDOM}};
  sel_r1 = _RAND_9[1:0];
  _RAND_10 = {1{`RANDOM}};
  en_REG_1 = _RAND_10[0:0];
  _RAND_11 = {1{`RANDOM}};
  en_1 = _RAND_11[0:0];
  _RAND_12 = {2{`RANDOM}};
  io_out_1_r = _RAND_12[63:0];
  _RAND_13 = {2{`RANDOM}};
  io_out_1_REG = _RAND_13[63:0];
  _RAND_14 = {1{`RANDOM}};
  io_err_out_1_r = _RAND_14[0:0];
  _RAND_15 = {1{`RANDOM}};
  io_err_out_1_REG = _RAND_15[0:0];
`endif // RANDOMIZE_REG_INIT
  `endif // RANDOMIZE
end // initial
