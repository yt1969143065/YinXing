...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [2:0] _io_out_bits_T_68 = chosenOH[0] ? io_in_0_bits_param : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_69 = chosenOH[1] ? io_in_1_bits_param : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_70 = chosenOH[2] ? io_in_2_bits_param : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_71 = chosenOH[3] ? io_in_3_bits_param : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_72 = chosenOH[4] ? io_in_4_bits_param : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_73 = chosenOH[5] ? io_in_5_bits_param : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_74 = chosenOH[6] ? io_in_6_bits_param : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_75 = chosenOH[7] ? io_in_7_bits_param : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_76 = chosenOH[8] ? io_in_8_bits_param : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_77 = chosenOH[9] ? io_in_9_bits_param : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_78 = chosenOH[10] ? io_in_10_bits_param : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_79 = chosenOH[11] ? io_in_11_bits_param : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_80 = chosenOH[12] ? io_in_12_bits_param : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_81 = chosenOH[13] ? io_in_13_bits_param : 3'h0; // @[Mux.scala 27:73]
  ...
  wire [15:0] _io_out_bits_T_95 = chosenOH[0] ? io_in_0_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_96 = chosenOH[1] ? io_in_1_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_97 = chosenOH[2] ? io_in_2_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_98 = chosenOH[3] ? io_in_3_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_99 = chosenOH[4] ? io_in_4_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_100 = chosenOH[5] ? io_in_5_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_101 = chosenOH[6] ? io_in_6_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_102 = chosenOH[7] ? io_in_7_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_103 = chosenOH[8] ? io_in_8_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_104 = chosenOH[9] ? io_in_9_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_105 = chosenOH[10] ? io_in_10_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_106 = chosenOH[11] ? io_in_11_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_107 = chosenOH[12] ? io_in_12_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_108 = chosenOH[13] ? io_in_13_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_109 = _io_out_bits_T_95 | _io_out_bits_T_96; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_110 = _io_out_bits_T_109 | _io_out_bits_T_97; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_111 = _io_out_bits_T_110 | _io_out_bits_T_98; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_112 = _io_out_bits_T_111 | _io_out_bits_T_99; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_113 = _io_out_bits_T_112 | _io_out_bits_T_100; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_114 = _io_out_bits_T_113 | _io_out_bits_T_101; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_115 = _io_out_bits_T_114 | _io_out_bits_T_102; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_116 = _io_out_bits_T_115 | _io_out_bits_T_103; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_117 = _io_out_bits_T_116 | _io_out_bits_T_104; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_118 = _io_out_bits_T_117 | _io_out_bits_T_105; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_119 = _io_out_bits_T_118 | _io_out_bits_T_106; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_120 = _io_out_bits_T_119 | _io_out_bits_T_107; // @[Mux.scala 27:73]
  ...
  assign io_out_bits_param = _io_out_bits_T_93 | _io_out_bits_T_81; // @[Mux.scala 27:73]
  assign io_out_bits_clients = chosenOH[0] & io_in_0_bits_clients | chosenOH[1] & io_in_1_bits_clients | chosenOH[2] &
    io_in_2_bits_clients | chosenOH[3] & io_in_3_bits_clients | chosenOH[4] & io_in_4_bits_clients | chosenOH[5] &
    io_in_5_bits_clients | chosenOH[6] & io_in_6_bits_clients | chosenOH[7] & io_in_7_bits_clients | chosenOH[8] &
    io_in_8_bits_clients | chosenOH[9] & io_in_9_bits_clients | chosenOH[10] & io_in_10_bits_clients | chosenOH[11] &
    io_in_11_bits_clients | chosenOH[12] & io_in_12_bits_clients | chosenOH[13] & io_in_13_bits_clients; // @[Mux.scala 27:73]
