...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [5:0] _io_out_bits_T_2 = chosenOH[0] ? io_in_0_bits_source : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_3 = chosenOH[1] ? io_in_1_bits_source : 6'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_8 = chosenOH[0] ? io_in_0_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _io_out_bits_T_9 = chosenOH[1] ? io_in_1_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_11 = chosenOH[0] ? io_in_0_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _io_out_bits_T_12 = chosenOH[1] ? io_in_1_bits_tag : 22'h0; // @[Mux.scala 27:73]
  ...
  assign io_out_bits_tag = _io_out_bits_T_11 | _io_out_bits_T_12; // @[Mux.scala 27:73]
  assign io_out_bits_set = _io_out_bits_T_8 | _io_out_bits_T_9; // @[Mux.scala 27:73]
  assign io_out_bits_needT = chosenOH[0] & io_in_0_bits_needT | chosenOH[1] & io_in_1_bits_needT; // @[Mux.scala 27:73]
  assign io_out_bits_source = _io_out_bits_T_2 | _io_out_bits_T_3; // @[Mux.scala 27:73]
