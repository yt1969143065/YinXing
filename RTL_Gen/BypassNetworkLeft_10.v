...
`endif // RANDOMIZE_REG_INIT
  ...
  reg [63:0] bypassedData_2; // @[BypassNetwork.scala 89:25]
  ...
  wire [1:0] _bypassedData_2_target_T = {io_bypass_1_valid_2,io_bypass_0_valid_2}; // @[BypassNetwork.scala 48:32]
  wire [63:0] _bypassedData_2_target_T_2 = io_bypass_0_valid_2 ? io_bypass_0_data : 64'h0; // @[Mux.scala 27:73]
  wire [63:0] _bypassedData_2_target_T_3 = io_bypass_1_valid_2 ? io_bypass_1_data : 64'h0; // @[Mux.scala 27:73]
  wire [63:0] _bypassedData_2_target_T_4 = _bypassedData_2_target_T_2 | _bypassedData_2_target_T_3; // @[Mux.scala 27:73]
  assign io_target_0 = bypassedData_0; // @[BypassNetwork.scala 97:13]
  assign io_target_1 = bypassedData_1; // @[BypassNetwork.scala 97:13]
  assign io_target_2 = bypassedData_2; // @[BypassNetwork.scala 97:13]
  always @(posedge clock) begin
    ...
    if (~io_hold) begin // @[BypassNetwork.scala 91:19]
      if (|_bypassedData_2_target_T) begin // @[BypassNetwork.scala 48:21]
        bypassedData_2 <= _bypassedData_2_target_T_4;
      end else begin
        bypassedData_2 <= io_source_2;
      end
    end
  end
