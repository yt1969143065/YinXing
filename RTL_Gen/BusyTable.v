module BusyTable(
  ...
  input  [6:0] io_wbPregs_5_bits,
  input        io_wbPregs_6_valid,
  input  [6:0] io_wbPregs_6_bits,
  ...
  input  [6:0] io_read_8_req,
  output       io_read_8_resp,
  input  [6:0] io_read_9_req,
  output       io_read_9_resp,
  input  [6:0] io_read_10_req,
  output       io_read_10_resp,
  input  [6:0] io_read_11_req,
  output       io_read_11_resp,
  input  [6:0] io_read_12_req,
  output       io_read_12_resp,
  input  [6:0] io_read_13_req,
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [127:0] _wbMask_T_10 = 128'h1 << io_wbPregs_5_bits; // @[OneHot.scala 57:35]
  wire [127:0] _wbMask_T_11 = io_wbPregs_5_valid ? _wbMask_T_10 : 128'h0; // @[BusyTable.scala 44:33]
  wire [127:0] _wbMask_T_12 = 128'h1 << io_wbPregs_6_bits; // @[OneHot.scala 57:35]
  wire [127:0] _wbMask_T_13 = io_wbPregs_6_valid ? _wbMask_T_12 : 128'h0; // @[BusyTable.scala 44:33]
  wire [127:0] _wbMask_T_14 = _wbMask_T_3 | _wbMask_T_5; // @[ParallelMux.scala 37:55]
  wire [127:0] _wbMask_T_15 = _wbMask_T_1 | _wbMask_T_14; // @[ParallelMux.scala 37:55]
  wire [127:0] _wbMask_T_16 = _wbMask_T_7 | _wbMask_T_9; // @[ParallelMux.scala 37:55]
  wire [127:0] _wbMask_T_17 = _wbMask_T_11 | _wbMask_T_13; // @[ParallelMux.scala 37:55]
  wire [127:0] _wbMask_T_18 = _wbMask_T_16 | _wbMask_T_17; // @[ParallelMux.scala 37:55]
  wire [127:0] wbMask = _wbMask_T_15 | _wbMask_T_18; // @[ParallelMux.scala 37:55]
  ...
  wire [95:0] _io_read_8_resp_T = table_ >> io_read_8_req; // @[BusyTable.scala 53:36]
  wire [95:0] _io_read_9_resp_T = table_ >> io_read_9_req; // @[BusyTable.scala 53:36]
  wire [95:0] _io_read_10_resp_T = table_ >> io_read_10_req; // @[BusyTable.scala 53:36]
  wire [95:0] _io_read_11_resp_T = table_ >> io_read_11_req; // @[BusyTable.scala 53:36]
  wire [95:0] _io_read_12_resp_T = table_ >> io_read_12_req; // @[BusyTable.scala 53:36]
  wire [95:0] _io_read_13_resp_T = table_ >> io_read_13_req; // @[BusyTable.scala 53:36]
  ...
  assign io_read_8_resp = ~_io_read_8_resp_T[0]; // @[BusyTable.scala 53:30]
  assign io_read_9_resp = ~_io_read_9_resp_T[0]; // @[BusyTable.scala 53:30]
  assign io_read_10_resp = ~_io_read_10_resp_T[0]; // @[BusyTable.scala 53:30]
  assign io_read_11_resp = ~_io_read_11_resp_T[0]; // @[BusyTable.scala 53:30]
  assign io_read_12_resp = ~_io_read_12_resp_T[0]; // @[BusyTable.scala 53:30]
  assign io_read_13_resp = ~_io_read_13_resp_T[0]; // @[BusyTable.scala 53:30]
