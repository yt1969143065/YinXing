module AXI4Deinterleaver_1(
  ...
  wire  deq_io_enq_bits_echo_tl_state_source; // @[Decoupled.scala 361:21]
  ...
  wire  deq_io_deq_bits_echo_tl_state_source; // @[Decoupled.scala 361:21]
  wire  deq_io_deq_bits_last; // @[Decoupled.scala 361:21]
  Queue_135 deq ( // @[Decoupled.scala 361:21]
    .clock(deq_clock),
    .reset(deq_reset),
