module FMUL_1(
  ...
  wire [53:0] multiplier_io_a; // @[FMUL.scala 262:26]
  wire [53:0] multiplier_io_b; // @[FMUL.scala 262:26]
  wire [107:0] multiplier_io_result; // @[FMUL.scala 262:26]
  wire [63:0] fmul_s1_io_a; // @[FMUL.scala 263:23]
  wire [63:0] fmul_s1_io_b; // @[FMUL.scala 263:23]
  ...
  wire [11:0] fmul_s1_io_out_shift_amt; // @[FMUL.scala 263:23]
  wire [11:0] fmul_s1_io_out_exp_shifted; // @[FMUL.scala 263:23]
  ...
  wire [11:0] fmul_s2_io_in_shift_amt; // @[FMUL.scala 264:23]
  wire [11:0] fmul_s2_io_in_exp_shifted; // @[FMUL.scala 264:23]
  wire  fmul_s2_io_in_may_be_subnormal; // @[FMUL.scala 264:23]
  wire [2:0] fmul_s2_io_in_rm; // @[FMUL.scala 264:23]
  wire [105:0] fmul_s2_io_prod; // @[FMUL.scala 264:23]
  ...
  wire [105:0] fmul_s2_io_out_prod; // @[FMUL.scala 264:23]
  wire  fmul_s2_io_out_prod_sign; // @[FMUL.scala 264:23]
  wire [11:0] fmul_s2_io_out_shift_amt; // @[FMUL.scala 264:23]
  wire [11:0] fmul_s2_io_out_exp_shifted; // @[FMUL.scala 264:23]
  ...
  wire [105:0] fmul_s3_io_in_prod; // @[FMUL.scala 265:23]
  wire  fmul_s3_io_in_prod_sign; // @[FMUL.scala 265:23]
  wire [11:0] fmul_s3_io_in_shift_amt; // @[FMUL.scala 265:23]
  wire [11:0] fmul_s3_io_in_exp_shifted; // @[FMUL.scala 265:23]
  wire  fmul_s3_io_in_may_be_subnormal; // @[FMUL.scala 265:23]
  wire [2:0] fmul_s3_io_in_rm; // @[FMUL.scala 265:23]
  wire [63:0] fmul_s3_io_result; // @[FMUL.scala 265:23]
  wire [4:0] fmul_s3_io_fflags; // @[FMUL.scala 265:23]
  wire  fmul_s3_io_to_fadd_fp_prod_sign; // @[FMUL.scala 265:23]
  wire [10:0] fmul_s3_io_to_fadd_fp_prod_exp; // @[FMUL.scala 265:23]
  wire [104:0] fmul_s3_io_to_fadd_fp_prod_sig; // @[FMUL.scala 265:23]
  ...
  wire [10:0] raw_a_fp_exp = io_a[62:52]; // @[package.scala 60:18]
  wire [51:0] raw_a_fp_sig = io_a[51:0]; // @[package.scala 61:18]
  wire  raw_a_raw_nz = |raw_a_fp_exp; // @[package.scala 81:72]
  wire [52:0] raw_a_sig = {raw_a_raw_nz,raw_a_fp_sig}; // @[Cat.scala 31:58]
  wire [10:0] raw_bfp_exp = io_b[62:52]; // @[package.scala 60:18]
  wire [51:0] raw_bfp_sig = io_b[51:0]; // @[package.scala 61:18]
  wire  raw_braw_nz = |raw_bfp_exp; // @[package.scala 81:72]
  wire [52:0] raw_bsig = {raw_braw_nz,raw_bfp_sig}; // @[Cat.scala 31:58]
  Multiplier_2 multiplier ( // @[FMUL.scala 262:26]
    .io_a(multiplier_io_a),
    .io_b(multiplier_io_b),
    .io_result(multiplier_io_result)
  );
  FMUL_s1_1 fmul_s1 ( // @[FMUL.scala 263:23]
    .io_a(fmul_s1_io_a),
    .io_b(fmul_s1_io_b),
    .io_rm(fmul_s1_io_rm),
  ...
  FMUL_s2_1 fmul_s2 ( // @[FMUL.scala 264:23]
  ...
  FMUL_s3_1 fmul_s3 ( // @[FMUL.scala 265:23]
  ...
  assign fmul_s2_io_prod = multiplier_io_result[105:0]; // @[FMUL.scala 280:19]
