module Pipeline_1(
  ...
  output [7:0] io_out_bits_req_set,
  ...
  wire [7:0] stages_0_io_enq_bits_req_set; // @[Pipeline.scala 11:47]
  ...
  wire [2:0] stages_0_io_enq_bits_req_way; // @[Pipeline.scala 11:47]
  ...
  wire [7:0] stages_0_io_deq_bits_req_set; // @[Pipeline.scala 11:47]
  ...
  wire [2:0] stages_0_io_deq_bits_req_way; // @[Pipeline.scala 11:47]
  ...
  wire [7:0] stages_1_io_enq_bits_req_set; // @[Pipeline.scala 11:47]
  ...
  wire [2:0] stages_1_io_enq_bits_req_way; // @[Pipeline.scala 11:47]
  ...
  wire [7:0] stages_1_io_deq_bits_req_set; // @[Pipeline.scala 11:47]
  ...
  wire [2:0] stages_1_io_deq_bits_req_way; // @[Pipeline.scala 11:47]
  ...
  Queue_222 stages_0 ( // @[Pipeline.scala 11:47]
  ...
  Queue_222 stages_1 ( // @[Pipeline.scala 11:47]
  ...
  assign io_out_bits_counter = stages_1_io_deq_bits_counter; // @[Pipeline.scala 18:10]
  assign io_out_bits_beat = stages_1_io_deq_bits_beat; // @[Pipeline.scala 18:10]
  assign io_out_bits_needPb = stages_1_io_deq_bits_needPb; // @[Pipeline.scala 18:10]
  assign io_out_bits_isReleaseAck = stages_1_io_deq_bits_isReleaseAck; // @[Pipeline.scala 18:10]
  assign io_out_bits_req_sourceId = stages_1_io_deq_bits_req_sourceId; // @[Pipeline.scala 18:10]
  assign io_out_bits_req_set = stages_1_io_deq_bits_req_set; // @[Pipeline.scala 18:10]
  assign io_out_bits_req_opcode = stages_1_io_deq_bits_req_opcode; // @[Pipeline.scala 18:10]
  assign io_out_bits_req_param = stages_1_io_deq_bits_req_param; // @[Pipeline.scala 18:10]
  assign io_out_bits_req_size = stages_1_io_deq_bits_req_size; // @[Pipeline.scala 18:10]
  assign io_out_bits_req_way = stages_1_io_deq_bits_req_way; // @[Pipeline.scala 18:10]
  assign io_out_bits_req_denied = stages_1_io_deq_bits_req_denied; // @[Pipeline.scala 18:10]
  assign io_out_bits_req_sinkId = stages_1_io_deq_bits_req_sinkId; // @[Pipeline.scala 18:10]
  assign io_out_bits_req_dirty = stages_1_io_deq_bits_req_dirty; // @[Pipeline.scala 18:10]
