module IntToFP_postnorm_1(
  ...
  wire [10:0] _GEN_1 = {{10'd0}, rounder_io_cout}; // @[IntToFP.scala 88:39]
  wire [10:0] _exp_T_1 = exp_raw + _GEN_1; // @[IntToFP.scala 88:39]
  wire [10:0] exp = io_in_is_zero ? 11'h0 : _exp_T_1; // @[IntToFP.scala 88:16]
  wire [11:0] io_result_hi = {io_in_sign,exp}; // @[Cat.scala 31:58]
