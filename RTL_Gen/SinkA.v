module SinkA(
  ...
  output         io_alloc_bits_needHint,
  output         io_alloc_bits_isPrefetch,
  output [1:0]   io_alloc_bits_alias,
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [28:0] set = io_a_bits_address[35:7]; // @[HuanCun.scala 139:22]
  ...
  assign io_alloc_bits_needHint = io_a_bits_user_needHint; // @[SinkA.scala 87:32]
  assign io_alloc_bits_isPrefetch = io_a_bits_opcode == 3'h5; // @[SinkA.scala 88:51]
  assign io_alloc_bits_alias = io_a_bits_user_alias; // @[SinkA.scala 89:29]
