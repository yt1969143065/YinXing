module Arbiter_9(
  ...
  wire [1:0] _GEN_0 = io_in_1_valid ? 2'h1 : 2'h2; // @[Arbiter.scala 138:13 141:26 142:17]
  wire [1:0] _GEN_1 = io_in_1_valid ? io_in_1_bits_source : 2'h2; // @[Arbiter.scala 139:15 141:26 143:19]
  wire [26:0] _GEN_2 = io_in_1_valid ? io_in_1_bits_vpn : io_in_2_bits_vpn; // @[Arbiter.scala 139:15 141:26 143:19]
  ...
  assign io_out_bits_vpn = io_in_0_valid ? io_in_0_bits_vpn : _GEN_2; // @[Arbiter.scala 141:26 143:19]
  assign io_out_bits_source = io_in_0_valid ? io_in_0_bits_source : _GEN_1; // @[Arbiter.scala 141:26 143:19]
  assign io_chosen = io_in_0_valid ? 2'h0 : _GEN_0; // @[Arbiter.scala 141:26 142:17]
endmodule
