...
`endif // RANDOMIZE_REG_INIT
  ...
  always @(posedge clock) begin
    if (reset) begin // @[InstrUncache.scala 57:22]
      state <= 2'h0; // @[InstrUncache.scala 57:22]
    end else if (_T_4) begin // @[InstrUncache.scala 126:32]
      if (io_resp_valid) begin // @[InstrUncache.scala 130:40]
        state <= 2'h0; // @[InstrUncache.scala 131:13]
      end else begin
        state <= _GEN_23;
      end
    end else begin
