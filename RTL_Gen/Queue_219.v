...
`endif // RANDOMIZE_REG_INIT
  reg [21:0] ram_tag [0:0]; // @[Decoupled.scala 259:95]
  wire  ram_tag_io_deq_bits_MPORT_en; // @[Decoupled.scala 259:95]
  wire  ram_tag_io_deq_bits_MPORT_addr; // @[Decoupled.scala 259:95]
  wire [21:0] ram_tag_io_deq_bits_MPORT_data; // @[Decoupled.scala 259:95]
  wire [21:0] ram_tag_MPORT_data; // @[Decoupled.scala 259:95]
  ...
  reg  ram_needT [0:0]; // @[Decoupled.scala 259:95]
  wire  ram_needT_io_deq_bits_MPORT_en; // @[Decoupled.scala 259:95]
  wire  ram_needT_io_deq_bits_MPORT_addr; // @[Decoupled.scala 259:95]
  wire  ram_needT_io_deq_bits_MPORT_data; // @[Decoupled.scala 259:95]
  wire  ram_needT_MPORT_data; // @[Decoupled.scala 259:95]
  wire  ram_needT_MPORT_addr; // @[Decoupled.scala 259:95]
  wire  ram_needT_MPORT_mask; // @[Decoupled.scala 259:95]
  wire  ram_needT_MPORT_en; // @[Decoupled.scala 259:95]
  ...
  assign ram_needT_io_deq_bits_MPORT_en = 1'h1;
  assign ram_needT_io_deq_bits_MPORT_addr = 1'h0;
  assign ram_needT_io_deq_bits_MPORT_data = ram_needT[ram_needT_io_deq_bits_MPORT_addr]; // @[Decoupled.scala 259:95]
  assign ram_needT_MPORT_data = io_enq_bits_needT;
  assign ram_needT_MPORT_addr = 1'h0;
  assign ram_needT_MPORT_mask = 1'h1;
  assign ram_needT_MPORT_en = io_enq_ready & io_enq_valid;
  ...
  assign io_deq_bits_needT = ram_needT_io_deq_bits_MPORT_data; // @[Decoupled.scala 296:17]
  ...
  always @(posedge clock) begin
    ...
    if (ram_needT_MPORT_en & ram_needT_MPORT_mask) begin
      ram_needT[ram_needT_MPORT_addr] <= ram_needT_MPORT_data; // @[Decoupled.scala 259:95]
    end
...
`ifdef RANDOMIZE_MEM_INIT
  ...
  for (initvar = 0; initvar < 1; initvar = initvar+1)
    ram_tag[initvar] = _RAND_0[21:0];
  _RAND_1 = {1{`RANDOM}};
  for (initvar = 0; initvar < 1; initvar = initvar+1)
    ram_set[initvar] = _RAND_1[7:0];
  _RAND_2 = {1{`RANDOM}};
  for (initvar = 0; initvar < 1; initvar = initvar+1)
    ram_needT[initvar] = _RAND_2[0:0];
  _RAND_3 = {1{`RANDOM}};
  for (initvar = 0; initvar < 1; initvar = initvar+1)
