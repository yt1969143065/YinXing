module DispatchArbiter(
  ...
  wire  _io_out_2_valid_T = 4'h0 == io_in_bits_ctrl_fuType; // @[Exu.scala 104:32]
  wire  _io_out_2_valid_T_1 = 4'h2 == io_in_bits_ctrl_fuType; // @[Exu.scala 104:32]
  wire  _io_out_2_valid_T_2 = 4'h3 == io_in_bits_ctrl_fuType; // @[Exu.scala 104:32]
  wire  _io_out_2_valid_T_3 = 4'h1 == io_in_bits_ctrl_fuType; // @[Exu.scala 104:32]
  ...
  wire  _io_out_2_valid_T_5 = |_io_out_2_valid_T_4; // @[Exu.scala 104:48]
  ...
  wire [2:0] _io_in_ready_T_3 = {_io_in_ready_T_2,_io_in_ready_T_1,_io_in_ready_T}; // @[Scheduler.scala 48:48]
  assign io_in_ready = |_io_in_ready_T_3; // @[Scheduler.scala 48:55]
  ...
  assign io_out_2_valid = io_in_valid & _io_out_2_valid_T_5; // @[Scheduler.scala 44:28]
  assign io_out_2_bits_cf_trigger_backendEn_0 = io_in_bits_cf_trigger_backendEn_0; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_cf_trigger_backendEn_1 = io_in_bits_cf_trigger_backendEn_1; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_cf_trigger_backendHit_0 = io_in_bits_cf_trigger_backendHit_0; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_cf_trigger_backendHit_1 = io_in_bits_cf_trigger_backendHit_1; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_cf_trigger_backendHit_2 = io_in_bits_cf_trigger_backendHit_2; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_cf_trigger_backendHit_3 = io_in_bits_cf_trigger_backendHit_3; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_cf_trigger_backendHit_4 = io_in_bits_cf_trigger_backendHit_4; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_cf_trigger_backendHit_5 = io_in_bits_cf_trigger_backendHit_5; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_cf_pd_isRVC = io_in_bits_cf_pd_isRVC; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_cf_pd_brType = io_in_bits_cf_pd_brType; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_cf_pd_isCall = io_in_bits_cf_pd_isCall; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_cf_pd_isRet = io_in_bits_cf_pd_isRet; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_cf_pred_taken = io_in_bits_cf_pred_taken; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_cf_ssid = io_in_bits_cf_ssid; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_cf_ftqPtr_flag = io_in_bits_cf_ftqPtr_flag; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_cf_ftqPtr_value = io_in_bits_cf_ftqPtr_value; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_cf_ftqOffset = io_in_bits_cf_ftqOffset; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_ctrl_srcType_0 = io_in_bits_ctrl_srcType_0; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_ctrl_srcType_1 = io_in_bits_ctrl_srcType_1; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_ctrl_fuType = io_in_bits_ctrl_fuType; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_ctrl_fuOpType = io_in_bits_ctrl_fuOpType; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_ctrl_rfWen = io_in_bits_ctrl_rfWen; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_ctrl_fpWen = io_in_bits_ctrl_fpWen; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_ctrl_imm = io_in_bits_ctrl_imm; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_ctrl_fpu_isAddSub = io_in_bits_ctrl_fpu_isAddSub; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_ctrl_fpu_typeTagIn = io_in_bits_ctrl_fpu_typeTagIn; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_ctrl_fpu_typeTagOut = io_in_bits_ctrl_fpu_typeTagOut; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_ctrl_fpu_fromInt = io_in_bits_ctrl_fpu_fromInt; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_ctrl_fpu_wflags = io_in_bits_ctrl_fpu_wflags; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_ctrl_fpu_fpWen = io_in_bits_ctrl_fpu_fpWen; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_ctrl_fpu_fmaCmd = io_in_bits_ctrl_fpu_fmaCmd; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_ctrl_fpu_div = io_in_bits_ctrl_fpu_div; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_ctrl_fpu_sqrt = io_in_bits_ctrl_fpu_sqrt; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_ctrl_fpu_fcvt = io_in_bits_ctrl_fpu_fcvt; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_ctrl_fpu_typ = io_in_bits_ctrl_fpu_typ; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_ctrl_fpu_fmt = io_in_bits_ctrl_fpu_fmt; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_ctrl_fpu_ren3 = io_in_bits_ctrl_fpu_ren3; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_ctrl_fpu_rm = io_in_bits_ctrl_fpu_rm; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_srcState_0 = io_in_bits_srcState_0; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_srcState_1 = io_in_bits_srcState_1; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_psrc_0 = io_in_bits_psrc_0; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_psrc_1 = io_in_bits_psrc_1; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_pdest = io_in_bits_pdest; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_robIdx_flag = io_in_bits_robIdx_flag; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_robIdx_value = io_in_bits_robIdx_value; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_lqIdx_flag = io_in_bits_lqIdx_flag; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_lqIdx_value = io_in_bits_lqIdx_value; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_sqIdx_flag = io_in_bits_sqIdx_flag; // @[Scheduler.scala 45:12]
  assign io_out_2_bits_sqIdx_value = io_in_bits_sqIdx_value; // @[Scheduler.scala 45:12]
endmodule
