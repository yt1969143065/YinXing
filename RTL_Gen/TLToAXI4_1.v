module TLToAXI4_1(
  ...
  output        auto_out_awecho_tl_state_source,
  ...
  input         auto_out_becho_tl_state_source,
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire  queue_arw_deq_io_enq_bits_echo_tl_state_source; // @[Decoupled.scala 361:21]
  ...
  wire  queue_arw_deq_io_deq_bits_echo_tl_state_source; // @[Decoupled.scala 361:21]
  ...
  wire  _GEN_5 = auto_in_a_bits_source ? count_2 : count_1; // @[ToAXI4.scala 195:{49,49}]
  reg  counter; // @[Edges.scala 228:27]
  wire  a_first = ~counter; // @[Edges.scala 230:25]
  wire  stall = _GEN_5 & a_first; // @[ToAXI4.scala 195:49]
  ...
  wire [1:0] _a_sel_T = 2'h1 << auto_in_a_bits_source; // @[OneHot.scala 64:12]
  ...
  Queue_136 deq ( // @[Decoupled.scala 361:21]
    .clock(deq_clock),
    .reset(deq_reset),
  ...
  Queue_137 queue_arw_deq ( // @[Decoupled.scala 361:21]
  ...
  assign queue_arw_deq_io_enq_bits_id = auto_in_a_bits_source; // @[ToAXI4.scala 166:{17,17}]
