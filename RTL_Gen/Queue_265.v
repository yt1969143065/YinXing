module Queue_265(
  ...
  output [1:0]  io_deq_bits_req_way,
...
`endif // RANDOMIZE_REG_INIT
  ...
  reg [11:0] ram_req_set [0:0]; // @[Decoupled.scala 259:95]
  ...
  wire [11:0] ram_req_set_io_deq_bits_MPORT_data; // @[Decoupled.scala 259:95]
  wire [11:0] ram_req_set_MPORT_data; // @[Decoupled.scala 259:95]
  ...
  reg [1:0] ram_req_way [0:0]; // @[Decoupled.scala 259:95]
  ...
  wire [1:0] ram_req_way_io_deq_bits_MPORT_data; // @[Decoupled.scala 259:95]
  wire [1:0] ram_req_way_MPORT_data; // @[Decoupled.scala 259:95]
...
`ifdef RANDOMIZE_MEM_INIT
  ...
  _RAND_2 = {1{`RANDOM}};
  for (initvar = 0; initvar < 1; initvar = initvar+1)
    ram_needPb[initvar] = _RAND_2[0:0];
  _RAND_3 = {1{`RANDOM}};
  for (initvar = 0; initvar < 1; initvar = initvar+1)
    ram_isReleaseAck[initvar] = _RAND_3[0:0];
  _RAND_4 = {1{`RANDOM}};
  for (initvar = 0; initvar < 1; initvar = initvar+1)
    ram_req_sourceId[initvar] = _RAND_4[5:0];
  _RAND_5 = {1{`RANDOM}};
  for (initvar = 0; initvar < 1; initvar = initvar+1)
    ram_req_set[initvar] = _RAND_5[11:0];
  _RAND_6 = {1{`RANDOM}};
  for (initvar = 0; initvar < 1; initvar = initvar+1)
    ram_req_opcode[initvar] = _RAND_6[2:0];
  _RAND_7 = {1{`RANDOM}};
  for (initvar = 0; initvar < 1; initvar = initvar+1)
    ram_req_param[initvar] = _RAND_7[2:0];
  _RAND_8 = {1{`RANDOM}};
  for (initvar = 0; initvar < 1; initvar = initvar+1)
    ram_req_size[initvar] = _RAND_8[2:0];
  _RAND_9 = {1{`RANDOM}};
  for (initvar = 0; initvar < 1; initvar = initvar+1)
    ram_req_way[initvar] = _RAND_9[1:0];
  _RAND_10 = {1{`RANDOM}};
  for (initvar = 0; initvar < 1; initvar = initvar+1)
    ram_req_denied[initvar] = _RAND_10[0:0];
  _RAND_11 = {1{`RANDOM}};
  for (initvar = 0; initvar < 1; initvar = initvar+1)
    ram_req_sinkId[initvar] = _RAND_11[3:0];
  _RAND_12 = {1{`RANDOM}};
  for (initvar = 0; initvar < 1; initvar = initvar+1)
    ram_req_dirty[initvar] = _RAND_12[0:0];
`endif // RANDOMIZE_MEM_INIT
`ifdef RANDOMIZE_REG_INIT
  _RAND_13 = {1{`RANDOM}};
