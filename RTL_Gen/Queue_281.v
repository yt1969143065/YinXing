module Queue_281(
  ...
  input  [18:0] io_enq_bits_tag,
  output        io_deq_valid,
  output [8:0]  io_deq_bits_set,
  output [2:0]  io_deq_bits_way,
  output [18:0] io_deq_bits_tag
);
...
`endif // RANDOMIZE_REG_INIT
  reg [8:0] ram_set [0:0]; // @[Decoupled.scala 259:95]
  wire  ram_set_io_deq_bits_MPORT_en; // @[Decoupled.scala 259:95]
  wire  ram_set_io_deq_bits_MPORT_addr; // @[Decoupled.scala 259:95]
  wire [8:0] ram_set_io_deq_bits_MPORT_data; // @[Decoupled.scala 259:95]
  wire [8:0] ram_set_MPORT_data; // @[Decoupled.scala 259:95]
  ...
  reg [18:0] ram_tag [0:0]; // @[Decoupled.scala 259:95]
  wire  ram_tag_io_deq_bits_MPORT_en; // @[Decoupled.scala 259:95]
  wire  ram_tag_io_deq_bits_MPORT_addr; // @[Decoupled.scala 259:95]
  wire [18:0] ram_tag_io_deq_bits_MPORT_data; // @[Decoupled.scala 259:95]
  wire [18:0] ram_tag_MPORT_data; // @[Decoupled.scala 259:95]
...
`ifdef RANDOMIZE_MEM_INIT
  ...
  for (initvar = 0; initvar < 1; initvar = initvar+1)
    ram_set[initvar] = _RAND_0[8:0];
  _RAND_1 = {1{`RANDOM}};
  for (initvar = 0; initvar < 1; initvar = initvar+1)
    ram_way[initvar] = _RAND_1[2:0];
  _RAND_2 = {1{`RANDOM}};
  for (initvar = 0; initvar < 1; initvar = initvar+1)
    ram_tag[initvar] = _RAND_2[18:0];
`endif // RANDOMIZE_MEM_INIT
`ifdef RANDOMIZE_REG_INIT
  _RAND_3 = {1{`RANDOM}};
