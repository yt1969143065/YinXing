...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [26:0] array_RW0_wdata_0; // @[SRAMTemplate.scala 102:26]
  wire [26:0] array_RW0_wdata_1; // @[SRAMTemplate.scala 102:26]
  wire [26:0] array_RW0_wdata_2; // @[SRAMTemplate.scala 102:26]
  wire [26:0] array_RW0_wdata_3; // @[SRAMTemplate.scala 102:26]
  wire [26:0] array_RW0_rdata_0; // @[SRAMTemplate.scala 102:26]
  wire [26:0] array_RW0_rdata_1; // @[SRAMTemplate.scala 102:26]
  wire [26:0] array_RW0_rdata_2; // @[SRAMTemplate.scala 102:26]
  wire [26:0] array_RW0_rdata_3; // @[SRAMTemplate.scala 102:26]
  ...
  reg [26:0] rdata_r0; // @[Reg.scala 28:20]
  reg [26:0] rdata_r1; // @[Reg.scala 28:20]
  reg [26:0] rdata_r2; // @[Reg.scala 28:20]
  reg [26:0] rdata_r3; // @[Reg.scala 28:20]
  array array ( // @[SRAMTemplate.scala 102:26]
  ...
  assign array_RW0_wdata_0 = resetState ? 27'h0 : io_wreq_bits_data_0; // @[SRAMTemplate.scala 118:26]
  assign array_RW0_wdata_1 = resetState ? 27'h0 : io_wreq_bits_data_1; // @[SRAMTemplate.scala 118:26]
  assign array_RW0_wdata_2 = resetState ? 27'h0 : io_wreq_bits_data_2; // @[SRAMTemplate.scala 118:26]
  assign array_RW0_wdata_3 = resetState ? 27'h0 : io_wreq_bits_data_3; // @[SRAMTemplate.scala 118:26]
...
`ifdef RANDOMIZE_REG_INIT
  ...
  _RAND_3 = {1{`RANDOM}};
  rdata_r0 = _RAND_3[26:0];
  _RAND_4 = {1{`RANDOM}};
  rdata_r1 = _RAND_4[26:0];
  _RAND_5 = {1{`RANDOM}};
  rdata_r2 = _RAND_5[26:0];
  _RAND_6 = {1{`RANDOM}};
  rdata_r3 = _RAND_6[26:0];
`endif // RANDOMIZE_REG_INIT
  `endif // RANDOMIZE
end // initial
