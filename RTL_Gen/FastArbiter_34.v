...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [1:0] _io_out_bits_T_41 = chosenOH[0] ? io_in_0_bits_way : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_42 = chosenOH[1] ? io_in_1_bits_way : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_43 = chosenOH[2] ? io_in_2_bits_way : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_44 = chosenOH[3] ? io_in_3_bits_way : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_45 = chosenOH[4] ? io_in_4_bits_way : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_46 = chosenOH[5] ? io_in_5_bits_way : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_47 = chosenOH[6] ? io_in_6_bits_way : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_48 = chosenOH[7] ? io_in_7_bits_way : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_49 = chosenOH[8] ? io_in_8_bits_way : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_50 = chosenOH[9] ? io_in_9_bits_way : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_51 = chosenOH[10] ? io_in_10_bits_way : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_52 = chosenOH[11] ? io_in_11_bits_way : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_53 = chosenOH[12] ? io_in_12_bits_way : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_54 = chosenOH[13] ? io_in_13_bits_way : 2'h0; // @[Mux.scala 27:73]
  ...
  wire [3:0] _io_out_bits_T_68 = chosenOH[0] ? io_in_0_bits_source : 4'h0; // @[Mux.scala 27:73]
  wire [3:0] _io_out_bits_T_69 = chosenOH[1] ? io_in_1_bits_source : 4'h0; // @[Mux.scala 27:73]
  wire [3:0] _io_out_bits_T_70 = chosenOH[2] ? io_in_2_bits_source : 4'h0; // @[Mux.scala 27:73]
  wire [3:0] _io_out_bits_T_71 = chosenOH[3] ? io_in_3_bits_source : 4'h0; // @[Mux.scala 27:73]
  wire [3:0] _io_out_bits_T_72 = chosenOH[4] ? io_in_4_bits_source : 4'h0; // @[Mux.scala 27:73]
  wire [3:0] _io_out_bits_T_73 = chosenOH[5] ? io_in_5_bits_source : 4'h0; // @[Mux.scala 27:73]
  wire [3:0] _io_out_bits_T_74 = chosenOH[6] ? io_in_6_bits_source : 4'h0; // @[Mux.scala 27:73]
  wire [3:0] _io_out_bits_T_75 = chosenOH[7] ? io_in_7_bits_source : 4'h0; // @[Mux.scala 27:73]
  wire [3:0] _io_out_bits_T_76 = chosenOH[8] ? io_in_8_bits_source : 4'h0; // @[Mux.scala 27:73]
  wire [3:0] _io_out_bits_T_77 = chosenOH[9] ? io_in_9_bits_source : 4'h0; // @[Mux.scala 27:73]
  wire [3:0] _io_out_bits_T_78 = chosenOH[10] ? io_in_10_bits_source : 4'h0; // @[Mux.scala 27:73]
  wire [3:0] _io_out_bits_T_79 = chosenOH[11] ? io_in_11_bits_source : 4'h0; // @[Mux.scala 27:73]
  wire [3:0] _io_out_bits_T_80 = chosenOH[12] ? io_in_12_bits_source : 4'h0; // @[Mux.scala 27:73]
  wire [3:0] _io_out_bits_T_81 = chosenOH[13] ? io_in_13_bits_source : 4'h0; // @[Mux.scala 27:73]
  ...
  wire [11:0] _io_out_bits_T_122 = chosenOH[0] ? io_in_0_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_123 = chosenOH[1] ? io_in_1_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_124 = chosenOH[2] ? io_in_2_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_125 = chosenOH[3] ? io_in_3_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_126 = chosenOH[4] ? io_in_4_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_127 = chosenOH[5] ? io_in_5_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_128 = chosenOH[6] ? io_in_6_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_129 = chosenOH[7] ? io_in_7_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_130 = chosenOH[8] ? io_in_8_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_131 = chosenOH[9] ? io_in_9_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_132 = chosenOH[10] ? io_in_10_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_133 = chosenOH[11] ? io_in_11_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_134 = chosenOH[12] ? io_in_12_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_135 = chosenOH[13] ? io_in_13_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_136 = _io_out_bits_T_122 | _io_out_bits_T_123; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_137 = _io_out_bits_T_136 | _io_out_bits_T_124; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_138 = _io_out_bits_T_137 | _io_out_bits_T_125; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_139 = _io_out_bits_T_138 | _io_out_bits_T_126; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_140 = _io_out_bits_T_139 | _io_out_bits_T_127; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_141 = _io_out_bits_T_140 | _io_out_bits_T_128; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_142 = _io_out_bits_T_141 | _io_out_bits_T_129; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_143 = _io_out_bits_T_142 | _io_out_bits_T_130; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_144 = _io_out_bits_T_143 | _io_out_bits_T_131; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_145 = _io_out_bits_T_144 | _io_out_bits_T_132; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_146 = _io_out_bits_T_145 | _io_out_bits_T_133; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_147 = _io_out_bits_T_146 | _io_out_bits_T_134; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_149 = chosenOH[0] ? io_in_0_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_150 = chosenOH[1] ? io_in_1_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_151 = chosenOH[2] ? io_in_2_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_152 = chosenOH[3] ? io_in_3_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_153 = chosenOH[4] ? io_in_4_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_154 = chosenOH[5] ? io_in_5_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_155 = chosenOH[6] ? io_in_6_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_156 = chosenOH[7] ? io_in_7_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_157 = chosenOH[8] ? io_in_8_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_158 = chosenOH[9] ? io_in_9_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_159 = chosenOH[10] ? io_in_10_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_160 = chosenOH[11] ? io_in_11_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_161 = chosenOH[12] ? io_in_12_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_162 = chosenOH[13] ? io_in_13_bits_tag : 16'h0; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_163 = _io_out_bits_T_149 | _io_out_bits_T_150; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_164 = _io_out_bits_T_163 | _io_out_bits_T_151; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_165 = _io_out_bits_T_164 | _io_out_bits_T_152; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_166 = _io_out_bits_T_165 | _io_out_bits_T_153; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_167 = _io_out_bits_T_166 | _io_out_bits_T_154; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_168 = _io_out_bits_T_167 | _io_out_bits_T_155; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_169 = _io_out_bits_T_168 | _io_out_bits_T_156; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_170 = _io_out_bits_T_169 | _io_out_bits_T_157; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_171 = _io_out_bits_T_170 | _io_out_bits_T_158; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_172 = _io_out_bits_T_171 | _io_out_bits_T_159; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_173 = _io_out_bits_T_172 | _io_out_bits_T_160; // @[Mux.scala 27:73]
  wire [15:0] _io_out_bits_T_174 = _io_out_bits_T_173 | _io_out_bits_T_161; // @[Mux.scala 27:73]
  ...
  assign io_out_bits_set = _io_out_bits_T_147 | _io_out_bits_T_135; // @[Mux.scala 27:73]
  assign io_out_bits_source = _io_out_bits_T_93 | _io_out_bits_T_81; // @[Mux.scala 27:73]
