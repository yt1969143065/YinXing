...
`endif // RANDOMIZE_REG_INIT
  ...
  assign io_resp_x = res_pmp_cfg_x & res_pma_cfg_x; // @[PMP.scala 557:28]
  assign io_resp_w = res_pmp_cfg_w & res_pma_cfg_w; // @[PMP.scala 556:28]
  assign io_resp_r = res_pmp_cfg_r & res_pma_cfg_r; // @[PMP.scala 555:28]
  always @(posedge clock) begin
    if (reset) begin // @[Reg.scala 28:20]
      res_pmp_r <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pmp_0_cfg_a[1]) begin // @[PMP.scala 179:8]
    ...
    if (reset) begin // @[Reg.scala 28:20]
      res_pmp_r1 <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pmp_1_cfg_a[1]) begin // @[PMP.scala 179:8]
    ...
    if (reset) begin // @[Reg.scala 28:20]
      res_pmp_r2 <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pmp_2_cfg_a[1]) begin // @[PMP.scala 179:8]
    ...
    if (reset) begin // @[Reg.scala 28:20]
      res_pmp_r3 <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pmp_3_cfg_a[1]) begin // @[PMP.scala 179:8]
    ...
    if (reset) begin // @[Reg.scala 28:20]
      res_pmp_r4 <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pmp_4_cfg_a[1]) begin // @[PMP.scala 179:8]
    ...
    if (reset) begin // @[Reg.scala 28:20]
      res_pmp_r5 <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pmp_5_cfg_a[1]) begin // @[PMP.scala 179:8]
    ...
    if (reset) begin // @[Reg.scala 28:20]
      res_pmp_r6 <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pmp_6_cfg_a[1]) begin // @[PMP.scala 179:8]
    ...
    if (reset) begin // @[Reg.scala 28:20]
      res_pmp_r7 <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pmp_7_cfg_a[1]) begin // @[PMP.scala 179:8]
    ...
    if (reset) begin // @[Reg.scala 28:20]
      res_pmp_r8 <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pmp_8_cfg_a[1]) begin // @[PMP.scala 179:8]
    ...
    if (reset) begin // @[Reg.scala 28:20]
      res_pmp_r9 <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pmp_9_cfg_a[1]) begin // @[PMP.scala 179:8]
    ...
    if (reset) begin // @[Reg.scala 28:20]
      res_pmp_r10 <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pmp_10_cfg_a[1]) begin // @[PMP.scala 179:8]
    ...
    if (reset) begin // @[Reg.scala 28:20]
      res_pmp_r11 <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pmp_11_cfg_a[1]) begin // @[PMP.scala 179:8]
    ...
    if (reset) begin // @[Reg.scala 28:20]
      res_pmp_r12 <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pmp_12_cfg_a[1]) begin // @[PMP.scala 179:8]
    ...
    if (reset) begin // @[Reg.scala 28:20]
      res_pmp_r13 <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pmp_13_cfg_a[1]) begin // @[PMP.scala 179:8]
    ...
    if (reset) begin // @[Reg.scala 28:20]
      res_pmp_r14 <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pmp_14_cfg_a[1]) begin // @[PMP.scala 179:8]
    ...
    if (reset) begin // @[Reg.scala 28:20]
      res_pmp_r15 <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pmp_15_cfg_a[1]) begin // @[PMP.scala 179:8]
    ...
    if (reset) begin // @[Reg.scala 28:20]
      res_pma_r <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pma_0_cfg_a[1]) begin // @[PMP.scala 179:8]
    ...
    if (reset) begin // @[Reg.scala 28:20]
      res_pma_r1 <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pma_1_cfg_a[1]) begin // @[PMP.scala 179:8]
    ...
    if (reset) begin // @[Reg.scala 28:20]
      res_pma_r2 <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pma_2_cfg_a[1]) begin // @[PMP.scala 179:8]
    ...
    if (reset) begin // @[Reg.scala 28:20]
      res_pma_r3 <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pma_3_cfg_a[1]) begin // @[PMP.scala 179:8]
    ...
    if (reset) begin // @[Reg.scala 28:20]
      res_pma_r4 <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pma_4_cfg_a[1]) begin // @[PMP.scala 179:8]
    ...
    if (reset) begin // @[Reg.scala 28:20]
      res_pma_r5 <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pma_5_cfg_a[1]) begin // @[PMP.scala 179:8]
    ...
    if (reset) begin // @[Reg.scala 28:20]
      res_pma_r6 <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pma_6_cfg_a[1]) begin // @[PMP.scala 179:8]
    ...
    if (reset) begin // @[Reg.scala 28:20]
      res_pma_r7 <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pma_7_cfg_a[1]) begin // @[PMP.scala 179:8]
    ...
    if (reset) begin // @[Reg.scala 28:20]
      res_pma_r8 <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pma_8_cfg_a[1]) begin // @[PMP.scala 179:8]
    ...
    if (reset) begin // @[Reg.scala 28:20]
      res_pma_r9 <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pma_9_cfg_a[1]) begin // @[PMP.scala 179:8]
    ...
    if (reset) begin // @[Reg.scala 28:20]
      res_pma_r10 <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pma_10_cfg_a[1]) begin // @[PMP.scala 179:8]
    ...
    if (reset) begin // @[Reg.scala 28:20]
      res_pma_r11 <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pma_11_cfg_a[1]) begin // @[PMP.scala 179:8]
    ...
    if (reset) begin // @[Reg.scala 28:20]
      res_pma_r12 <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pma_12_cfg_a[1]) begin // @[PMP.scala 179:8]
    ...
    if (reset) begin // @[Reg.scala 28:20]
      res_pma_r13 <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pma_13_cfg_a[1]) begin // @[PMP.scala 179:8]
    ...
    if (reset) begin // @[Reg.scala 28:20]
      res_pma_r14 <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pma_14_cfg_a[1]) begin // @[PMP.scala 179:8]
    ...
    if (reset) begin // @[Reg.scala 28:20]
      res_pma_r15 <= 1'h0; // @[Reg.scala 28:20]
    end else if (io_req_valid) begin // @[Reg.scala 29:18]
      if (io_check_env_pma_15_cfg_a[1]) begin // @[PMP.scala 179:8]
