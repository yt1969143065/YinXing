module TLBuffer_21(
  ...
  wire [1:0] bundleOut_0_a_q_io_enq_bits_user_alias; // @[Decoupled.scala 361:21]
  ...
  wire [1:0] bundleOut_0_a_q_io_deq_bits_user_alias; // @[Decoupled.scala 361:21]
  wire  bundleOut_0_a_q_io_deq_bits_user_preferCache; // @[Decoupled.scala 361:21]
  wire  bundleOut_0_a_q_io_deq_bits_user_needHint; // @[Decoupled.scala 361:21]
  ...
  wire [4:0] bundleIn_0_d_q_io_enq_bits_sink; // @[Decoupled.scala 361:21]
  ...
  wire [4:0] bundleIn_0_d_q_io_deq_bits_sink; // @[Decoupled.scala 361:21]
  ...
  wire [4:0] bundleOut_0_e_q_io_enq_bits_sink; // @[Decoupled.scala 361:21]
  wire  bundleOut_0_e_q_io_deq_ready; // @[Decoupled.scala 361:21]
  wire  bundleOut_0_e_q_io_deq_valid; // @[Decoupled.scala 361:21]
  wire [4:0] bundleOut_0_e_q_io_deq_bits_sink; // @[Decoupled.scala 361:21]
  Queue_190 bundleOut_0_a_q ( // @[Decoupled.scala 361:21]
    ...
    .io_enq_bits_user_alias(bundleOut_0_a_q_io_enq_bits_user_alias),
    ...
    .io_deq_bits_user_alias(bundleOut_0_a_q_io_deq_bits_user_alias),
    .io_deq_bits_user_preferCache(bundleOut_0_a_q_io_deq_bits_user_preferCache),
    .io_deq_bits_user_needHint(bundleOut_0_a_q_io_deq_bits_user_needHint),
    .io_deq_bits_mask(bundleOut_0_a_q_io_deq_bits_mask),
    .io_deq_bits_data(bundleOut_0_a_q_io_deq_bits_data),
    .io_deq_bits_corrupt(bundleOut_0_a_q_io_deq_bits_corrupt)
  );
  Queue_191 bundleIn_0_d_q ( // @[Decoupled.scala 361:21]
  ...
  Queue_192 bundleIn_0_bq ( // @[Decoupled.scala 361:21]
  ...
  Queue_193 bundleOut_0_c_q ( // @[Decoupled.scala 361:21]
  ...
  Queue_194 bundleOut_0_e_q ( // @[Decoupled.scala 361:21]
  ...
  assign auto_out_a_bits_user_alias = bundleOut_0_a_q_io_deq_bits_user_alias; // @[Nodes.scala 1207:84 Buffer.scala 37:13]
  ...
  assign auto_out_a_bits_user_needHint = bundleOut_0_a_q_io_deq_bits_user_needHint; // @[Nodes.scala 1207:84 Buffer.scala 37:13]
  ...
  assign bundleOut_0_a_q_io_enq_bits_user_alias = auto_in_a_bits_user_alias; // @[Nodes.scala 1210:84 LazyModule.scala 309:16]
