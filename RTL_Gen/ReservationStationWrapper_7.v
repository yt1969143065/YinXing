...
`endif // RANDOMIZE_REG_INIT
  ...
  wire  rs_0_io_deq_0_bits_uop_ctrl_fpu_fpWen; // @[ReservationStation.scala 159:13]
  wire  rs_0_io_deq_0_bits_uop_ctrl_fpu_div; // @[ReservationStation.scala 159:13]
  wire  rs_0_io_deq_0_bits_uop_ctrl_fpu_sqrt; // @[ReservationStation.scala 159:13]
  wire  rs_0_io_deq_0_bits_uop_ctrl_fpu_fcvt; // @[ReservationStation.scala 159:13]
  wire [1:0] rs_0_io_deq_0_bits_uop_ctrl_fpu_typ; // @[ReservationStation.scala 159:13]
  wire [1:0] rs_0_io_deq_0_bits_uop_ctrl_fpu_fmt; // @[ReservationStation.scala 159:13]
  ...
  ReservationStation_8 rs_0 ( // @[ReservationStation.scala 159:13]
    .clock(rs_0_clock),
    .reset(rs_0_reset),
  ...
  assign io_deq_0_bits_uop_ctrl_fpu_fpWen = rs_0_io_deq_0_bits_uop_ctrl_fpu_fpWen; // @[ReservationStation.scala 176:12]
  assign io_deq_0_bits_uop_ctrl_fpu_div = rs_0_io_deq_0_bits_uop_ctrl_fpu_div; // @[ReservationStation.scala 176:12]
  assign io_deq_0_bits_uop_ctrl_fpu_sqrt = rs_0_io_deq_0_bits_uop_ctrl_fpu_sqrt; // @[ReservationStation.scala 176:12]
  assign io_deq_0_bits_uop_ctrl_fpu_fcvt = rs_0_io_deq_0_bits_uop_ctrl_fpu_fcvt; // @[ReservationStation.scala 176:12]
  assign io_deq_0_bits_uop_ctrl_fpu_typ = rs_0_io_deq_0_bits_uop_ctrl_fpu_typ; // @[ReservationStation.scala 176:12]
  assign io_deq_0_bits_uop_ctrl_fpu_fmt = rs_0_io_deq_0_bits_uop_ctrl_fpu_fmt; // @[ReservationStation.scala 176:12]
