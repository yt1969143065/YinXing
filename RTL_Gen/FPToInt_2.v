...
`endif // RANDOMIZE_REG_INIT
  wire  dataModule_clock; // @[FPToInt.scala 139:35]
  wire [63:0] dataModule_io_in_src_0; // @[FPToInt.scala 139:35]
  wire [63:0] dataModule_io_in_src_1; // @[FPToInt.scala 139:35]
  wire  dataModule_io_in_fpCtrl_typeTagIn; // @[FPToInt.scala 139:35]
  wire  dataModule_io_in_fpCtrl_wflags; // @[FPToInt.scala 139:35]
  wire  dataModule_io_in_fpCtrl_fcvt; // @[FPToInt.scala 139:35]
  wire [1:0] dataModule_io_in_fpCtrl_typ; // @[FPToInt.scala 139:35]
  wire [1:0] dataModule_io_in_fpCtrl_fmt; // @[FPToInt.scala 139:35]
  wire [2:0] dataModule_io_in_rm; // @[FPToInt.scala 139:35]
  wire [63:0] dataModule_io_out_data; // @[FPToInt.scala 139:35]
  wire [4:0] dataModule_io_out_fflags; // @[FPToInt.scala 139:35]
  wire  dataModule_regEnables_0; // @[FPToInt.scala 139:35]
  wire  dataModule_regEnables_1; // @[FPToInt.scala 139:35]
  ...
  FPToIntDataModule dataModule ( // @[FPToInt.scala 139:35]
  ...
  assign dataModule_io_in_fpCtrl_fmt = io_in_bits_uop_ctrl_fpu_fmt; // @[FPUSubModule.scala 57:29]
