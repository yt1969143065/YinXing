module AXI4UserYanker_1(
  ...
  input         auto_in_awecho_tl_state_source,
  ...
  output        auto_in_becho_tl_state_source,
  ...
  input         auto_in_arecho_tl_state_source,
  input         auto_in_rready,
  output        auto_in_rvalid,
  output        auto_in_rid,
  output [63:0] auto_in_rdata,
  output [3:0]  auto_in_recho_tl_state_size,
  output        auto_in_recho_tl_state_source,
  ...
  wire  QueueCompatibility_2_io_enq_bits_tl_state_source; // @[UserYanker.scala 47:17]
  ...
  wire  QueueCompatibility_2_io_deq_bits_tl_state_source; // @[UserYanker.scala 47:17]
  ...
  wire  QueueCompatibility_3_io_enq_bits_tl_state_source; // @[UserYanker.scala 47:17]
  ...
  wire  QueueCompatibility_3_io_deq_bits_tl_state_source; // @[UserYanker.scala 47:17]
  ...
  wire  _rWIRE_0_tl_state_source = QueueCompatibility_io_deq_bits_tl_state_source; // @[UserYanker.scala 62:{23,23}]
  wire  _rWIRE_1_tl_state_source = QueueCompatibility_1_io_deq_bits_tl_state_source; // @[UserYanker.scala 62:{23,23}]
  ...
  wire  _bWIRE_0_tl_state_source = QueueCompatibility_2_io_deq_bits_tl_state_source; // @[UserYanker.scala 83:{23,23}]
  wire  _bWIRE_1_tl_state_source = QueueCompatibility_3_io_deq_bits_tl_state_source; // @[UserYanker.scala 83:{23,23}]
  ...
  QueueCompatibility_128 QueueCompatibility ( // @[UserYanker.scala 47:17]
  ...
  QueueCompatibility_128 QueueCompatibility_1 ( // @[UserYanker.scala 47:17]
  ...
  QueueCompatibility_128 QueueCompatibility_2 ( // @[UserYanker.scala 47:17]
  ...
  QueueCompatibility_128 QueueCompatibility_3 ( // @[UserYanker.scala 47:17]
