module WrBypass_128(
  ...
  input         reset,
  input         io_wen,
  input  [1:0]  io_write_idx,
  input  [12:0] io_write_tag,
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [1:0] idx_tag_cam_io_rreq_0_idx; // @[WrBypass.scala 57:27]
  wire [12:0] idx_tag_cam_io_rreq_0_tag; // @[WrBypass.scala 57:27]
  ...
  wire [1:0] idx_tag_cam_io_wdata_idx; // @[WrBypass.scala 57:27]
  wire [12:0] idx_tag_cam_io_wdata_tag; // @[WrBypass.scala 57:27]
  ...
  CAMTemplate_128 idx_tag_cam ( // @[WrBypass.scala 57:27]
