module FCMA_ADD_s2(
  ...
  wire [26:0] far_path_tininess_rounder_io_in_sig; // @[FADD.scala 313:41]
  ...
  wire [26:0] near_path_tininess_rounder_io_in_sig; // @[FADD.scala 352:42]
  ...
  wire [31:0] special_path_result = io_in_special_case_bits_nan ? 32'h7fc00000 : _special_path_result_T_3; // @[FADD.scala 295:32]
  ...
  wire [7:0] _GEN_0 = {{7'd0}, far_path_rounder_io_cout}; // @[FADD.scala 325:55]
  wire [7:0] far_path_exp_rounded = _GEN_0 + io_in_far_path_out_exp; // @[FADD.scala 325:55]
  wire  far_path_may_uf = far_path_tininess & ~io_in_far_path_mul_of; // @[FADD.scala 330:43]
  wire  far_path_of_before_round = io_in_far_path_out_exp == 8'hff; // @[FADD.scala 333:18]
  wire  _far_path_of_after_round_T = io_in_far_path_out_exp == 8'hfe; // @[FADD.scala 335:18]
  ...
  wire  near_path_is_zero = io_in_near_path_out_exp == 8'h0 & io_in_near_path_sig_is_zero; // @[FADD.scala 350:49]
  wire [7:0] _GEN_1 = {{7'd0}, near_path_rounder_io_cout}; // @[FADD.scala 364:57]
  wire [7:0] near_path_exp_rounded = _GEN_1 + io_in_near_path_out_exp; // @[FADD.scala 364:57]
  ...
  wire  near_path_of = near_path_exp_rounded == 8'hff; // @[FADD.scala 373:44]
  ...
  wire [7:0] common_overflow_exp = rmin ? 8'hfe : 8'hff; // @[FADD.scala 383:32]
  wire [22:0] common_overflow_sig = rmin ? 23'h7fffff : 23'h0; // @[FADD.scala 389:8]
  ...
  wire [31:0] _io_result_T_1 = io_in_sel_far_path ? far_path_result : near_path_result; // @[FADD.scala 408:10]
  wire [31:0] _io_result_T_2 = common_overflow ? _io_result_T : _io_result_T_1; // @[FADD.scala 405:8]
  TininessRounder far_path_tininess_rounder ( // @[FADD.scala 313:41]
  ...
  TininessRounder near_path_tininess_rounder ( // @[FADD.scala 352:42]
