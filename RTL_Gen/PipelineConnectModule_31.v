module PipelineConnectModule_31(
  input         clock,
  input         reset,
  output        io_in_ready,
  input         io_in_valid,
  ...
  input  [6:0]  io_in_bits_psrc_2,
  input  [6:0]  io_in_bits_pdest,
  input  [6:0]  io_in_bits_old_pdest,
  ...
  output        io_out_bits_cf_storeSetHit,
  output        io_out_bits_cf_loadWaitStrict,
  output [4:0]  io_out_bits_cf_ssid,
  ...
  output [6:0]  io_out_bits_psrc_0,
  output [6:0]  io_out_bits_psrc_1,
  output [6:0]  io_out_bits_psrc_2,
  output [6:0]  io_out_bits_pdest,
  output [6:0]  io_out_bits_old_pdest,
...
`endif // RANDOMIZE_REG_INIT
  ...
  reg  io_out_bits_rcf_storeSetHit; // @[Reg.scala 16:16]
  reg  io_out_bits_rcf_loadWaitStrict; // @[Reg.scala 16:16]
  reg [4:0] io_out_bits_rcf_ssid; // @[Reg.scala 16:16]
  ...
  reg [6:0] io_out_bits_rpsrc_0; // @[Reg.scala 16:16]
  reg [6:0] io_out_bits_rpsrc_1; // @[Reg.scala 16:16]
  reg [6:0] io_out_bits_rpsrc_2; // @[Reg.scala 16:16]
  reg [6:0] io_out_bits_rpdest; // @[Reg.scala 16:16]
  reg [6:0] io_out_bits_rold_pdest; // @[Reg.scala 16:16]
  reg  io_out_bits_rrobIdx_flag; // @[Reg.scala 16:16]
  reg [6:0] io_out_bits_rrobIdx_value; // @[Reg.scala 16:16]
  reg  io_out_bits_reliminatedMove; // @[Reg.scala 16:16]
  ...
  assign io_out_bits_cf_storeSetHit = io_out_bits_rcf_storeSetHit; // @[PipelineConnect.scala 42:17]
  assign io_out_bits_cf_loadWaitStrict = io_out_bits_rcf_loadWaitStrict; // @[PipelineConnect.scala 42:17]
  assign io_out_bits_cf_ssid = io_out_bits_rcf_ssid; // @[PipelineConnect.scala 42:17]
  ...
  assign io_out_bits_psrc_0 = io_out_bits_rpsrc_0; // @[PipelineConnect.scala 42:17]
  assign io_out_bits_psrc_1 = io_out_bits_rpsrc_1; // @[PipelineConnect.scala 42:17]
  assign io_out_bits_psrc_2 = io_out_bits_rpsrc_2; // @[PipelineConnect.scala 42:17]
  assign io_out_bits_pdest = io_out_bits_rpdest; // @[PipelineConnect.scala 42:17]
  assign io_out_bits_old_pdest = io_out_bits_rold_pdest; // @[PipelineConnect.scala 42:17]
  assign io_out_bits_robIdx_flag = io_out_bits_rrobIdx_flag; // @[PipelineConnect.scala 42:17]
  assign io_out_bits_robIdx_value = io_out_bits_rrobIdx_value; // @[PipelineConnect.scala 42:17]
  assign io_out_bits_eliminatedMove = io_out_bits_reliminatedMove; // @[PipelineConnect.scala 42:17]
  always @(posedge clock) begin
    ...
    if (leftFire) begin // @[Reg.scala 17:18]
      io_out_bits_rcf_storeSetHit <= io_in_bits_cf_storeSetHit; // @[Reg.scala 17:22]
    end
    if (leftFire) begin // @[Reg.scala 17:18]
      io_out_bits_rcf_loadWaitStrict <= io_in_bits_cf_loadWaitStrict; // @[Reg.scala 17:22]
    end
    if (leftFire) begin // @[Reg.scala 17:18]
      io_out_bits_rcf_ssid <= io_in_bits_cf_ssid; // @[Reg.scala 17:22]
    end
    if (leftFire) begin // @[Reg.scala 17:18]
    ...
    if (leftFire) begin // @[Reg.scala 17:18]
      io_out_bits_rpsrc_0 <= io_in_bits_psrc_0; // @[Reg.scala 17:22]
    end
    if (leftFire) begin // @[Reg.scala 17:18]
      io_out_bits_rpsrc_1 <= io_in_bits_psrc_1; // @[Reg.scala 17:22]
    end
    if (leftFire) begin // @[Reg.scala 17:18]
      io_out_bits_rpsrc_2 <= io_in_bits_psrc_2; // @[Reg.scala 17:22]
    end
    if (leftFire) begin // @[Reg.scala 17:18]
      io_out_bits_rpdest <= io_in_bits_pdest; // @[Reg.scala 17:22]
    end
    if (leftFire) begin // @[Reg.scala 17:18]
      io_out_bits_rold_pdest <= io_in_bits_old_pdest; // @[Reg.scala 17:22]
    end
    if (leftFire) begin // @[Reg.scala 17:18]
      io_out_bits_rrobIdx_flag <= io_in_bits_robIdx_flag; // @[Reg.scala 17:22]
    end
    if (leftFire) begin // @[Reg.scala 17:18]
      io_out_bits_rrobIdx_value <= io_in_bits_robIdx_value; // @[Reg.scala 17:22]
    end
    if (leftFire) begin // @[Reg.scala 17:18]
      io_out_bits_reliminatedMove <= io_in_bits_eliminatedMove; // @[Reg.scala 17:22]
    end
  end
...
`ifdef RANDOMIZE_REG_INIT
  ...
  _RAND_1 = {1{`RANDOM}};
  io_out_bits_rcf_exceptionVec_1 = _RAND_1[0:0];
  _RAND_2 = {1{`RANDOM}};
  io_out_bits_rcf_exceptionVec_2 = _RAND_2[0:0];
  _RAND_3 = {1{`RANDOM}};
  io_out_bits_rcf_exceptionVec_12 = _RAND_3[0:0];
  _RAND_4 = {1{`RANDOM}};
  io_out_bits_rcf_trigger_frontendHit_0 = _RAND_4[0:0];
  _RAND_5 = {1{`RANDOM}};
  io_out_bits_rcf_trigger_frontendHit_1 = _RAND_5[0:0];
  _RAND_6 = {1{`RANDOM}};
  io_out_bits_rcf_trigger_frontendHit_2 = _RAND_6[0:0];
  _RAND_7 = {1{`RANDOM}};
  io_out_bits_rcf_trigger_frontendHit_3 = _RAND_7[0:0];
  _RAND_8 = {1{`RANDOM}};
  io_out_bits_rcf_trigger_backendEn_0 = _RAND_8[0:0];
  _RAND_9 = {1{`RANDOM}};
  io_out_bits_rcf_trigger_backendEn_1 = _RAND_9[0:0];
  _RAND_10 = {1{`RANDOM}};
  io_out_bits_rcf_trigger_backendHit_0 = _RAND_10[0:0];
  _RAND_11 = {1{`RANDOM}};
  io_out_bits_rcf_trigger_backendHit_1 = _RAND_11[0:0];
  _RAND_12 = {1{`RANDOM}};
  io_out_bits_rcf_trigger_backendHit_2 = _RAND_12[0:0];
  _RAND_13 = {1{`RANDOM}};
  io_out_bits_rcf_trigger_backendHit_3 = _RAND_13[0:0];
  _RAND_14 = {1{`RANDOM}};
  io_out_bits_rcf_trigger_backendHit_4 = _RAND_14[0:0];
  _RAND_15 = {1{`RANDOM}};
  io_out_bits_rcf_trigger_backendHit_5 = _RAND_15[0:0];
  _RAND_16 = {1{`RANDOM}};
  io_out_bits_rcf_pd_isRVC = _RAND_16[0:0];
  _RAND_17 = {1{`RANDOM}};
  io_out_bits_rcf_pd_brType = _RAND_17[1:0];
  _RAND_18 = {1{`RANDOM}};
  io_out_bits_rcf_pd_isCall = _RAND_18[0:0];
  _RAND_19 = {1{`RANDOM}};
  io_out_bits_rcf_pd_isRet = _RAND_19[0:0];
  _RAND_20 = {1{`RANDOM}};
  io_out_bits_rcf_pred_taken = _RAND_20[0:0];
  _RAND_21 = {1{`RANDOM}};
  io_out_bits_rcf_crossPageIPFFix = _RAND_21[0:0];
  _RAND_22 = {1{`RANDOM}};
  io_out_bits_rcf_storeSetHit = _RAND_22[0:0];
  _RAND_23 = {1{`RANDOM}};
  io_out_bits_rcf_loadWaitStrict = _RAND_23[0:0];
  _RAND_24 = {1{`RANDOM}};
  io_out_bits_rcf_ssid = _RAND_24[4:0];
  _RAND_25 = {1{`RANDOM}};
  io_out_bits_rcf_ftqPtr_flag = _RAND_25[0:0];
  _RAND_26 = {1{`RANDOM}};
  io_out_bits_rcf_ftqPtr_value = _RAND_26[5:0];
  _RAND_27 = {1{`RANDOM}};
  io_out_bits_rcf_ftqOffset = _RAND_27[2:0];
  _RAND_28 = {1{`RANDOM}};
  io_out_bits_rctrl_srcType_0 = _RAND_28[1:0];
  _RAND_29 = {1{`RANDOM}};
  io_out_bits_rctrl_srcType_1 = _RAND_29[1:0];
  _RAND_30 = {1{`RANDOM}};
  io_out_bits_rctrl_srcType_2 = _RAND_30[1:0];
  _RAND_31 = {1{`RANDOM}};
  io_out_bits_rctrl_ldest = _RAND_31[4:0];
  _RAND_32 = {1{`RANDOM}};
  io_out_bits_rctrl_fuType = _RAND_32[3:0];
  _RAND_33 = {1{`RANDOM}};
  io_out_bits_rctrl_fuOpType = _RAND_33[6:0];
  _RAND_34 = {1{`RANDOM}};
  io_out_bits_rctrl_rfWen = _RAND_34[0:0];
  _RAND_35 = {1{`RANDOM}};
  io_out_bits_rctrl_fpWen = _RAND_35[0:0];
  _RAND_36 = {1{`RANDOM}};
  io_out_bits_rctrl_isRVCORETrap = _RAND_36[0:0];
  _RAND_37 = {1{`RANDOM}};
  io_out_bits_rctrl_noSpecExec = _RAND_37[0:0];
  _RAND_38 = {1{`RANDOM}};
  io_out_bits_rctrl_blockBackward = _RAND_38[0:0];
  _RAND_39 = {1{`RANDOM}};
  io_out_bits_rctrl_flushPipe = _RAND_39[0:0];
  _RAND_40 = {1{`RANDOM}};
  io_out_bits_rctrl_selImm = _RAND_40[3:0];
  _RAND_41 = {1{`RANDOM}};
  io_out_bits_rctrl_imm = _RAND_41[19:0];
  _RAND_42 = {1{`RANDOM}};
  io_out_bits_rctrl_commitType = _RAND_42[2:0];
  _RAND_43 = {1{`RANDOM}};
  io_out_bits_rctrl_fpu_isAddSub = _RAND_43[0:0];
  _RAND_44 = {1{`RANDOM}};
  io_out_bits_rctrl_fpu_typeTagIn = _RAND_44[0:0];
  _RAND_45 = {1{`RANDOM}};
  io_out_bits_rctrl_fpu_typeTagOut = _RAND_45[0:0];
  _RAND_46 = {1{`RANDOM}};
  io_out_bits_rctrl_fpu_fromInt = _RAND_46[0:0];
  _RAND_47 = {1{`RANDOM}};
  io_out_bits_rctrl_fpu_wflags = _RAND_47[0:0];
  _RAND_48 = {1{`RANDOM}};
  io_out_bits_rctrl_fpu_fpWen = _RAND_48[0:0];
  _RAND_49 = {1{`RANDOM}};
  io_out_bits_rctrl_fpu_fmaCmd = _RAND_49[1:0];
  _RAND_50 = {1{`RANDOM}};
  io_out_bits_rctrl_fpu_div = _RAND_50[0:0];
  _RAND_51 = {1{`RANDOM}};
  io_out_bits_rctrl_fpu_sqrt = _RAND_51[0:0];
  _RAND_52 = {1{`RANDOM}};
  io_out_bits_rctrl_fpu_fcvt = _RAND_52[0:0];
  _RAND_53 = {1{`RANDOM}};
  io_out_bits_rctrl_fpu_typ = _RAND_53[1:0];
  _RAND_54 = {1{`RANDOM}};
  io_out_bits_rctrl_fpu_fmt = _RAND_54[1:0];
  _RAND_55 = {1{`RANDOM}};
  io_out_bits_rctrl_fpu_ren3 = _RAND_55[0:0];
  _RAND_56 = {1{`RANDOM}};
  io_out_bits_rctrl_fpu_rm = _RAND_56[2:0];
  _RAND_57 = {1{`RANDOM}};
  io_out_bits_rctrl_isMove = _RAND_57[0:0];
  _RAND_58 = {1{`RANDOM}};
  io_out_bits_rpsrc_0 = _RAND_58[6:0];
  _RAND_59 = {1{`RANDOM}};
  io_out_bits_rpsrc_1 = _RAND_59[6:0];
  _RAND_60 = {1{`RANDOM}};
  io_out_bits_rpsrc_2 = _RAND_60[6:0];
  _RAND_61 = {1{`RANDOM}};
  io_out_bits_rpdest = _RAND_61[6:0];
  _RAND_62 = {1{`RANDOM}};
  io_out_bits_rold_pdest = _RAND_62[6:0];
  _RAND_63 = {1{`RANDOM}};
  io_out_bits_rrobIdx_flag = _RAND_63[0:0];
  _RAND_64 = {1{`RANDOM}};
  io_out_bits_rrobIdx_value = _RAND_64[6:0];
  _RAND_65 = {1{`RANDOM}};
  io_out_bits_reliminatedMove = _RAND_65[0:0];
`endif // RANDOMIZE_REG_INIT
  `endif // RANDOMIZE
end // initial
