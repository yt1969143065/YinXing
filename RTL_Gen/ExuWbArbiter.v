...
`endif // RANDOMIZE_REG_INIT
  ...
  wire  ctrl_arb_io_in_2_ready; // @[WbArbiter.scala 43:24]
  wire  ctrl_arb_io_in_2_valid; // @[WbArbiter.scala 43:24]
  wire  ctrl_arb_io_in_2_bits_uop_cf_trigger_backendHit_0; // @[WbArbiter.scala 43:24]
  wire  ctrl_arb_io_in_2_bits_uop_cf_trigger_backendHit_1; // @[WbArbiter.scala 43:24]
  wire  ctrl_arb_io_in_2_bits_uop_cf_trigger_backendHit_2; // @[WbArbiter.scala 43:24]
  wire  ctrl_arb_io_in_2_bits_uop_cf_trigger_backendHit_3; // @[WbArbiter.scala 43:24]
  wire  ctrl_arb_io_in_2_bits_uop_cf_trigger_backendHit_4; // @[WbArbiter.scala 43:24]
  wire  ctrl_arb_io_in_2_bits_uop_cf_trigger_backendHit_5; // @[WbArbiter.scala 43:24]
  wire  ctrl_arb_io_in_2_bits_uop_ctrl_rfWen; // @[WbArbiter.scala 43:24]
  wire  ctrl_arb_io_in_2_bits_uop_ctrl_fpWen; // @[WbArbiter.scala 43:24]
  wire [6:0] ctrl_arb_io_in_2_bits_uop_pdest; // @[WbArbiter.scala 43:24]
  wire  ctrl_arb_io_in_2_bits_uop_robIdx_flag; // @[WbArbiter.scala 43:24]
  wire [6:0] ctrl_arb_io_in_2_bits_uop_robIdx_value; // @[WbArbiter.scala 43:24]
  ...
  wire [1:0] sel_hi = {_sel_T_2,_sel_T_1}; // @[WbArbiter.scala 75:42]
  reg [2:0] io_out_bits_REG; // @[WbArbiter.scala 76:33]
  wire [63:0] _io_out_bits_T_643 = io_out_bits_REG[0] ? io_in_0_bits_data : 64'h0; // @[Mux.scala 27:73]
  wire [63:0] _io_out_bits_T_644 = io_out_bits_REG[1] ? io_in_1_bits_data : 64'h0; // @[Mux.scala 27:73]
  wire [63:0] _io_out_bits_T_645 = io_out_bits_REG[2] ? io_in_2_bits_data : 64'h0; // @[Mux.scala 27:73]
  wire [63:0] _io_out_bits_T_646 = _io_out_bits_T_643 | _io_out_bits_T_644; // @[Mux.scala 27:73]
  ...
  Arbiter_14 ctrl_arb ( // @[WbArbiter.scala 43:24]
    ...
    .io_in_2_bits_uop_cf_trigger_backendHit_0(ctrl_arb_io_in_2_bits_uop_cf_trigger_backendHit_0),
    .io_in_2_bits_uop_cf_trigger_backendHit_1(ctrl_arb_io_in_2_bits_uop_cf_trigger_backendHit_1),
    .io_in_2_bits_uop_cf_trigger_backendHit_2(ctrl_arb_io_in_2_bits_uop_cf_trigger_backendHit_2),
    .io_in_2_bits_uop_cf_trigger_backendHit_3(ctrl_arb_io_in_2_bits_uop_cf_trigger_backendHit_3),
    .io_in_2_bits_uop_cf_trigger_backendHit_4(ctrl_arb_io_in_2_bits_uop_cf_trigger_backendHit_4),
    .io_in_2_bits_uop_cf_trigger_backendHit_5(ctrl_arb_io_in_2_bits_uop_cf_trigger_backendHit_5),
  ...
  assign io_in_2_ready = ctrl_arb_io_in_2_ready; // @[WbArbiter.scala 56:14]
  ...
  assign io_out_bits_data = _io_out_bits_T_646 | _io_out_bits_T_645; // @[Mux.scala 27:73]
  ...
  assign ctrl_arb_io_in_2_valid = io_in_2_valid; // @[WbArbiter.scala 50:16]
  assign ctrl_arb_io_in_2_bits_uop_cf_trigger_backendHit_0 = io_in_2_bits_uop_cf_trigger_backendHit_0; // @[WbArbiter.scala 52:9]
  assign ctrl_arb_io_in_2_bits_uop_cf_trigger_backendHit_1 = io_in_2_bits_uop_cf_trigger_backendHit_1; // @[WbArbiter.scala 52:9]
  assign ctrl_arb_io_in_2_bits_uop_cf_trigger_backendHit_2 = io_in_2_bits_uop_cf_trigger_backendHit_2; // @[WbArbiter.scala 52:9]
  assign ctrl_arb_io_in_2_bits_uop_cf_trigger_backendHit_3 = io_in_2_bits_uop_cf_trigger_backendHit_3; // @[WbArbiter.scala 52:9]
  assign ctrl_arb_io_in_2_bits_uop_cf_trigger_backendHit_4 = io_in_2_bits_uop_cf_trigger_backendHit_4; // @[WbArbiter.scala 52:9]
  assign ctrl_arb_io_in_2_bits_uop_cf_trigger_backendHit_5 = io_in_2_bits_uop_cf_trigger_backendHit_5; // @[WbArbiter.scala 52:9]
  assign ctrl_arb_io_in_2_bits_uop_ctrl_rfWen = io_in_2_bits_uop_ctrl_rfWen; // @[WbArbiter.scala 52:9]
  assign ctrl_arb_io_in_2_bits_uop_ctrl_fpWen = io_in_2_bits_uop_ctrl_fpWen; // @[WbArbiter.scala 52:9]
  assign ctrl_arb_io_in_2_bits_uop_pdest = io_in_2_bits_uop_pdest; // @[WbArbiter.scala 52:9]
  assign ctrl_arb_io_in_2_bits_uop_robIdx_flag = io_in_2_bits_uop_robIdx_flag; // @[WbArbiter.scala 52:9]
  assign ctrl_arb_io_in_2_bits_uop_robIdx_value = io_in_2_bits_uop_robIdx_value; // @[WbArbiter.scala 52:9]
  always @(posedge clock) begin
    io_out_valid_REG <= ctrl_arb_io_out_valid & ~_io_out_valid_T_2; // @[WbArbiter.scala 70:51]
    io_out_bits_REG <= {sel_hi,_sel_T}; // @[WbArbiter.scala 75:42]
