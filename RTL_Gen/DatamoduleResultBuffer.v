module DatamoduleResultBuffer(
  ...
  input  [63:0] io_enq_0_bits_data,
  input  [7:0]  io_enq_0_bits_mask,
  ...
  input  [63:0] io_enq_1_bits_data,
  input  [7:0]  io_enq_1_bits_mask,
  ...
  output [63:0] io_deq_0_bits_data,
  output [7:0]  io_deq_0_bits_mask,
  ...
  output [63:0] io_deq_1_bits_data,
  output [7:0]  io_deq_1_bits_mask,
...
`endif // RANDOMIZE_REG_INIT
  ...
  reg [63:0] data_0_data; // @[DatamoduleResultBuffer.scala 55:17]
  reg [7:0] data_0_mask; // @[DatamoduleResultBuffer.scala 55:17]
  reg  data_0_wline; // @[DatamoduleResultBuffer.scala 55:17]
  reg [4:0] data_0_sqPtr_value; // @[DatamoduleResultBuffer.scala 55:17]
  reg [35:0] data_1_addr; // @[DatamoduleResultBuffer.scala 55:17]
  reg [38:0] data_1_vaddr; // @[DatamoduleResultBuffer.scala 55:17]
  reg [63:0] data_1_data; // @[DatamoduleResultBuffer.scala 55:17]
  reg [7:0] data_1_mask; // @[DatamoduleResultBuffer.scala 55:17]
  reg  data_1_wline; // @[DatamoduleResultBuffer.scala 55:17]
  reg [4:0] data_1_sqPtr_value; // @[DatamoduleResultBuffer.scala 55:17]
  ...
  wire [4:0] _GEN_48 = ~_io_enq_0_ready_T[0] ? io_enq_0_bits_sqPtr_value : data_0_sqPtr_value; // @[DatamoduleResultBuffer.scala 55:17 95:{32,32}]
  wire [4:0] _GEN_49 = _io_enq_0_ready_T[0] ? io_enq_0_bits_sqPtr_value : data_1_sqPtr_value; // @[DatamoduleResultBuffer.scala 55:17 95:{32,32}]
  wire  _GEN_52 = ~_io_enq_0_ready_T[0] ? io_enq_0_bits_wline : data_0_wline; // @[DatamoduleResultBuffer.scala 55:17 95:{32,32}]
  wire  _GEN_53 = _io_enq_0_ready_T[0] ? io_enq_0_bits_wline : data_1_wline; // @[DatamoduleResultBuffer.scala 55:17 95:{32,32}]
  wire [7:0] _GEN_54 = ~_io_enq_0_ready_T[0] ? io_enq_0_bits_mask : data_0_mask; // @[DatamoduleResultBuffer.scala 55:17 95:{32,32}]
  wire [7:0] _GEN_55 = _io_enq_0_ready_T[0] ? io_enq_0_bits_mask : data_1_mask; // @[DatamoduleResultBuffer.scala 55:17 95:{32,32}]
  wire [63:0] _GEN_56 = ~_io_enq_0_ready_T[0] ? io_enq_0_bits_data : data_0_data; // @[DatamoduleResultBuffer.scala 55:17 95:{32,32}]
  wire [63:0] _GEN_57 = _io_enq_0_ready_T[0] ? io_enq_0_bits_data : data_1_data; // @[DatamoduleResultBuffer.scala 55:17 95:{32,32}]
  wire [38:0] _GEN_58 = ~_io_enq_0_ready_T[0] ? io_enq_0_bits_vaddr : data_0_vaddr; // @[DatamoduleResultBuffer.scala 55:17 95:{32,32}]
  wire [38:0] _GEN_59 = _io_enq_0_ready_T[0] ? io_enq_0_bits_vaddr : data_1_vaddr; // @[DatamoduleResultBuffer.scala 55:17 95:{32,32}]
  wire [35:0] _GEN_60 = ~_io_enq_0_ready_T[0] ? io_enq_0_bits_addr : data_0_addr; // @[DatamoduleResultBuffer.scala 55:17 95:{32,32}]
  wire [35:0] _GEN_61 = _io_enq_0_ready_T[0] ? io_enq_0_bits_addr : data_1_addr; // @[DatamoduleResultBuffer.scala 55:17 95:{32,32}]
  ...
  wire [4:0] _GEN_64 = _T_30 ? _GEN_48 : data_0_sqPtr_value; // @[DatamoduleResultBuffer.scala 55:17 93:30]
  wire [4:0] _GEN_65 = _T_30 ? _GEN_49 : data_1_sqPtr_value; // @[DatamoduleResultBuffer.scala 55:17 93:30]
  wire  _GEN_68 = _T_30 ? _GEN_52 : data_0_wline; // @[DatamoduleResultBuffer.scala 55:17 93:30]
  wire  _GEN_69 = _T_30 ? _GEN_53 : data_1_wline; // @[DatamoduleResultBuffer.scala 55:17 93:30]
  wire [7:0] _GEN_70 = _T_30 ? _GEN_54 : data_0_mask; // @[DatamoduleResultBuffer.scala 55:17 93:30]
  wire [7:0] _GEN_71 = _T_30 ? _GEN_55 : data_1_mask; // @[DatamoduleResultBuffer.scala 55:17 93:30]
  wire [63:0] _GEN_72 = _T_30 ? _GEN_56 : data_0_data; // @[DatamoduleResultBuffer.scala 55:17 93:30]
  wire [63:0] _GEN_73 = _T_30 ? _GEN_57 : data_1_data; // @[DatamoduleResultBuffer.scala 55:17 93:30]
  wire [38:0] _GEN_74 = _T_30 ? _GEN_58 : data_0_vaddr; // @[DatamoduleResultBuffer.scala 55:17 93:30]
  wire [38:0] _GEN_75 = _T_30 ? _GEN_59 : data_1_vaddr; // @[DatamoduleResultBuffer.scala 55:17 93:30]
  wire [35:0] _GEN_76 = _T_30 ? _GEN_60 : data_0_addr; // @[DatamoduleResultBuffer.scala 55:17 93:30]
  wire [35:0] _GEN_77 = _T_30 ? _GEN_61 : data_1_addr; // @[DatamoduleResultBuffer.scala 55:17 93:30]
  ...
  always @(posedge clock) begin
    ...
    if (_T_35) begin // @[DatamoduleResultBuffer.scala 93:30]
      if (_io_enq_1_ready_T_1) begin // @[DatamoduleResultBuffer.scala 95:32]
        ...
        data_1_sqPtr_value <= _GEN_65;
      end
    end else begin
      data_1_sqPtr_value <= _GEN_65;
    end
    if (reset) begin // @[DatamoduleResultBuffer.scala 56:23]
      valids_0 <= 1'h0; // @[DatamoduleResultBuffer.scala 56:23]
    end else if (_T_35) begin // @[DatamoduleResultBuffer.scala 93:30]
      valids_0 <= _GEN_79;
    end else if (_T_30) begin // @[DatamoduleResultBuffer.scala 93:30]
      valids_0 <= _GEN_46;
    ...
    if (reset) begin // @[DatamoduleResultBuffer.scala 56:23]
      valids_1 <= 1'h0; // @[DatamoduleResultBuffer.scala 56:23]
    end else if (_T_35) begin // @[DatamoduleResultBuffer.scala 93:30]
      valids_1 <= _GEN_80;
    end else if (_T_30) begin // @[DatamoduleResultBuffer.scala 93:30]
      valids_1 <= _GEN_47;
    ...
    if (reset) begin // @[DatamoduleResultBuffer.scala 57:25]
      enq_flag <= 1'h0; // @[DatamoduleResultBuffer.scala 57:25]
    end else if (_T_35) begin // @[DatamoduleResultBuffer.scala 93:30]
      enq_flag <= _io_enq_1_ready_T_1 + 1'h1; // @[DatamoduleResultBuffer.scala 96:40]
    end else if (_T_30) begin // @[DatamoduleResultBuffer.scala 93:30]
      enq_flag <= _io_enq_0_ready_T[0] + 1'h1; // @[DatamoduleResultBuffer.scala 96:40]
    end
    if (reset) begin // @[DatamoduleResultBuffer.scala 58:25]
      deq_flag <= 1'h0; // @[DatamoduleResultBuffer.scala 58:25]
    end else if (_entry_allowin_0_T_6) begin // @[DatamoduleResultBuffer.scala 86:30]
      deq_flag <= _io_deq_1_valid_T_1 + 1'h1; // @[DatamoduleResultBuffer.scala 88:40]
    end else if (_entry_allowin_0_T_1) begin // @[DatamoduleResultBuffer.scala 86:30]
      deq_flag <= _io_deq_0_valid_T[0] + 1'h1; // @[DatamoduleResultBuffer.scala 88:40]
    end
  end
...
`ifdef RANDOMIZE_REG_INIT
  ...
  _RAND_2 = {2{`RANDOM}};
  data_0_data = _RAND_2[63:0];
  _RAND_3 = {1{`RANDOM}};
  data_0_mask = _RAND_3[7:0];
  _RAND_4 = {1{`RANDOM}};
  data_0_wline = _RAND_4[0:0];
  _RAND_5 = {1{`RANDOM}};
  data_0_sqPtr_value = _RAND_5[4:0];
  _RAND_6 = {2{`RANDOM}};
  data_1_addr = _RAND_6[35:0];
  _RAND_7 = {2{`RANDOM}};
  data_1_vaddr = _RAND_7[38:0];
  _RAND_8 = {2{`RANDOM}};
  data_1_data = _RAND_8[63:0];
  _RAND_9 = {1{`RANDOM}};
  data_1_mask = _RAND_9[7:0];
  _RAND_10 = {1{`RANDOM}};
  data_1_wline = _RAND_10[0:0];
  _RAND_11 = {1{`RANDOM}};
  data_1_sqPtr_value = _RAND_11[4:0];
  _RAND_12 = {1{`RANDOM}};
