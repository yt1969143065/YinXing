...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [1:0] _io_out_bits_T_47 = chosenOH[0] ? io_in_0_bits_data_state : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_48 = chosenOH[1] ? io_in_1_bits_data_state : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_49 = chosenOH[2] ? io_in_2_bits_data_state : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_50 = chosenOH[3] ? io_in_3_bits_data_state : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_51 = chosenOH[4] ? io_in_4_bits_data_state : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_52 = chosenOH[5] ? io_in_5_bits_data_state : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_53 = chosenOH[6] ? io_in_6_bits_data_state : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_54 = chosenOH[7] ? io_in_7_bits_data_state : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_55 = chosenOH[8] ? io_in_8_bits_data_state : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_56 = chosenOH[9] ? io_in_9_bits_data_state : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_57 = chosenOH[10] ? io_in_10_bits_data_state : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_58 = chosenOH[11] ? io_in_11_bits_data_state : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_59 = chosenOH[12] ? io_in_12_bits_data_state : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_60 = chosenOH[13] ? io_in_13_bits_data_state : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_61 = chosenOH[14] ? io_in_14_bits_data_state : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_62 = chosenOH[15] ? io_in_15_bits_data_state : 2'h0; // @[Mux.scala 27:73]
  ...
  wire  _io_out_bits_T_93 = chosenOH[15] & io_in_15_bits_data_dirty; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_109 = chosenOH[0] ? io_in_0_bits_way : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_110 = chosenOH[1] ? io_in_1_bits_way : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_111 = chosenOH[2] ? io_in_2_bits_way : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_112 = chosenOH[3] ? io_in_3_bits_way : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_113 = chosenOH[4] ? io_in_4_bits_way : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_114 = chosenOH[5] ? io_in_5_bits_way : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_115 = chosenOH[6] ? io_in_6_bits_way : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_116 = chosenOH[7] ? io_in_7_bits_way : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_117 = chosenOH[8] ? io_in_8_bits_way : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_118 = chosenOH[9] ? io_in_9_bits_way : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_119 = chosenOH[10] ? io_in_10_bits_way : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_120 = chosenOH[11] ? io_in_11_bits_way : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_121 = chosenOH[12] ? io_in_12_bits_way : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_122 = chosenOH[13] ? io_in_13_bits_way : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_123 = chosenOH[14] ? io_in_14_bits_way : 2'h0; // @[Mux.scala 27:73]
  wire [1:0] _io_out_bits_T_124 = chosenOH[15] ? io_in_15_bits_way : 2'h0; // @[Mux.scala 27:73]
  ...
  wire [11:0] _io_out_bits_T_140 = chosenOH[0] ? io_in_0_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_141 = chosenOH[1] ? io_in_1_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_142 = chosenOH[2] ? io_in_2_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_143 = chosenOH[3] ? io_in_3_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_144 = chosenOH[4] ? io_in_4_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_145 = chosenOH[5] ? io_in_5_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_146 = chosenOH[6] ? io_in_6_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_147 = chosenOH[7] ? io_in_7_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_148 = chosenOH[8] ? io_in_8_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_149 = chosenOH[9] ? io_in_9_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_150 = chosenOH[10] ? io_in_10_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_151 = chosenOH[11] ? io_in_11_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_152 = chosenOH[12] ? io_in_12_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_153 = chosenOH[13] ? io_in_13_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_154 = chosenOH[14] ? io_in_14_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_155 = chosenOH[15] ? io_in_15_bits_set : 12'h0; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_156 = _io_out_bits_T_140 | _io_out_bits_T_141; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_157 = _io_out_bits_T_156 | _io_out_bits_T_142; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_158 = _io_out_bits_T_157 | _io_out_bits_T_143; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_159 = _io_out_bits_T_158 | _io_out_bits_T_144; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_160 = _io_out_bits_T_159 | _io_out_bits_T_145; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_161 = _io_out_bits_T_160 | _io_out_bits_T_146; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_162 = _io_out_bits_T_161 | _io_out_bits_T_147; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_163 = _io_out_bits_T_162 | _io_out_bits_T_148; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_164 = _io_out_bits_T_163 | _io_out_bits_T_149; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_165 = _io_out_bits_T_164 | _io_out_bits_T_150; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_166 = _io_out_bits_T_165 | _io_out_bits_T_151; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_167 = _io_out_bits_T_166 | _io_out_bits_T_152; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_168 = _io_out_bits_T_167 | _io_out_bits_T_153; // @[Mux.scala 27:73]
  wire [11:0] _io_out_bits_T_169 = _io_out_bits_T_168 | _io_out_bits_T_154; // @[Mux.scala 27:73]
  ...
  assign io_out_bits_set = _io_out_bits_T_169 | _io_out_bits_T_155; // @[Mux.scala 27:73]
  assign io_out_bits_way = _io_out_bits_T_138 | _io_out_bits_T_124; // @[Mux.scala 27:73]
  assign io_out_bits_data_dirty = chosenOH[0] & io_in_0_bits_data_dirty | chosenOH[1] & io_in_1_bits_data_dirty |
    ...
    _io_out_bits_T_93; // @[Mux.scala 27:73]
  assign io_out_bits_data_state = _io_out_bits_T_76 | _io_out_bits_T_62; // @[Mux.scala 27:73]
