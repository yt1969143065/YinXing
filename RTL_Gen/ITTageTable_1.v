module ITTageTable_1(
  ...
  input  [6:0]  io_req_bits_folded_hist_hist_31_folded_hist,
  input  [7:0]  io_req_bits_folded_hist_hist_15_folded_hist,
  output        io_resp_valid,
  output [1:0]  io_resp_bits_ctr,
  output [1:0]  io_resp_bits_u,
  output [38:0] io_resp_bits_target,
  input  [38:0] io_update_pc,
  input  [6:0]  io_update_folded_hist_hist_31_folded_hist,
  input  [7:0]  io_update_folded_hist_hist_15_folded_hist,
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [37:0] _GEN_261 = {{31'd0}, io_req_bits_folded_hist_hist_31_folded_hist}; // @[ITTAGE.scala 186:31]
  wire [37:0] _idx_T = s0_unhashed_idx ^ _GEN_261; // @[ITTAGE.scala 186:31]
  wire [6:0] s0_idx = _idx_T[6:0]; // @[ITTAGE.scala 186:40]
  wire [30:0] _GEN_262 = {{23'd0}, io_req_bits_folded_hist_hist_15_folded_hist}; // @[ITTAGE.scala 187:52]
  wire [30:0] _tag_T_1 = s0_unhashed_idx[37:7] ^ _GEN_262; // @[ITTAGE.scala 187:52]
  wire [8:0] _tag_T_2 = {io_req_bits_folded_hist_hist_15_folded_hist, 1'h0}; // @[ITTAGE.scala 187:75]
  ...
  wire [37:0] _GEN_264 = {{31'd0}, io_update_folded_hist_hist_31_folded_hist}; // @[ITTAGE.scala 186:31]
  wire [37:0] _idx_T_1 = io_update_pc[38:1] ^ _GEN_264; // @[ITTAGE.scala 186:31]
  wire [6:0] update_idx = _idx_T_1[6:0]; // @[ITTAGE.scala 186:40]
  wire [30:0] _GEN_265 = {{23'd0}, io_update_folded_hist_hist_15_folded_hist}; // @[ITTAGE.scala 187:52]
  wire [30:0] _tag_T_5 = io_update_pc[38:8] ^ _GEN_265; // @[ITTAGE.scala 187:52]
  wire [8:0] _tag_T_6 = {io_update_folded_hist_hist_15_folded_hist, 1'h0}; // @[ITTAGE.scala 187:75]
