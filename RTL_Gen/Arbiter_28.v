module Arbiter_28(
  ...
  wire  _GEN_1 = io_in_1_valid ? io_in_1_bits_cancel : io_in_2_bits_cancel; // @[Arbiter.scala 139:15 141:26 143:19]
  wire [23:0] _GEN_3 = io_in_1_valid ? io_in_1_bits_replace_tag : io_in_2_bits_replace_tag; // @[Arbiter.scala 139:15 141:26 143:19]
  wire [1:0] _GEN_4 = io_in_1_valid ? io_in_1_bits_replace_coh_state : io_in_2_bits_replace_coh_state; // @[Arbiter.scala 139:15 141:26 143:19]
  wire [1:0] _GEN_5 = io_in_1_valid ? io_in_1_bits_req_coh_state : io_in_2_bits_req_coh_state; // @[Arbiter.scala 139:15 141:26 143:19]
  wire [3:0] _GEN_11 = io_in_1_valid ? io_in_1_bits_way_en : io_in_2_bits_way_en; // @[Arbiter.scala 139:15 141:26 143:19]
  wire [38:0] _GEN_12 = io_in_1_valid ? io_in_1_bits_vaddr : io_in_2_bits_vaddr; // @[Arbiter.scala 139:15 141:26 143:19]
  wire [35:0] _GEN_13 = io_in_1_valid ? io_in_1_bits_addr : io_in_2_bits_addr; // @[Arbiter.scala 139:15 141:26 143:19]
  wire [4:0] _GEN_14 = io_in_1_valid ? io_in_1_bits_cmd : io_in_2_bits_cmd; // @[Arbiter.scala 139:15 141:26 143:19]
  wire [1:0] _GEN_15 = io_in_1_valid ? io_in_1_bits_source : io_in_2_bits_source; // @[Arbiter.scala 139:15 141:26 143:19]
  ...
  assign io_out_bits_source = io_in_0_valid ? io_in_0_bits_source : _GEN_15; // @[Arbiter.scala 141:26 143:19]
  assign io_out_bits_cmd = io_in_0_valid ? io_in_0_bits_cmd : _GEN_14; // @[Arbiter.scala 141:26 143:19]
  assign io_out_bits_addr = io_in_0_valid ? io_in_0_bits_addr : _GEN_13; // @[Arbiter.scala 141:26 143:19]
  assign io_out_bits_vaddr = io_in_0_valid ? io_in_0_bits_vaddr : _GEN_12; // @[Arbiter.scala 141:26 143:19]
  assign io_out_bits_way_en = io_in_0_valid ? io_in_0_bits_way_en : _GEN_11; // @[Arbiter.scala 141:26 143:19]
  ...
  assign io_out_bits_req_coh_state = io_in_0_valid ? io_in_0_bits_req_coh_state : _GEN_5; // @[Arbiter.scala 141:26 143:19]
  assign io_out_bits_replace_coh_state = io_in_0_valid ? io_in_0_bits_replace_coh_state : _GEN_4; // @[Arbiter.scala 141:26 143:19]
  assign io_out_bits_replace_tag = io_in_0_valid ? io_in_0_bits_replace_tag : _GEN_3; // @[Arbiter.scala 141:26 143:19]
  assign io_out_bits_id = io_in_0_valid ? io_in_0_bits_id : 64'h0; // @[Arbiter.scala 141:26 143:19]
  assign io_out_bits_cancel = io_in_0_valid ? 1'h0 : _GEN_1; // @[Arbiter.scala 141:26 143:19]
endmodule
