module DebugModule(
  ...
  input          auto_debug_dmInner_dmInner_tl_in_a_bits_source,
  ...
  output         auto_debug_dmInner_dmInner_tl_in_d_bits_source,
  ...
  wire  debug_auto_dmInner_dmInner_sb2tlOpt_out_a_ready; // @[RocketDebugWrapper.scala 43:25]
  wire  debug_auto_dmInner_dmInner_sb2tlOpt_out_a_valid; // @[RocketDebugWrapper.scala 43:25]
  wire [2:0] debug_auto_dmInner_dmInner_sb2tlOpt_out_a_bits_opcode; // @[RocketDebugWrapper.scala 43:25]
  wire [35:0] debug_auto_dmInner_dmInner_sb2tlOpt_out_a_bits_address; // @[RocketDebugWrapper.scala 43:25]
  wire [31:0] debug_auto_dmInner_dmInner_sb2tlOpt_out_a_bits_mask; // @[RocketDebugWrapper.scala 43:25]
  wire [255:0] debug_auto_dmInner_dmInner_sb2tlOpt_out_a_bits_data; // @[RocketDebugWrapper.scala 43:25]
  wire  debug_auto_dmInner_dmInner_sb2tlOpt_out_d_ready; // @[RocketDebugWrapper.scala 43:25]
  wire  debug_auto_dmInner_dmInner_sb2tlOpt_out_d_valid; // @[RocketDebugWrapper.scala 43:25]
  wire  debug_auto_dmInner_dmInner_sb2tlOpt_out_d_bits_denied; // @[RocketDebugWrapper.scala 43:25]
  wire [255:0] debug_auto_dmInner_dmInner_sb2tlOpt_out_d_bits_data; // @[RocketDebugWrapper.scala 43:25]
  wire  debug_auto_dmInner_dmInner_sb2tlOpt_out_d_bits_corrupt; // @[RocketDebugWrapper.scala 43:25]
  wire  debug_auto_dmInner_dmInner_tl_in_a_ready; // @[RocketDebugWrapper.scala 43:25]
  wire  debug_auto_dmInner_dmInner_tl_in_a_valid; // @[RocketDebugWrapper.scala 43:25]
  wire [2:0] debug_auto_dmInner_dmInner_tl_in_a_bits_opcode; // @[RocketDebugWrapper.scala 43:25]
  wire [1:0] debug_auto_dmInner_dmInner_tl_in_a_bits_size; // @[RocketDebugWrapper.scala 43:25]
  wire  debug_auto_dmInner_dmInner_tl_in_a_bits_source; // @[RocketDebugWrapper.scala 43:25]
  wire [29:0] debug_auto_dmInner_dmInner_tl_in_a_bits_address; // @[RocketDebugWrapper.scala 43:25]
  wire [7:0] debug_auto_dmInner_dmInner_tl_in_a_bits_mask; // @[RocketDebugWrapper.scala 43:25]
  wire [63:0] debug_auto_dmInner_dmInner_tl_in_a_bits_data; // @[RocketDebugWrapper.scala 43:25]
  wire  debug_auto_dmInner_dmInner_tl_in_d_ready; // @[RocketDebugWrapper.scala 43:25]
  wire  debug_auto_dmInner_dmInner_tl_in_d_valid; // @[RocketDebugWrapper.scala 43:25]
  wire [2:0] debug_auto_dmInner_dmInner_tl_in_d_bits_opcode; // @[RocketDebugWrapper.scala 43:25]
  wire [1:0] debug_auto_dmInner_dmInner_tl_in_d_bits_size; // @[RocketDebugWrapper.scala 43:25]
  wire  debug_auto_dmInner_dmInner_tl_in_d_bits_source; // @[RocketDebugWrapper.scala 43:25]
  wire [63:0] debug_auto_dmInner_dmInner_tl_in_d_bits_data; // @[RocketDebugWrapper.scala 43:25]
  wire  debug_auto_dmOuter_dmOuter_int_out_0; // @[RocketDebugWrapper.scala 43:25]
  wire  debug_io_debug_clock; // @[RocketDebugWrapper.scala 43:25]
  wire  debug_io_debug_reset; // @[RocketDebugWrapper.scala 43:25]
  wire  debug_io_tl_clock; // @[RocketDebugWrapper.scala 43:25]
  wire  debug_io_tl_reset; // @[RocketDebugWrapper.scala 43:25]
  wire  debug_io_ctrl_ndreset; // @[RocketDebugWrapper.scala 43:25]
  wire  debug_io_ctrl_dmactive; // @[RocketDebugWrapper.scala 43:25]
  wire  debug_io_ctrl_dmactiveAck; // @[RocketDebugWrapper.scala 43:25]
  wire  debug_io_dmi_dmi_req_ready; // @[RocketDebugWrapper.scala 43:25]
  wire  debug_io_dmi_dmi_req_valid; // @[RocketDebugWrapper.scala 43:25]
  wire [6:0] debug_io_dmi_dmi_req_bits_addr; // @[RocketDebugWrapper.scala 43:25]
  wire [31:0] debug_io_dmi_dmi_req_bits_data; // @[RocketDebugWrapper.scala 43:25]
  wire [1:0] debug_io_dmi_dmi_req_bits_op; // @[RocketDebugWrapper.scala 43:25]
  wire  debug_io_dmi_dmi_resp_ready; // @[RocketDebugWrapper.scala 43:25]
  wire  debug_io_dmi_dmi_resp_valid; // @[RocketDebugWrapper.scala 43:25]
  wire [31:0] debug_io_dmi_dmi_resp_bits_data; // @[RocketDebugWrapper.scala 43:25]
  wire [1:0] debug_io_dmi_dmi_resp_bits_resp; // @[RocketDebugWrapper.scala 43:25]
  wire  debug_io_dmi_dmiClock; // @[RocketDebugWrapper.scala 43:25]
  wire  debug_io_dmi_dmiReset; // @[RocketDebugWrapper.scala 43:25]
  wire  debug_io_hartIsInReset_0; // @[RocketDebugWrapper.scala 43:25]
  wire  dtm_io_jtag_clock; // @[RocketDebugWrapper.scala 78:23]
  wire  dtm_io_jtag_reset; // @[RocketDebugWrapper.scala 78:23]
  wire  dtm_io_dmi_req_ready; // @[RocketDebugWrapper.scala 78:23]
  wire  dtm_io_dmi_req_valid; // @[RocketDebugWrapper.scala 78:23]
  wire [6:0] dtm_io_dmi_req_bits_addr; // @[RocketDebugWrapper.scala 78:23]
  wire [31:0] dtm_io_dmi_req_bits_data; // @[RocketDebugWrapper.scala 78:23]
  wire [1:0] dtm_io_dmi_req_bits_op; // @[RocketDebugWrapper.scala 78:23]
  wire  dtm_io_dmi_resp_ready; // @[RocketDebugWrapper.scala 78:23]
  wire  dtm_io_dmi_resp_valid; // @[RocketDebugWrapper.scala 78:23]
  wire [31:0] dtm_io_dmi_resp_bits_data; // @[RocketDebugWrapper.scala 78:23]
  wire [1:0] dtm_io_dmi_resp_bits_resp; // @[RocketDebugWrapper.scala 78:23]
  wire  dtm_io_jtag_TMS; // @[RocketDebugWrapper.scala 78:23]
  wire  dtm_io_jtag_TDI; // @[RocketDebugWrapper.scala 78:23]
  wire  dtm_io_jtag_TDO_data; // @[RocketDebugWrapper.scala 78:23]
  wire  dtm_io_jtag_TDO_driven; // @[RocketDebugWrapper.scala 78:23]
  wire [10:0] dtm_io_jtag_mfr_id; // @[RocketDebugWrapper.scala 78:23]
  wire [15:0] dtm_io_jtag_part_number; // @[RocketDebugWrapper.scala 78:23]
  wire [3:0] dtm_io_jtag_version; // @[RocketDebugWrapper.scala 78:23]
  TLDebugModule debug ( // @[RocketDebugWrapper.scala 43:25]
  ...
  DebugTransportModuleJTAG dtm ( // @[RocketDebugWrapper.scala 78:23]
  ...
  assign io_debugIO_systemjtag_jtag_TDO_data = dtm_io_jtag_TDO_data; // @[RocketDebugWrapper.scala 79:19]
  assign io_debugIO_systemjtag_jtag_TDO_driven = dtm_io_jtag_TDO_driven; // @[RocketDebugWrapper.scala 79:19]
  assign io_debugIO_ndreset = debug_io_ctrl_ndreset; // @[RocketDebugWrapper.scala 68:24]
  assign io_debugIO_dmactive = debug_io_ctrl_dmactive; // @[RocketDebugWrapper.scala 69:25]
  ...
  assign debug_io_debug_clock = io_debugIO_clock; // @[RocketDebugWrapper.scala 67:33]
  assign debug_io_debug_reset = io_debugIO_reset; // @[RocketDebugWrapper.scala 66:33]
  assign debug_io_tl_clock = io_clock; // @[RocketDebugWrapper.scala 61:42]
  assign debug_io_tl_reset = io_reset; // @[RocketDebugWrapper.scala 60:30]
  assign debug_io_ctrl_dmactiveAck = io_debugIO_dmactiveAck; // @[RocketDebugWrapper.scala 70:38]
  assign debug_io_dmi_dmi_req_valid = dtm_io_dmi_req_valid; // @[RocketDebugWrapper.scala 89:35]
  assign debug_io_dmi_dmi_req_bits_addr = dtm_io_dmi_req_bits_addr; // @[RocketDebugWrapper.scala 89:35]
  assign debug_io_dmi_dmi_req_bits_data = dtm_io_dmi_req_bits_data; // @[RocketDebugWrapper.scala 89:35]
  assign debug_io_dmi_dmi_req_bits_op = dtm_io_dmi_req_bits_op; // @[RocketDebugWrapper.scala 89:35]
  assign debug_io_dmi_dmi_resp_ready = dtm_io_dmi_resp_ready; // @[RocketDebugWrapper.scala 89:35]
  assign debug_io_dmi_dmiClock = io_debugIO_systemjtag_jtag_TCK; // @[RocketDebugWrapper.scala 90:40]
  assign debug_io_dmi_dmiReset = io_debugIO_systemjtag_reset; // @[RocketDebugWrapper.scala 91:40]
  assign debug_io_hartIsInReset_0 = io_resetCtrl_hartIsInReset_0; // @[RocketDebugWrapper.scala 62:35]
  assign dtm_io_jtag_clock = io_debugIO_systemjtag_jtag_TCK; // @[RocketDebugWrapper.scala 83:26]
  assign dtm_io_jtag_reset = io_debugIO_systemjtag_reset; // @[RocketDebugWrapper.scala 84:26]
  assign dtm_io_dmi_req_ready = debug_io_dmi_dmi_req_ready; // @[RocketDebugWrapper.scala 89:35]
  assign dtm_io_dmi_resp_valid = debug_io_dmi_dmi_resp_valid; // @[RocketDebugWrapper.scala 89:35]
  assign dtm_io_dmi_resp_bits_data = debug_io_dmi_dmi_resp_bits_data; // @[RocketDebugWrapper.scala 89:35]
  assign dtm_io_dmi_resp_bits_resp = debug_io_dmi_dmi_resp_bits_resp; // @[RocketDebugWrapper.scala 89:35]
  assign dtm_io_jtag_TMS = io_debugIO_systemjtag_jtag_TMS; // @[RocketDebugWrapper.scala 79:19]
  assign dtm_io_jtag_TDI = io_debugIO_systemjtag_jtag_TDI; // @[RocketDebugWrapper.scala 79:19]
  assign dtm_io_jtag_mfr_id = io_debugIO_systemjtag_mfr_id; // @[RocketDebugWrapper.scala 85:26]
  assign dtm_io_jtag_part_number = io_debugIO_systemjtag_part_number; // @[RocketDebugWrapper.scala 86:31]
  assign dtm_io_jtag_version = io_debugIO_systemjtag_version; // @[RocketDebugWrapper.scala 87:27]
endmodule
