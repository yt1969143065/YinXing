...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [33:0] _a_acquire_bits_address_T = {io_task_bits_tag,io_task_bits_set,6'h0}; // @[Cat.scala 31:58]
  reg [15:0] s0_task_tag; // @[Reg.scala 16:16]
  reg [11:0] s0_task_set; // @[Reg.scala 16:16]
  ...
  reg [15:0] s1_task_tag; // @[Reg.scala 16:16]
  reg [11:0] s1_task_set; // @[Reg.scala 16:16]
  ...
  wire [33:0] _a_put_bits_address_T = {s1_task_tag,s1_task_set,s1_task_off}; // @[Cat.scala 31:58]
  ...
  wire [35:0] a_put_bits_address = {{2'd0}, _a_put_bits_address_T}; // @[SourceA.scala 40:19 102:22]
  wire [35:0] _T_39 = muxStateEarly_0 ? a_put_bits_address : 36'h0; // @[Mux.scala 27:73]
  wire [35:0] a_acquire_bits_address = {{2'd0}, _a_acquire_bits_address_T}; // @[SourceA.scala 39:23 54:26]
...
`ifdef RANDOMIZE_REG_INIT
  ...
  state_1 = _RAND_3[0:0];
  _RAND_4 = {1{`RANDOM}};
  s0_task_tag = _RAND_4[15:0];
  _RAND_5 = {1{`RANDOM}};
  s0_task_set = _RAND_5[11:0];
  _RAND_6 = {1{`RANDOM}};
  ...
  _RAND_14 = {1{`RANDOM}};
  s1_task_tag = _RAND_14[15:0];
  _RAND_15 = {1{`RANDOM}};
  s1_task_set = _RAND_15[11:0];
  _RAND_16 = {1{`RANDOM}};
