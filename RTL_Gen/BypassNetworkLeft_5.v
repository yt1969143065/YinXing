...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [63:0] _bypassedData_0_target_T_6 = _bypassedData_0_target_T_2 | _bypassedData_0_target_T_3; // @[Mux.scala 27:73]
  wire [63:0] _bypassedData_0_target_T_7 = _bypassedData_0_target_T_6 | _bypassedData_0_target_T_4; // @[Mux.scala 27:73]
  wire [63:0] _bypassedData_0_target_T_8 = _bypassedData_0_target_T_7 | _bypassedData_0_target_T_5; // @[Mux.scala 27:73]
  wire [3:0] _bypassedData_1_target_T = {io_bypass_3_valid_1,io_bypass_2_valid_1,io_bypass_1_valid_1,io_bypass_0_valid_1
    }; // @[BypassNetwork.scala 48:32]
  ...
  wire [63:0] _bypassedData_1_target_T_6 = _bypassedData_1_target_T_2 | _bypassedData_1_target_T_3; // @[Mux.scala 27:73]
  wire [63:0] _bypassedData_1_target_T_7 = _bypassedData_1_target_T_6 | _bypassedData_1_target_T_4; // @[Mux.scala 27:73]
  wire [63:0] _bypassedData_1_target_T_8 = _bypassedData_1_target_T_7 | _bypassedData_1_target_T_5; // @[Mux.scala 27:73]
  ...
  always @(posedge clock) begin
    if (~io_hold) begin // @[BypassNetwork.scala 91:19]
      if (|_bypassedData_0_target_T) begin // @[BypassNetwork.scala 48:21]
        bypassedData_0 <= _bypassedData_0_target_T_8;
      end else begin
    ...
    if (~io_hold) begin // @[BypassNetwork.scala 91:19]
      if (|_bypassedData_1_target_T) begin // @[BypassNetwork.scala 48:21]
        bypassedData_1 <= _bypassedData_1_target_T_8;
      end else begin
