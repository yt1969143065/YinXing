...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [8:0] _wcounter_T_2 = w_todo - _GEN_34; // @[Fragmenter.scala 171:27]
  ...
  Queue_147 deq ( // @[Decoupled.scala 361:21]
    .clock(deq_clock),
    .reset(deq_reset),
  ...
  Queue_147 deq_1 ( // @[Decoupled.scala 361:21]
    .clock(deq_1_clock),
    .reset(deq_1_reset),
  ...
  Queue_109 in_wdeq ( // @[Decoupled.scala 361:21]
    .clock(in_wdeq_clock),
    .reset(in_wdeq_reset),
  ...
  always @(posedge clock) begin
    ...
    if (reset) begin // @[Fragmenter.scala 167:30]
      ...
      w_counter <= _wcounter_T_2; // @[Fragmenter.scala 171:17]
    end
    ...
    if (reset) begin // @[Fragmenter.scala 195:26]
      ...
      if (auto_out_becho_real_last) begin // @[Fragmenter.scala 198:48]
        error_0 <= 2'h0;
      end else begin
        error_0 <= _error_0_T;
      end
