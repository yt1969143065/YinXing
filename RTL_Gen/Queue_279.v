...
`endif // RANDOMIZE_REG_INIT
  reg [11:0] ram_set [0:0]; // @[Decoupled.scala 259:95]
  ...
  reg [1:0] ram_way [0:0]; // @[Decoupled.scala 259:95]
  ...
  reg [15:0] ram_tag [0:0]; // @[Decoupled.scala 259:95]
...
`ifdef RANDOMIZE_MEM_INIT
  ...
  for (initvar = 0; initvar < 1; initvar = initvar+1)
    ram_set[initvar] = _RAND_0[11:0];
  _RAND_1 = {1{`RANDOM}};
  for (initvar = 0; initvar < 1; initvar = initvar+1)
    ram_way[initvar] = _RAND_1[1:0];
  _RAND_2 = {1{`RANDOM}};
  for (initvar = 0; initvar < 1; initvar = initvar+1)
    ram_tag[initvar] = _RAND_2[15:0];
`endif // RANDOMIZE_MEM_INIT
`ifdef RANDOMIZE_REG_INIT
  _RAND_3 = {1{`RANDOM}};
