module Queue_262(
  ...
  input         io_enq_bits_extra_tlrr_extra_source,
...
`endif // RANDOMIZE_REG_INIT
  ...
  reg [12:0] ram_index [0:0]; // @[Decoupled.scala 259:95]
  wire  ram_index_io_deq_bits_MPORT_en; // @[Decoupled.scala 259:95]
  wire  ram_index_io_deq_bits_MPORT_addr; // @[Decoupled.scala 259:95]
  wire [12:0] ram_index_io_deq_bits_MPORT_data; // @[Decoupled.scala 259:95]
  wire [12:0] ram_index_MPORT_data; // @[Decoupled.scala 259:95]
  ...
  reg  ram_extra_tlrr_extra_source [0:0]; // @[Decoupled.scala 259:95]
  ...
  wire  ram_extra_tlrr_extra_source_io_deq_bits_MPORT_data; // @[Decoupled.scala 259:95]
  wire  ram_extra_tlrr_extra_source_MPORT_data; // @[Decoupled.scala 259:95]
