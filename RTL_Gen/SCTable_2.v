module SCTable_2(
  ...
  input  [7:0]  io_req_bits_folded_hist_hist_35_folded_hist,
  ...
  input  [7:0]  io_update_folded_hist_hist_35_folded_hist,
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [37:0] _GEN_10 = {{30'd0}, io_req_bits_folded_hist_hist_35_folded_hist}; // @[SC.scala 87:31]
  ...
  wire [37:0] _GEN_11 = {{30'd0}, io_update_folded_hist_hist_35_folded_hist}; // @[SC.scala 87:31]
  ...
  SRAMTemplate_100 table_ ( // @[SC.scala 72:21]
    .clock(table__clock),
    .reset(table__reset),
  ...
  WrBypass_161 wrbypasses_0 ( // @[SC.scala 140:42]
  ...
  WrBypass_161 wrbypasses_1 ( // @[SC.scala 140:42]
