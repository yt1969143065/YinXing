...
`endif // RANDOMIZE_REG_INIT
  ...
  wire  _GEN_4 = _T & _bundleIn_0_a_ready_T | bundleOut_0_a_bits_data_rdata_written_once; // @[WidthWidget.scala 63:35 64:30 56:41]
  ...
  wire  _GEN_8 = _T & _bundleIn_0_a_ready_T | bundleOut_0_a_bits_mask_rdata_written_once; // @[WidthWidget.scala 63:35 64:30 56:41]
  ...
  wire  cated_bits_source = repeated_repeater_io_deq_bits_source; // @[WidthWidget.scala 155:25 156:15]
  reg [1:0] repeat_sel_hold_r; // @[Reg.scala 16:16]
  wire [1:0] _GEN_19 = cated_bits_source ? repeat_sel_sel_sources_1 : repeat_sel_sel_sources_0; // @[Reg.scala 17:{22,22}]
  wire [1:0] _GEN_20 = repeat_first ? _GEN_19 : repeat_sel_hold_r; // @[Reg.scala 16:16 17:{18,22}]
  wire [1:0] _repeat_sel_T = ~repeat_limit; // @[WidthWidget.scala 116:18]
  wire [1:0] repeat_sel = _GEN_20 & _repeat_sel_T; // @[WidthWidget.scala 116:16]
  ...
  wire [63:0] _GEN_22 = 2'h1 == repeat_index ? repeat_bundleIn_0_d_bits_data_mux_1 : repeat_bundleIn_0_d_bits_data_mux_0
    ; // @[WidthWidget.scala 131:{30,30}]
  wire [63:0] _GEN_23 = 2'h2 == repeat_index ? repeat_bundleIn_0_d_bits_data_mux_2 : _GEN_22; // @[WidthWidget.scala 131:{30,30}]
  ...
  assign auto_in_d_bits_data = 2'h3 == repeat_index ? repeat_bundleIn_0_d_bits_data_mux_3 : _GEN_23; // @[WidthWidget.scala 131:{30,30}]
  ...
  always @(posedge clock) begin
    ...
    if (reset) begin // @[WidthWidget.scala 56:41]
      ...
      bundleOut_0_a_bits_mask_rdata_written_once <= _GEN_8;
    end
    if (_T & _bundleIn_0_a_ready_T) begin // @[WidthWidget.scala 63:35]
    ...
    if (repeat_first) begin // @[Reg.scala 17:18]
      if (cated_bits_source) begin // @[Reg.scala 17:22]
        repeat_sel_hold_r <= repeat_sel_sel_sources_1; // @[Reg.scala 17:22]
      end else begin
...
`ifdef RANDOMIZE_REG_INIT
  ...
  _RAND_12 = {1{`RANDOM}};
  repeat_sel_hold_r = _RAND_12[1:0];
`endif // RANDOMIZE_REG_INIT
  `endif // RANDOMIZE
end // initial
