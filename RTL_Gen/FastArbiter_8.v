module FastArbiter_8(
  ...
  input        io_in_0_valid,
  input  [5:0] io_in_0_bits_sink,
  output       io_in_1_ready,
  input        io_in_1_valid,
  input  [5:0] io_in_1_bits_sink,
  output       io_in_2_ready,
  input        io_in_2_valid,
  input  [5:0] io_in_2_bits_sink,
  output       io_in_3_ready,
  input        io_in_3_valid,
  input  [5:0] io_in_3_bits_sink,
  output       io_in_4_ready,
  input        io_in_4_valid,
  input  [5:0] io_in_4_bits_sink,
  output       io_in_5_ready,
  input        io_in_5_valid,
  input  [5:0] io_in_5_bits_sink,
  output       io_in_6_ready,
  input        io_in_6_valid,
  input  [5:0] io_in_6_bits_sink,
  output       io_in_7_ready,
  input        io_in_7_valid,
  input  [5:0] io_in_7_bits_sink,
  output       io_in_8_ready,
  input        io_in_8_valid,
  input  [5:0] io_in_8_bits_sink,
  output       io_in_9_ready,
  input        io_in_9_valid,
  input  [5:0] io_in_9_bits_sink,
  output       io_in_10_ready,
  input        io_in_10_valid,
  input  [5:0] io_in_10_bits_sink,
  output       io_in_11_ready,
  input        io_in_11_valid,
  input  [5:0] io_in_11_bits_sink,
  output       io_in_12_ready,
  input        io_in_12_valid,
  input  [5:0] io_in_12_bits_sink,
  output       io_in_13_ready,
  input        io_in_13_valid,
  input  [5:0] io_in_13_bits_sink,
  input        io_out_ready,
  output       io_out_valid,
  output [5:0] io_out_bits_sink
);
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [5:0] _io_out_bits_T_14 = chosenOH[0] ? io_in_0_bits_sink : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_15 = chosenOH[1] ? io_in_1_bits_sink : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_16 = chosenOH[2] ? io_in_2_bits_sink : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_17 = chosenOH[3] ? io_in_3_bits_sink : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_18 = chosenOH[4] ? io_in_4_bits_sink : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_19 = chosenOH[5] ? io_in_5_bits_sink : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_20 = chosenOH[6] ? io_in_6_bits_sink : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_21 = chosenOH[7] ? io_in_7_bits_sink : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_22 = chosenOH[8] ? io_in_8_bits_sink : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_23 = chosenOH[9] ? io_in_9_bits_sink : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_24 = chosenOH[10] ? io_in_10_bits_sink : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_25 = chosenOH[11] ? io_in_11_bits_sink : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_26 = chosenOH[12] ? io_in_12_bits_sink : 6'h0; // @[Mux.scala 27:73]
  wire [5:0] _io_out_bits_T_27 = chosenOH[13] ? io_in_13_bits_sink : 6'h0; // @[Mux.scala 27:73]
  ...
  assign io_out_bits_sink = _io_out_bits_T_39 | _io_out_bits_T_27; // @[Mux.scala 27:73]
