module TageTable_1(
  ...
  input  [5:0]  io_req_bits_folded_hist_hist_27_folded_hist,
  input  [6:0]  io_req_bits_folded_hist_hist_19_folded_hist,
  ...
  input  [5:0]  io_update_folded_hist_hist_27_folded_hist,
  input  [6:0]  io_update_folded_hist_hist_19_folded_hist,
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [37:0] _GEN_877 = {{31'd0}, io_req_bits_folded_hist_hist_19_folded_hist}; // @[Tage.scala 285:29]
  wire [37:0] _idx_T = req_unhashed_idx ^ _GEN_877; // @[Tage.scala 285:29]
  wire [6:0] s0_idx = _idx_T[6:0]; // @[Tage.scala 285:38]
  wire [6:0] _tag_T_1 = {io_req_bits_folded_hist_hist_27_folded_hist, 1'h0}; // @[Tage.scala 286:52]
  ...
  wire [37:0] _GEN_881 = {{31'd0}, io_update_folded_hist_hist_19_folded_hist}; // @[Tage.scala 285:29]
  wire [37:0] _idx_T_1 = update_unhashed_idx ^ _GEN_881; // @[Tage.scala 285:29]
  wire [6:0] update_idx = _idx_T_1[6:0]; // @[Tage.scala 285:38]
  wire [6:0] _tag_T_4 = {io_update_folded_hist_hist_27_folded_hist, 1'h0}; // @[Tage.scala 286:52]
