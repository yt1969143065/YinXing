...
`endif // RANDOMIZE_REG_INIT
  reg [255:0] ram_data [0:4]; // @[Decoupled.scala 259:95]
  ...
  reg  ram_corrupt [0:4]; // @[Decoupled.scala 259:95]
  ...
  `else
  assign ram_data_io_deq_bits_MPORT_data = ram_data_io_deq_bits_MPORT_addr >= 3'h5 ? _RAND_1[255:0] :
    ram_data[ram_data_io_deq_bits_MPORT_addr]; // @[Decoupled.scala 259:95]
  `endif // RANDOMIZE_GARBAGE_ASSIGN
  assign ram_data_MPORT_data = io_enq_bits_data;
  assign ram_data_MPORT_addr = enq_ptr_value;
  assign ram_data_MPORT_mask = 1'h1;
  assign ram_data_MPORT_en = empty ? _GEN_15 : _do_enq_T;
  ...
  `else
  assign ram_corrupt_io_deq_bits_MPORT_data = ram_corrupt_io_deq_bits_MPORT_addr >= 3'h5 ? _RAND_3[0:0] :
    ram_corrupt[ram_corrupt_io_deq_bits_MPORT_addr]; // @[Decoupled.scala 259:95]
  `endif // RANDOMIZE_GARBAGE_ASSIGN
  assign ram_corrupt_MPORT_data = io_enq_bits_corrupt;
  assign ram_corrupt_MPORT_addr = enq_ptr_value;
  assign ram_corrupt_MPORT_mask = 1'h1;
  assign ram_corrupt_MPORT_en = empty ? _GEN_15 : _do_enq_T;
  ...
  assign io_deq_bits_corrupt = empty ? io_enq_bits_corrupt : ram_corrupt_io_deq_bits_MPORT_data; // @[Decoupled.scala 296:17 301:17 302:19]
