module BusErrorUnit(
  ...
  input  [35:0] io_errors_l2_ecc_error_bits
);
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire  _GEN_11 = io_errors_dcache_ecc_error_valid ? _GEN_7 : io_errors_icache_ecc_error_valid & enable_0; // @[BusErrorUnit.scala 92:26]
  wire  _GEN_12 = io_errors_dcache_ecc_error_valid & enable_1; // @[BusErrorUnit.scala 92:26]
  wire [35:0] _GEN_13 = io_errors_dcache_ecc_error_valid ? _GEN_9 : io_errors_icache_ecc_error_bits; // @[BusErrorUnit.scala 92:26]
  wire  _GEN_14 = enable_2 | _GEN_11; // @[BusErrorUnit.scala 94:19 95:21]
  wire [1:0] _GEN_15 = enable_2 ? 2'h2 : {{1'd0}, _GEN_12}; // @[BusErrorUnit.scala 94:19 96:21]
  wire [35:0] _GEN_16 = enable_2 ? io_errors_l2_ecc_error_bits : _GEN_13; // @[BusErrorUnit.scala 94:19 97:21]
  wire  _GEN_17 = io_errors_l2_ecc_error_valid | accrued_2; // @[BusErrorUnit.scala 92:26 93:13 76:22]
  wire  cause_wen = io_errors_l2_ecc_error_valid ? _GEN_14 : _GEN_11; // @[BusErrorUnit.scala 92:26]
  wire [1:0] new_cause = io_errors_l2_ecc_error_valid ? _GEN_15 : {{1'd0}, _GEN_12}; // @[BusErrorUnit.scala 92:26]
  wire [35:0] new_value = io_errors_l2_ecc_error_valid ? _GEN_16 : _GEN_13; // @[BusErrorUnit.scala 92:26]
  ...
  wire  _GEN_34 = out_f_wivalid_11 ? auto_in_a_bits_data[0] : enable_0; // @[BusErrorUnit.scala 64:21 RegField.scala 74:{88,92}]
  wire  out_f_wivalid_12 = out_wivalid_11 & out_wimask_3; // @[RegisterRouter.scala 82:24]
  wire  _GEN_35 = out_f_wivalid_12 ? auto_in_a_bits_data[1] : enable_1; // @[BusErrorUnit.scala 64:21 RegField.scala 74:{88,92}]
  wire  out_f_wivalid_13 = out_wivalid_11 & out_wimask_4; // @[RegisterRouter.scala 82:24]
  wire  _GEN_36 = out_f_wivalid_13 ? auto_in_a_bits_data[2] : enable_2; // @[BusErrorUnit.scala 64:21 RegField.scala 74:{88,92}]
  ...
  always @(posedge clock) begin
    ...
    enable_0 <= reset | _GEN_34; // @[BusErrorUnit.scala 64:{21,21}]
    enable_1 <= reset | _GEN_35; // @[BusErrorUnit.scala 64:{21,21}]
    enable_2 <= reset | _GEN_36; // @[BusErrorUnit.scala 64:{21,21}]
    if (reset) begin // @[BusErrorUnit.scala 70:31]
      global_interrupt_0 <= 1'h0; // @[BusErrorUnit.scala 70:31]
    end else if (out_f_wivalid_14) begin // @[RegField.scala 74:88]
      global_interrupt_0 <= auto_in_a_bits_data[0]; // @[RegField.scala 74:92]
    end
    if (reset) begin // @[BusErrorUnit.scala 70:31]
      global_interrupt_1 <= 1'h0; // @[BusErrorUnit.scala 70:31]
    end else if (out_f_wivalid_15) begin // @[RegField.scala 74:88]
      global_interrupt_1 <= auto_in_a_bits_data[1]; // @[RegField.scala 74:92]
    end
    if (reset) begin // @[BusErrorUnit.scala 70:31]
      global_interrupt_2 <= 1'h0; // @[BusErrorUnit.scala 70:31]
    end else if (out_f_wivalid_16) begin // @[RegField.scala 74:88]
      global_interrupt_2 <= auto_in_a_bits_data[2]; // @[RegField.scala 74:92]
    end
    if (reset) begin // @[BusErrorUnit.scala 76:22]
      accrued_0 <= 1'h0; // @[BusErrorUnit.scala 76:22]
    end else if (out_f_wivalid_17) begin // @[RegField.scala 74:88]
      accrued_0 <= auto_in_a_bits_data[0]; // @[RegField.scala 74:92]
    end else begin
      accrued_0 <= _GEN_3;
    end
    if (reset) begin // @[BusErrorUnit.scala 76:22]
      accrued_1 <= 1'h0; // @[BusErrorUnit.scala 76:22]
    end else if (out_f_wivalid_18) begin // @[RegField.scala 74:88]
      accrued_1 <= auto_in_a_bits_data[1]; // @[RegField.scala 74:92]
    end else begin
      accrued_1 <= _GEN_10;
    end
    if (reset) begin // @[BusErrorUnit.scala 76:22]
      accrued_2 <= 1'h0; // @[BusErrorUnit.scala 76:22]
    end else if (out_f_wivalid_19) begin // @[RegField.scala 74:88]
      accrued_2 <= auto_in_a_bits_data[2]; // @[RegField.scala 74:92]
    end else begin
      accrued_2 <= _GEN_17;
    end
    if (reset) begin // @[BusErrorUnit.scala 82:30]
      local_interrupt_0 <= 1'h0; // @[BusErrorUnit.scala 82:30]
    end else if (out_f_wivalid_2) begin // @[RegField.scala 74:88]
      local_interrupt_0 <= auto_in_a_bits_data[0]; // @[RegField.scala 74:92]
    end
    if (reset) begin // @[BusErrorUnit.scala 82:30]
      local_interrupt_1 <= 1'h0; // @[BusErrorUnit.scala 82:30]
    end else if (out_f_wivalid_3) begin // @[RegField.scala 74:88]
      local_interrupt_1 <= auto_in_a_bits_data[1]; // @[RegField.scala 74:92]
    end
    if (reset) begin // @[BusErrorUnit.scala 82:30]
      local_interrupt_2 <= 1'h0; // @[BusErrorUnit.scala 82:30]
    end else if (out_f_wivalid_4) begin // @[RegField.scala 74:88]
      local_interrupt_2 <= auto_in_a_bits_data[2]; // @[RegField.scala 74:92]
    end
  end
