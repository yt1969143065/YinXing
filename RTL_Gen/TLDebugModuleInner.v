...
`endif // RANDOMIZE_REG_INIT
  ...
  always @(posedge clock) begin
    ...
    if (reset) begin // @[Debug.scala 853:29]
      hrmaskReg_0 <= 1'h0; // @[Debug.scala 853:29]
    end else if (~io_dmactive) begin // @[Debug.scala 860:45]
      hrmaskReg_0 <= 1'h0; // @[Debug.scala 861:17]
    end else if (_T_4) begin // @[Debug.scala 862:37]
      hrmaskReg_0 <= io_innerCtrl_bits_hrmask_0; // @[Debug.scala 863:17]
    end
