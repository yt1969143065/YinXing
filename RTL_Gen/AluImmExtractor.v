module AluImmExtractor(
  ...
  wire  imm32_signBit = io_uop_ctrl_imm[11]; // @[BitUtils.scala 43:20]
  ...
  wire [31:0] imm32 = io_uop_ctrl_selImm == 4'h2 ? _imm32_T_3 : _imm32_T_8; // @[DataArray.scala 116:20]
  wire  io_data_out_1_signBit = imm32[31]; // @[BitUtils.scala 43:20]
  ...
  assign io_data_out_1 = _T ? _io_data_out_1_T_2 : io_data_in_1; // @[DataArray.scala 115:48 120:20 98:15]
endmodule
