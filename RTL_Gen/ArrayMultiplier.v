...
`endif // RANDOMIZE_REG_INIT
  ...
  wire  io_out_bits_data_signBit = res[31]; // @[BitUtils.scala 43:20]
...
`ifdef RANDOMIZE_REG_INIT
  ...
  _RAND_12 = {1{`RANDOM}};
  ctrlVec_1_isW = _RAND_12[0:0];
  _RAND_13 = {1{`RANDOM}};
  ctrlVec_1_isHi = _RAND_13[0:0];
  _RAND_14 = {1{`RANDOM}};
  ctrlVec_2_isW = _RAND_14[0:0];
  _RAND_15 = {1{`RANDOM}};
  ctrlVec_2_isHi = _RAND_15[0:0];
`endif // RANDOMIZE_REG_INIT
  `endif // RANDOMIZE
end // initial
