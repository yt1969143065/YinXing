module SinkD(
  ...
  input  [5:0]   io_d_bits_sink,
  input          io_d_bits_denied,
  input          io_d_bits_echo_blockisdirty,
  ...
  output [5:0]   io_resp_bits_sink,
  output         io_resp_bits_last,
  output         io_resp_bits_denied,
  output         io_resp_bits_dirty,
...
`endif // RANDOMIZE_REG_INIT
  ...
  assign io_resp_bits_dirty = io_d_bits_echo_blockisdirty; // @[SinkD.scala 63:22]
