...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [7:0] waymask = resetState ? 8'hff : io_wreq_bits_waymask; // @[SRAMTemplate.scala 119:20]
  ...
  array_5 array ( // @[SRAMTemplate.scala 102:26]
  ...
  assign array_RW0_wdata_4 = resetState ? 1'h0 : io_wreq_bits_data_4; // @[SRAMTemplate.scala 118:26]
  assign array_RW0_wdata_5 = resetState ? 1'h0 : io_wreq_bits_data_5; // @[SRAMTemplate.scala 118:26]
  assign array_RW0_wdata_6 = resetState ? 1'h0 : io_wreq_bits_data_6; // @[SRAMTemplate.scala 118:26]
  assign array_RW0_wdata_7 = resetState ? 1'h0 : io_wreq_bits_data_7; // @[SRAMTemplate.scala 118:26]
  ...
  assign array_RW0_wmask_4 = waymask[4]; // @[SRAMTemplate.scala 120:51]
  assign array_RW0_wmask_5 = waymask[5]; // @[SRAMTemplate.scala 120:51]
  assign array_RW0_wmask_6 = waymask[6]; // @[SRAMTemplate.scala 120:51]
  assign array_RW0_wmask_7 = waymask[7]; // @[SRAMTemplate.scala 120:51]
...
`ifdef RANDOMIZE_REG_INIT
  ...
  _RAND_7 = {1{`RANDOM}};
  rdata_r4 = _RAND_7[0:0];
  _RAND_8 = {1{`RANDOM}};
  rdata_r5 = _RAND_8[0:0];
  _RAND_9 = {1{`RANDOM}};
  rdata_r6 = _RAND_9[0:0];
  _RAND_10 = {1{`RANDOM}};
  rdata_r7 = _RAND_10[0:0];
`endif // RANDOMIZE_REG_INIT
  `endif // RANDOMIZE
end // initial
