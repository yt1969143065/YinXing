...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [52:0] divModule_io_a; // @[FDIV.scala 292:25]
  wire [52:0] divModule_io_d; // @[FDIV.scala 292:25]
  ...
  wire [56:0] divModule_io_rem; // @[FDIV.scala 292:25]
  wire [54:0] divModule_io_quot; // @[FDIV.scala 292:25]
  wire [54:0] divModule_io_quotM1; // @[FDIV.scala 292:25]
  wire  sqrtModule_clock; // @[FDIV.scala 299:26]
  wire [53:0] sqrtModule_io_a; // @[FDIV.scala 299:26]
  wire [1:0] sqrtModule_io_state; // @[FDIV.scala 299:26]
  wire [55:0] sqrtModule_io_rem; // @[FDIV.scala 299:26]
  wire [54:0] sqrtModule_io_res; // @[FDIV.scala 299:26]
  wire [54:0] sqrtModule_io_resM1; // @[FDIV.scala 299:26]
  wire [51:0] rounder_io_in; // @[FDIV.scala 312:23]
  ...
  wire [51:0] rounder_io_out; // @[FDIV.scala 312:23]
  ...
  wire [10:0] _GEN_36 = {{10'd0}, decode_a_expIsZero}; // @[package.scala 83:27]
  wire [10:0] raw_a_exp = fp_a_exp | _GEN_36; // @[package.scala 83:27]
  wire [52:0] raw_a_sig = {expNotZero,fp_a_sig}; // @[Cat.scala 31:58]
  wire [10:0] _GEN_37 = {{10'd0}, decode_bexpIsZero}; // @[package.scala 83:27]
  wire [10:0] raw_bexp = fp_bexp | _GEN_37; // @[package.scala 83:27]
  ...
  wire [11:0] _sqrtFinalExp_T_1 = aExp - 12'h3ff; // @[FDIV.scala 255:36]
  ...
  wire [12:0] _divFinalExp_T_2 = ~_divFinalExp_T_1; // @[FDIV.scala 253:50]
  wire [12:0] _divFinalExp_T_4 = _divFinalExp_T + _divFinalExp_T_2; // @[FDIV.scala 253:48]
  ...
  wire [12:0] _GEN_41 = {{12'd0}, _divFinalExp_T_5}; // @[FDIV.scala 253:78]
  wire [12:0] divFinalExp = _divFinalExp_T_4 + _GEN_41; // @[FDIV.scala 253:78]
  wire [12:0] finalExp = sqrtReg ? sqrtFinalExp : divFinalExp; // @[FDIV.scala 256:21]
  wire [12:0] _infRes_T = ~finalExp; // @[FDIV.scala 259:17]
  wire [12:0] _infRes_T_2 = _infRes_T + 13'h400; // @[FDIV.scala 259:27]
  wire  infRes = _infRes_T_2[12]; // @[FDIV.scala 259:105]
  ...
  wire [12:0] _zeroRes_T_1 = finalExp + 13'h434; // @[FDIV.scala 258:27]
  wire  zeroRes = _zeroRes_T_1[12]; // @[FDIV.scala 258:77]
  ...
  wire  finalIter = iterNumReg == 5'h0; // @[FDIV.scala 289:27]
  ...
  wire [115:0] _GEN_0 = {{63'd0}, aSigReg}; // @[FDIV.scala 231:23]
  wire [115:0] _aSigNorm_T = _GEN_0 << aLZC_clz_io_out; // @[FDIV.scala 231:23]
  wire [52:0] aSigNorm = _aSigNorm_T[52:0]; // @[FDIV.scala 220:22 231:12]
  wire  _aSigReg_T_7 = state[0] | _T_3[0]; // @[FDIV.scala 221:82]
  wire [115:0] _GEN_1 = {{63'd0}, dSigReg}; // @[FDIV.scala 233:23]
  wire [115:0] _dSigNorm_T = _GEN_1 << dLZC_clz_io_out; // @[FDIV.scala 233:23]
  wire [52:0] dSigNorm = _dSigNorm_T[52:0]; // @[FDIV.scala 222:22 233:12]
  wire [11:0] _GEN_47 = {{6'd0}, aLZC_clz_io_out}; // @[FDIV.scala 234:19]
  wire [11:0] aExpFix = aExp - _GEN_47; // @[FDIV.scala 234:19]
  wire  _aExp_T_8 = state[0] | _T_3[0] & aSubReg; // @[FDIV.scala 227:78]
  wire [11:0] _GEN_49 = {{6'd0}, dLZC_clz_io_out}; // @[FDIV.scala 235:19]
  wire [11:0] dExpFix = dExp - _GEN_49; // @[FDIV.scala 235:19]
  ...
  wire [12:0] _subRes_T_1 = finalExp + 13'h3fe; // @[FDIV.scala 260:26]
  wire  subRes = _subRes_T_1[12] & ~zeroRes; // @[FDIV.scala 260:79]
  ...
  wire [12:0] resultSigBits = subRes ? _zeroRes_T_1 : 13'h36; // @[FDIV.scala 280:26]
  reg  needShiftReg; // @[Reg.scala 16:16]
  wire  _oddIterReg_T_1 = ~resultSigBits[1]; // @[FDIV.scala 284:30]
  reg  oddIterReg; // @[Reg.scala 16:16]
  wire [12:0] _iterNumInit_T_1 = resultSigBits - 13'h1; // @[FDIV.scala 286:49]
  wire [11:0] iterNumInit = sqrtReg ? _iterNumInit_T_1[12:1] : {{1'd0}, resultSigBits[12:2]}; // @[FDIV.scala 286:24]
  wire  _iterNumReg_T_4 = _T_5[0] | _T_7[0]; // @[FDIV.scala 287:54]
  wire [4:0] _iterNum_T_3 = iterNumReg - 5'h1; // @[FDIV.scala 288:58]
  wire [11:0] _iterNum_T_4 = _T_5[0] ? iterNumInit : {{7'd0}, _iterNum_T_3}; // @[FDIV.scala 288:17]
  wire [4:0] iterNum = _iterNum_T_4[4:0]; // @[FDIV.scala 285:21 288:11]
  wire [53:0] _sqrtModule_io_a_T_1 = {1'h0,aSigReg}; // @[Cat.scala 31:58]
  wire [53:0] _sqrtModule_io_a_T_2 = {aSigReg,1'h0}; // @[Cat.scala 31:58]
  wire [54:0] quotIter = sqrtReg ? sqrtModule_io_res : divModule_io_quot; // @[FDIV.scala 304:18]
  wire [54:0] quotM1Iter = sqrtReg ? sqrtModule_io_resM1 : divModule_io_quotM1; // @[FDIV.scala 305:20]
  ...
  wire [57:0] r = sqrtReg ? _rT_2 : _rT_3; // @[FDIV.scala 308:14]
  wire [54:0] qFinal = r[57] ? quotM1Iter : quotIter; // @[FDIV.scala 309:19]
  wire [12:0] _resExp_T_1 = finalExp + 13'h3ff; // @[FDIV.scala 319:45]
  wire [12:0] _resExp_T_2 = subResReg ? 13'h0 : _resExp_T_1; // @[FDIV.scala 319:19]
  wire [10:0] resExp = _resExp_T_2[10:0]; // @[FDIV.scala 319:78]
  ...
  wire [10:0] _combinedExp_T_4 = resExp + 11'h1; // @[FDIV.scala 334:85]
  wire [51:0] _combinedSig_T_3 = rounder_io_in; // @[FDIV.scala 337:91]
  wire [51:0] _combinedSig_T_4 = rounder_io_out; // @[FDIV.scala 337:125]
  ...
  CLZ_15 aLZC_clz ( // @[CLZ.scala 22:21]
    .io_in(aLZC_clz_io_in),
    .io_out(aLZC_clz_io_out)
  );
  CLZ_15 dLZC_clz ( // @[CLZ.scala 22:21]
    .io_in(dLZC_clz_io_in),
    .io_out(dLZC_clz_io_out)
  );
  DivIterModule_1 divModule ( // @[FDIV.scala 292:25]
  ...
  SqrtIterModule_1 sqrtModule ( // @[FDIV.scala 299:26]
  ...
  RoundingUnit_1 rounder ( // @[FDIV.scala 312:23]
    .io_in(rounder_io_in),
  ...
  assign rounder_io_in = needShiftReg ? qFinal[53:2] : qFinal[52:1]; // @[FDIV.scala 313:23]
  ...
  always @(posedge clock) begin
    ...
    if (_io_specialIO_out_valid_T[0]) begin // @[Reg.scala 17:18]
      ...
      end else if (rounder_io_cout & resExp != 11'h7fe) begin // @[FDIV.scala 334:10]
    ...
    if (_io_specialIO_out_valid_T[0]) begin // @[Reg.scala 17:18]
      ...
      end else if (rounder_io_cout & resExp == 11'h7fe) begin // @[FDIV.scala 337:10]
...
`ifdef RANDOMIZE_REG_INIT
  ...
  dExp = _RAND_7[11:0];
  _RAND_8 = {2{`RANDOM}};
  aSigReg = _RAND_8[52:0];
  _RAND_9 = {2{`RANDOM}};
  dSigReg = _RAND_9[52:0];
  _RAND_10 = {1{`RANDOM}};
  inv = _RAND_10[0:0];
  _RAND_11 = {1{`RANDOM}};
  dz = _RAND_11[0:0];
  ...
  _RAND_19 = {1{`RANDOM}};
  special_exp = _RAND_19[10:0];
  _RAND_20 = {2{`RANDOM}};
  special_sig = _RAND_20[51:0];
  _RAND_21 = {1{`RANDOM}};
  ...
  _RAND_24 = {1{`RANDOM}};
  combinedExpReg = _RAND_24[10:0];
  _RAND_25 = {2{`RANDOM}};
  combinedSigReg = _RAND_25[51:0];
  _RAND_26 = {1{`RANDOM}};
