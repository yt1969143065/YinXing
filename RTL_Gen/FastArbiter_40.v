...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [2:0] _io_out_bits_T_47 = chosenOH[0] ? io_in_0_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_48 = chosenOH[1] ? io_in_1_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_49 = chosenOH[2] ? io_in_2_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_50 = chosenOH[3] ? io_in_3_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_51 = chosenOH[4] ? io_in_4_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_52 = chosenOH[5] ? io_in_5_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_53 = chosenOH[6] ? io_in_6_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_54 = chosenOH[7] ? io_in_7_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_55 = chosenOH[8] ? io_in_8_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_56 = chosenOH[9] ? io_in_9_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_57 = chosenOH[10] ? io_in_10_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_58 = chosenOH[11] ? io_in_11_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_59 = chosenOH[12] ? io_in_12_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_60 = chosenOH[13] ? io_in_13_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_61 = chosenOH[14] ? io_in_14_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_62 = chosenOH[15] ? io_in_15_bits_way : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_63 = _io_out_bits_T_47 | _io_out_bits_T_48; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_64 = _io_out_bits_T_63 | _io_out_bits_T_49; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_65 = _io_out_bits_T_64 | _io_out_bits_T_50; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_66 = _io_out_bits_T_65 | _io_out_bits_T_51; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_67 = _io_out_bits_T_66 | _io_out_bits_T_52; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_68 = _io_out_bits_T_67 | _io_out_bits_T_53; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_69 = _io_out_bits_T_68 | _io_out_bits_T_54; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_70 = _io_out_bits_T_69 | _io_out_bits_T_55; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_71 = _io_out_bits_T_70 | _io_out_bits_T_56; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_72 = _io_out_bits_T_71 | _io_out_bits_T_57; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_73 = _io_out_bits_T_72 | _io_out_bits_T_58; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_74 = _io_out_bits_T_73 | _io_out_bits_T_59; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_75 = _io_out_bits_T_74 | _io_out_bits_T_60; // @[Mux.scala 27:73]
  wire [2:0] _io_out_bits_T_76 = _io_out_bits_T_75 | _io_out_bits_T_61; // @[Mux.scala 27:73]
  wire [8:0] _io_out_bits_T_78 = chosenOH[0] ? io_in_0_bits_set : 9'h0; // @[Mux.scala 27:73]
  wire [8:0] _io_out_bits_T_79 = chosenOH[1] ? io_in_1_bits_set : 9'h0; // @[Mux.scala 27:73]
  wire [8:0] _io_out_bits_T_80 = chosenOH[2] ? io_in_2_bits_set : 9'h0; // @[Mux.scala 27:73]
  wire [8:0] _io_out_bits_T_81 = chosenOH[3] ? io_in_3_bits_set : 9'h0; // @[Mux.scala 27:73]
  wire [8:0] _io_out_bits_T_82 = chosenOH[4] ? io_in_4_bits_set : 9'h0; // @[Mux.scala 27:73]
  wire [8:0] _io_out_bits_T_83 = chosenOH[5] ? io_in_5_bits_set : 9'h0; // @[Mux.scala 27:73]
  wire [8:0] _io_out_bits_T_84 = chosenOH[6] ? io_in_6_bits_set : 9'h0; // @[Mux.scala 27:73]
  wire [8:0] _io_out_bits_T_85 = chosenOH[7] ? io_in_7_bits_set : 9'h0; // @[Mux.scala 27:73]
  wire [8:0] _io_out_bits_T_86 = chosenOH[8] ? io_in_8_bits_set : 9'h0; // @[Mux.scala 27:73]
  wire [8:0] _io_out_bits_T_87 = chosenOH[9] ? io_in_9_bits_set : 9'h0; // @[Mux.scala 27:73]
  wire [8:0] _io_out_bits_T_88 = chosenOH[10] ? io_in_10_bits_set : 9'h0; // @[Mux.scala 27:73]
  wire [8:0] _io_out_bits_T_89 = chosenOH[11] ? io_in_11_bits_set : 9'h0; // @[Mux.scala 27:73]
  wire [8:0] _io_out_bits_T_90 = chosenOH[12] ? io_in_12_bits_set : 9'h0; // @[Mux.scala 27:73]
  wire [8:0] _io_out_bits_T_91 = chosenOH[13] ? io_in_13_bits_set : 9'h0; // @[Mux.scala 27:73]
  wire [8:0] _io_out_bits_T_92 = chosenOH[14] ? io_in_14_bits_set : 9'h0; // @[Mux.scala 27:73]
  wire [8:0] _io_out_bits_T_93 = chosenOH[15] ? io_in_15_bits_set : 9'h0; // @[Mux.scala 27:73]
  wire [8:0] _io_out_bits_T_94 = _io_out_bits_T_78 | _io_out_bits_T_79; // @[Mux.scala 27:73]
  wire [8:0] _io_out_bits_T_95 = _io_out_bits_T_94 | _io_out_bits_T_80; // @[Mux.scala 27:73]
  wire [8:0] _io_out_bits_T_96 = _io_out_bits_T_95 | _io_out_bits_T_81; // @[Mux.scala 27:73]
  wire [8:0] _io_out_bits_T_97 = _io_out_bits_T_96 | _io_out_bits_T_82; // @[Mux.scala 27:73]
  wire [8:0] _io_out_bits_T_98 = _io_out_bits_T_97 | _io_out_bits_T_83; // @[Mux.scala 27:73]
  wire [8:0] _io_out_bits_T_99 = _io_out_bits_T_98 | _io_out_bits_T_84; // @[Mux.scala 27:73]
  wire [8:0] _io_out_bits_T_100 = _io_out_bits_T_99 | _io_out_bits_T_85; // @[Mux.scala 27:73]
  wire [8:0] _io_out_bits_T_101 = _io_out_bits_T_100 | _io_out_bits_T_86; // @[Mux.scala 27:73]
  wire [8:0] _io_out_bits_T_102 = _io_out_bits_T_101 | _io_out_bits_T_87; // @[Mux.scala 27:73]
  wire [8:0] _io_out_bits_T_103 = _io_out_bits_T_102 | _io_out_bits_T_88; // @[Mux.scala 27:73]
  wire [8:0] _io_out_bits_T_104 = _io_out_bits_T_103 | _io_out_bits_T_89; // @[Mux.scala 27:73]
  wire [8:0] _io_out_bits_T_105 = _io_out_bits_T_104 | _io_out_bits_T_90; // @[Mux.scala 27:73]
  wire [8:0] _io_out_bits_T_106 = _io_out_bits_T_105 | _io_out_bits_T_91; // @[Mux.scala 27:73]
  wire [8:0] _io_out_bits_T_107 = _io_out_bits_T_106 | _io_out_bits_T_92; // @[Mux.scala 27:73]
  ...
  assign io_out_bits_set = _io_out_bits_T_107 | _io_out_bits_T_93; // @[Mux.scala 27:73]
  assign io_out_bits_way = _io_out_bits_T_76 | _io_out_bits_T_62; // @[Mux.scala 27:73]
