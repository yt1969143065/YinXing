module SRAMTemplate_269(
  input         clock,
  input         io_rreq_valid,
  input  [11:0] io_rreq_bits_setIdx,
  output [15:0] io_rresp_data_0,
  output [15:0] io_rresp_data_1,
  output [15:0] io_rresp_data_2,
  output [15:0] io_rresp_data_3,
  input         io_wreq_valid,
  input  [11:0] io_wreq_bits_setIdx,
  input  [15:0] io_wreq_bits_data_0,
  input  [15:0] io_wreq_bits_data_1,
  input  [15:0] io_wreq_bits_data_2,
  input  [15:0] io_wreq_bits_data_3,
  ...
  wire [15:0] array_RW0_wdata_0; // @[SRAMTemplate.scala 113:26]
  wire [15:0] array_RW0_wdata_1; // @[SRAMTemplate.scala 113:26]
  wire [15:0] array_RW0_wdata_2; // @[SRAMTemplate.scala 113:26]
  wire [15:0] array_RW0_wdata_3; // @[SRAMTemplate.scala 113:26]
  wire [15:0] array_RW0_rdata_0; // @[SRAMTemplate.scala 113:26]
  wire [15:0] array_RW0_rdata_1; // @[SRAMTemplate.scala 113:26]
  wire [15:0] array_RW0_rdata_2; // @[SRAMTemplate.scala 113:26]
  wire [15:0] array_RW0_rdata_3; // @[SRAMTemplate.scala 113:26]
  ...
  array_43 array ( // @[SRAMTemplate.scala 113:26]
