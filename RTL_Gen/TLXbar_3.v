...
`endif // RANDOMIZE_REG_INIT
  wire [7:0] _GEN_1 = {{7'd0}, auto_in_1_a_bits_source}; // @[Xbar.scala 237:55]
  wire [7:0] in_1_a_bits_source = _GEN_1 | 8'h80; // @[Xbar.scala 237:55]
  wire  requestDOI_0_0 = ~auto_out_d_bits_source[7]; // @[Parameters.scala 54:32]
  wire  requestDOI_0_1 = auto_out_d_bits_source[7:1] == 7'h40; // @[Parameters.scala 54:32]
  ...
  wire [7:0] in_0_a_bits_source = {{1'd0}, auto_in_0_a_bits_source}; // @[Xbar.scala 231:18 237:29]
  wire [7:0] _T_36 = muxStateEarly_0 ? in_0_a_bits_source : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _T_37 = muxStateEarly_1 ? in_1_a_bits_source : 8'h0; // @[Mux.scala 27:73]
