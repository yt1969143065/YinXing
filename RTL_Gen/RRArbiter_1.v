...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [26:0] _GEN_31 = 3'h1 == io_chosen ? io_in_1_bits_req_info_vpn : io_in_0_bits_req_info_vpn; // @[Arbiter.scala 57:{15,15}]
  wire [26:0] _GEN_32 = 3'h2 == io_chosen ? io_in_2_bits_req_info_vpn : _GEN_31; // @[Arbiter.scala 57:{15,15}]
  wire [26:0] _GEN_33 = 3'h3 == io_chosen ? io_in_3_bits_req_info_vpn : _GEN_32; // @[Arbiter.scala 57:{15,15}]
  wire [26:0] _GEN_34 = 3'h4 == io_chosen ? io_in_4_bits_req_info_vpn : _GEN_33; // @[Arbiter.scala 57:{15,15}]
  ...
  assign io_out_bits_req_info_vpn = 3'h5 == io_chosen ? io_in_5_bits_req_info_vpn : _GEN_34; // @[Arbiter.scala 57:{15,15}]
