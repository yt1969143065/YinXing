module Pipeline_45(
  ...
  wire [63:0] stages_0_io_enq_bits_set; // @[Pipeline.scala 11:47]
  wire [63:0] stages_0_io_enq_bits_tag; // @[Pipeline.scala 11:47]
  wire [63:0] stages_0_io_enq_bits_way; // @[Pipeline.scala 11:47]
  wire [63:0] stages_0_io_enq_bits_dir; // @[Pipeline.scala 11:47]
  ...
  wire [63:0] stages_0_io_deq_bits_set; // @[Pipeline.scala 11:47]
  wire [63:0] stages_0_io_deq_bits_tag; // @[Pipeline.scala 11:47]
  wire [63:0] stages_0_io_deq_bits_way; // @[Pipeline.scala 11:47]
  wire [63:0] stages_0_io_deq_bits_dir; // @[Pipeline.scala 11:47]
  ...
  wire [63:0] stages_1_io_enq_bits_set; // @[Pipeline.scala 11:47]
  wire [63:0] stages_1_io_enq_bits_tag; // @[Pipeline.scala 11:47]
  wire [63:0] stages_1_io_enq_bits_way; // @[Pipeline.scala 11:47]
  wire [63:0] stages_1_io_enq_bits_dir; // @[Pipeline.scala 11:47]
  ...
  wire [63:0] stages_1_io_deq_bits_set; // @[Pipeline.scala 11:47]
  wire [63:0] stages_1_io_deq_bits_tag; // @[Pipeline.scala 11:47]
  wire [63:0] stages_1_io_deq_bits_way; // @[Pipeline.scala 11:47]
  wire [63:0] stages_1_io_deq_bits_dir; // @[Pipeline.scala 11:47]
  Queue_347 stages_0 ( // @[Pipeline.scala 11:47]
    ...
    .io_enq_bits_dir(stages_0_io_enq_bits_dir),
    ...
    .io_deq_bits_dir(stages_0_io_deq_bits_dir)
  );
  Queue_347 stages_1 ( // @[Pipeline.scala 11:47]
    ...
    .io_enq_bits_set(stages_1_io_enq_bits_set),
    .io_enq_bits_tag(stages_1_io_enq_bits_tag),
    .io_enq_bits_way(stages_1_io_enq_bits_way),
    .io_enq_bits_dir(stages_1_io_enq_bits_dir),
    ...
    .io_deq_bits_set(stages_1_io_deq_bits_set),
    .io_deq_bits_tag(stages_1_io_deq_bits_tag),
    .io_deq_bits_way(stages_1_io_deq_bits_way),
    .io_deq_bits_dir(stages_1_io_deq_bits_dir)
  );
  ...
  assign io_out_bits_set = stages_1_io_deq_bits_set; // @[Pipeline.scala 18:10]
  assign io_out_bits_tag = stages_1_io_deq_bits_tag; // @[Pipeline.scala 18:10]
  assign io_out_bits_way = stages_1_io_deq_bits_way; // @[Pipeline.scala 18:10]
  assign io_out_bits_dir = stages_1_io_deq_bits_dir; // @[Pipeline.scala 18:10]
  ...
  assign stages_0_io_enq_bits_dir = io_in_bits_dir; // @[Pipeline.scala 14:14]
  ...
  assign stages_1_io_enq_bits_set = stages_0_io_deq_bits_set; // @[Pipeline.scala 14:14]
  assign stages_1_io_enq_bits_tag = stages_0_io_deq_bits_tag; // @[Pipeline.scala 14:14]
  assign stages_1_io_enq_bits_way = stages_0_io_deq_bits_way; // @[Pipeline.scala 14:14]
  assign stages_1_io_enq_bits_dir = stages_0_io_deq_bits_dir; // @[Pipeline.scala 14:14]
