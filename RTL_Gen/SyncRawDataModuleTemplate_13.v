module SyncRawDataModuleTemplate_13(
  input         clock,
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [6:0] _T_166 = {w__6,w__5,w__4,w__3,w__2,w__1,w__0}; // @[DataModuleTemplate.scala 45:13]
  ...
  wire [6:0] _T_184 = {w_1_6,w_1_5,w_1_4,w_1_3,w_1_2,w_1_1,w_1_0}; // @[DataModuleTemplate.scala 45:13]
  ...
  wire [6:0] _T_202 = {w_2_6,w_2_5,w_2_4,w_2_3,w_2_2,w_2_1,w_2_0}; // @[DataModuleTemplate.scala 45:13]
  ...
  wire [6:0] _T_220 = {w_3_6,w_3_5,w_3_4,w_3_3,w_3_2,w_3_1,w_3_0}; // @[DataModuleTemplate.scala 45:13]
  ...
  wire [6:0] _T_238 = {w_4_6,w_4_5,w_4_4,w_4_3,w_4_2,w_4_1,w_4_0}; // @[DataModuleTemplate.scala 45:13]
  ...
  wire [6:0] _T_256 = {w_5_6,w_5_5,w_5_4,w_5_3,w_5_2,w_5_1,w_5_0}; // @[DataModuleTemplate.scala 45:13]
  ...
  wire [6:0] _T_274 = {w_6_6,w_6_5,w_6_4,w_6_3,w_6_2,w_6_1,w_6_0}; // @[DataModuleTemplate.scala 45:13]
  ...
  wire [6:0] _T_292 = {w_7_6,w_7_5,w_7_4,w_7_3,w_7_2,w_7_1,w_7_0}; // @[DataModuleTemplate.scala 45:13]
  ...
  wire [6:0] _T_310 = {w_8_6,w_8_5,w_8_4,w_8_3,w_8_2,w_8_1,w_8_0}; // @[DataModuleTemplate.scala 45:13]
  ...
  wire [6:0] _T_328 = {w_9_6,w_9_5,w_9_4,w_9_3,w_9_2,w_9_1,w_9_0}; // @[DataModuleTemplate.scala 45:13]
  ...
  wire [6:0] _T_346 = {w_10_6,w_10_5,w_10_4,w_10_3,w_10_2,w_10_1,w_10_0}; // @[DataModuleTemplate.scala 45:13]
  ...
  wire [6:0] _T_364 = {w_11_6,w_11_5,w_11_4,w_11_3,w_11_2,w_11_1,w_11_0}; // @[DataModuleTemplate.scala 45:13]
  ...
  wire [6:0] _T_382 = {w_12_6,w_12_5,w_12_4,w_12_3,w_12_2,w_12_1,w_12_0}; // @[DataModuleTemplate.scala 45:13]
  ...
  wire [6:0] _T_400 = {w_13_6,w_13_5,w_13_4,w_13_3,w_13_2,w_13_1,w_13_0}; // @[DataModuleTemplate.scala 45:13]
  ...
  wire [6:0] _T_418 = {w_14_6,w_14_5,w_14_4,w_14_3,w_14_2,w_14_1,w_14_0}; // @[DataModuleTemplate.scala 45:13]
  ...
  wire [6:0] _T_436 = {w_15_6,w_15_5,w_15_4,w_15_3,w_15_2,w_15_1,w_15_0}; // @[DataModuleTemplate.scala 45:13]
  ...
  always @(posedge clock) begin
    if (|_T_166) begin // @[DataModuleTemplate.scala 45:25]
    ...
    if (|_T_202) begin // @[DataModuleTemplate.scala 45:25]
      data_2 <= _data_2_T_12; // @[DataModuleTemplate.scala 46:15]
    end
    if (|_T_220) begin // @[DataModuleTemplate.scala 45:25]
      data_3 <= _data_3_T_12; // @[DataModuleTemplate.scala 46:15]
    end
    if (|_T_238) begin // @[DataModuleTemplate.scala 45:25]
    ...
    if (|_T_274) begin // @[DataModuleTemplate.scala 45:25]
    ...
    if (|_T_310) begin // @[DataModuleTemplate.scala 45:25]
      data_8 <= _data_8_T_12; // @[DataModuleTemplate.scala 46:15]
    end
    if (|_T_328) begin // @[DataModuleTemplate.scala 45:25]
      data_9 <= _data_9_T_12; // @[DataModuleTemplate.scala 46:15]
    end
    if (|_T_346) begin // @[DataModuleTemplate.scala 45:25]
      data_10 <= _data_10_T_12; // @[DataModuleTemplate.scala 46:15]
    end
    if (|_T_364) begin // @[DataModuleTemplate.scala 45:25]
      data_11 <= _data_11_T_12; // @[DataModuleTemplate.scala 46:15]
    end
    if (|_T_382) begin // @[DataModuleTemplate.scala 45:25]
      data_12 <= _data_12_T_12; // @[DataModuleTemplate.scala 46:15]
    end
    if (|_T_400) begin // @[DataModuleTemplate.scala 45:25]
      data_13 <= _data_13_T_12; // @[DataModuleTemplate.scala 46:15]
    end
    if (|_T_418) begin // @[DataModuleTemplate.scala 45:25]
      data_14 <= _data_14_T_12; // @[DataModuleTemplate.scala 46:15]
    end
    if (|_T_436) begin // @[DataModuleTemplate.scala 45:25]
      data_15 <= _data_15_T_12; // @[DataModuleTemplate.scala 46:15]
    end
